...
<html>
	...
	<BODY onload="myload();">
		...
		<!-- 内容 -->
		<div>
			<s:form action="PG_IC_add" method="post" name="IC_info" theme="simple" id="course_info">
				 <div>
				...
				<table cellpadding="1" cellspacing="1" bgcolor="#ECEDEB" width="700">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							<label> 
								PINGGU_IC_U_<input name="IC.tableName" type="text" id="ICTableName" value="${IC.tableName}" size="60" >
							</label>
						</td>
					</tr> 
					<!-- <tr>
