...
-->
	...
	<body>
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="保单栏目简介" /></div>
			</li>
		</ul>
		<table width="100%">
			<tr>
			<td valign="top" width="200px" id="tree_list_td"><wysLib:policyTypeTree href="policyLib_view.action?ptype.id=" rootAble="true"></wysLib:policyTypeTree>
		</td>
			...
			<td valign="top"><table width="100%" cellpadding="2" cellspacing="1" >
				...
				<tr>
					...
					<td >
						<a href="policyLib_alterInit.action?ptype.id=<s:property value="ptype.id"/>" class="textbg4">修 改</a>
						<br />
						<s:form method="post" name="delEp" action="policyLib_delete.action">
