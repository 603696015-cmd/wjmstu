...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function delsure(scanning){ 
				//if(scanning){ 
			    	//return true;
			    //}
				//alert("请先上传扫描件，才能终审通过");
			    //return false;
			}
		</script>
<style type="text/css"> 
			...
			<table width="100%">
				<tr>
					<td valign="top" width="100" id="tree_list_td"> 
						<wysLib:productTypeTree href="PG_Policy_AuditListInit.action?sublibs=1&ptype.id="
					...
					<td valign="top">
							<form action="PG_buyPolicyListInit.action" method="post" name="assignProduct" id="assignProduct">
							...
							<table width="100%" align="center" cellpadding="2"
								...
								<tr>
									...
									<!-- <th width="280" height="30" align="center" >
										扫描件									
									</th> -->
								...
								<s:iterator value="policys">
									<tr>
										...
										<!-- <td height="30" align="center" >  
											<form action="Policy_UpdateScanning.action?policy.id=<s:property value="id" />" enctype="multipart/form-data"	method="post"> 
												<s:hidden name="actionName" value="Policy_Audit2ListInit"/>
								      ...
								      <td align="center" valign="middle"> 
									   	  <s:if test="valid == 3">
										   	  <a href="PG_Policy_AuditInit.action?policy.id=${id }&policy.valid=4&actionName=Policy_Audit2ListInit" class="textbg6">不通过</a>
										   	  <a href="PG_Policy_AuditInit.action?policy.id=${id }&policy.valid=5&actionName=Policy_Audit2ListInit"  onClick="return delsure('<s:property value="scanning" />');" class="textbg4">通过</a> 
									   	  </s:if>   
								   	    <!--  <s:if test="valid == 3">
										   	  <a href="Policy_AuditInit.action?policy.id=${id }&policy.valid=6&actionName=Policy_AuditListInit">删除</a>
									   	  </s:if>  -->
