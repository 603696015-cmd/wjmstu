									...
									<tr>
								      ...
								      <td align="center" valign="middle"> 
									   	  <s:if test="valid == 1 || valid == 4">
										   	  <a href="PG_Policy_AuditInit.action?policy.id=${id }&policy.valid=2&actionName=Policy_AuditListInit" class="textbg6">不通过</a>
										   	  <a href="PG_Policy_AuditInit.action?policy.id=${id }&policy.valid=3&actionName=Policy_AuditListInit" class="textbg4">通过</a>
										   	  <a href="PG_IC_U_Info_AlertInit.action?policy.id=${id}&IC_U_ID=<s:property value="IC_U_ID" />&actionName=Policy_AuditListInit" class="textbg4">修改</a>									   	  </s:if>   
								   	    <!--<s:if test="valid == 3"> 
