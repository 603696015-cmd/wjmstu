...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>店铺首页</TITLE>
<META content="text/html; charset=utf-8" http-equiv=Content-Type>
<META content=IE=EmulateIE7 http-equiv=X-UA-Compatible>
<META content=name=keywords>
<META content=name=description>
<LINK rel=stylesheet type=text/css href="<%=path %>/front/css/index.css">
<LINK rel=stylesheet type=text/css href="<%=path %>/front/css/menu.css">
<STYLE type=text/css>
BODY {
	FONT-SIZE: 12px
}
...
<table width="100%" height="33" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td background="<%=path %>/front/images/tlbg.gif">
...
<table width="960" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content3>
  <tr>
    <td background="<%=path %>/front/images/pic_34.gif" class="STYLE10"> 　　店铺简介 </td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" height="320" align="center">
    	<s:if test="pfmsUser.dianpujianjietupian != null">															
			<img src="<s:property value="pfmsUser.dianpujianjietupian_"/>" width="450" height="300" />
		</s:if><s:else>
    ...
    <td valign="top"><TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
      <TBODY>
        <TR>
          <TD height=100 vAlign=top style="padding:15px;">
          		<s:property value="pfmsUser.note"/>
          </TD>
          </TR>
      </TBODY>
    </TABLE>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
        <tr>
          <td>&nbsp;</td>
          <td width="160">&nbsp;</td>
          <td width="140"><img src="<%=path %>/front/images/more01.jpg" width="85" height="29" onclick="window.location.href='shopIndex_jianjie.action?id=${pfmsUser.userId} '"></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table width="960" height="51" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td background="<%=path %>/front/images/pic_17.gif" class="STYLE10"> 　　<span class="STYLE11">店内产品导航</span></td>
  </tr>
</table>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content3>
  <tr>
    ...
    <td class=hotback style="padding-top:15px;">
      ...
      <tr>
        <td>
        <form action="shopIndex.action?id=${id }" method="post" name="assign">
                ...
                <TBODY>
                  <TR>
                    <TD class=heicu14 height=30 vAlign=middle><A 
                        href="shopIndex_content.action?productId=${id }&id=${shopId }" class="STYLE5"><s:property value="name"></s:property></A></TD>
                  </TR>
                  <TR>
                    <TD height=95 vAlign=bottom><TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                        <TBODY>
                          <!-- <TR>
                            ...
                            <TD width="300" height="100" vAlign="top"><s:property value="jianjie"></s:property></TD>
                            <TD align="center" vAlign=top class="h30">
                            	<s:property value="shuliang"/>
                            </TD>
                            <TD width="180" vAlign="top">
	                            <span class="font-hui">
	                            <a href="#"><s:property value="productCompanyName"></s:property></a>
	                            </span><br>
                                <s:property value="pfmsUser.province_city_county"></s:property></TD>
                          </TR> -->
                          <TR>
                            <TD width=110 height="100" align=left vAlign=top>
                            	<s:if test="chanpintupian != null">															
