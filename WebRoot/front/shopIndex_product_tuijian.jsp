...
<HTML 
xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>店铺推荐产品</TITLE>
...
<table width="960" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content3>
  <tr>
    <td background="<%=path %>/front/images/pic_34.gif" class="STYLE10"> 　　推荐产品 </td>
  </tr>
</table>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content3>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="33" class="dibaikuang2">　<span class="tabtop">店内新闻</span></td>
      </tr>
    </table>
    ...
    <s:iterator value="newsList">
    	<tr>
            <td> 
            	<a target="_blank" href="newsIndexView.action?news.id=<s:property value="id" />">
                		...
                		<TBODY>
                  			<TR>
                    			<TD class=heicu14 height=30 vAlign=middle><A 
                       				 href="shopIndex_content.action?productId=${id }&id=${shopId }" class=STYLE5><s:property value="name"/></A></TD>
                  			</TR>
                  			<TR>
                    				...
                    				<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                        				<TBODY>
                          					<TR>
                            					...
                            					<TD align="center" vAlign=top class="h30"><s:property value="huiyuanjia"/></TD>
                            					<TD width="180" vAlign=top><span class="font-hui"><a href="#"><s:property value="productCompanyName"></s:property></a></span><br>
                              						<s:property value="pfmsUser.province_city_county"></s:property>
                              					</TD>
                          					</TR>
                        				</TBODY>
                    				</TABLE>
