                ...
                <TBODY>
                  <TR>
                    <TD class=heicu14 height=30 vAlign=middle><A 
                        href="shopIndex.action?id=${userId }" class="STYLE5"><s:property value="user.realname"/></A></TD>
                  </TR>
                  <TR>
                    <TD height=95 vAlign=bottom><TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                        <TBODY>
                          <TR>
                            ...
                            <TD width="300" height=100 align="left" vAlign=top><s:property value="note"/></TD>
