  ...
  <tr>
    ...
    <td valign="top" class=hotback style="padding-top:15px;">
    	<table border=0 cellSpacing=0 cellPadding=0  width="95%" align=center>
    		<tr>
    			<td>营业执照</td>
    			<td><img src="<%=path %>/images/pfms/yingyezhizhao_${pfmsUser.userId }.${pfmsUser.yingyezhizhao }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>税务登记证</td>
    			<td><img src="<%=path %>/images/pfms/shuiwudengjizheng_${pfmsUser.userId }.${pfmsUser.shuiwudengjizheng }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>组织机构代码证</td>
    			<td><img src="<%=path %>/images/pfms/zuzhijigoudaimazheng_${pfmsUser.userId }.${pfmsUser.zuzhijigoudaimazheng }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>法人身份证</td>
    			<td><img src="<%=path %>/images/pfms/farenshenfenzheng_${pfmsUser.userId }.${pfmsUser.farenshenfenzheng }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>资质等级证书</td>
    			<td><img src="<%=path %>/images/pfms/zizhidengjizhengshu_${pfmsUser.userId }.${pfmsUser.zizhidengjizhengshu }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>信用等级评估证书</td>
    			<td><img src="<%=path %>/images/pfms/xinyongdengjipingguzhengshu_${pfmsUser.userId }.${pfmsUser.xinyongdengjipingguzhengshu }" width="450" height="300"/><br></td>
    		</tr>
    		<tr>
    			<td>其他证书</td>
    			<td><img src="<%=path %>/images/pfms/qitazhengshu_${pfmsUser.userId }.${pfmsUser.qitazhengshu }" width="450" height="300"/><br></td>
    		</tr>
    	</table>
    	<!-- 营业执照：
    	<img src="<%=path %>/images/pfms/yingyezhizhao_${pfmsUser.userId }.${pfmsUser.yingyezhizhao }" width="450" height="300"/><br>
    	税务登记证：
    	<img src="<%=path %>/images/pfms/shuiwudengjizheng_${pfmsUser.userId }.${pfmsUser.shuiwudengjizheng }" width="450" height="300"/><br>
    	组织机构代码证：
    	<img src="<%=path %>/images/pfms/zuzhijigoudaimazheng_${pfmsUser.userId }.${pfmsUser.zuzhijigoudaimazheng }" width="450" height="300"/><br>
    	法人身份证：
    	<img src="<%=path %>/images/pfms/farenshenfenzheng_${pfmsUser.userId }.${pfmsUser.farenshenfenzheng }" width="450" height="300"/><br>
    	资质等级证书：
    	<img src="<%=path %>/images/pfms/zizhidengjizhengshu_${pfmsUser.userId }.${pfmsUser.zizhidengjizhengshu }" width="450" height="300"/><br>
    	信用等级评估证书：
    	<img src="<%=path %>/images/pfms/xinyongdengjipingguzhengshu_${pfmsUser.userId }.${pfmsUser.xinyongdengjipingguzhengshu }" width="450" height="300"/><br>
    	其他证书：
    	<img src="<%=path %>/images/pfms/qitazhengshu_${pfmsUser.userId }.${pfmsUser.qitazhengshu }" width="450" height="300"/><br> -->
    </td>
  </tr>
</table>
