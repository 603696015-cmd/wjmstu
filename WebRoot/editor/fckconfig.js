...
FCKConfig.ToolbarSets["qcontent"] = [
...
FCKConfig.stuffurl='http://localhost:8080/gdgat/';
FCKConfig.LinkBrowser = true ;
FCKConfig.LinkBrowserURL = "../../../question_stuffList.action" ;
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.7 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL =  "../../../question_stuffList.action" ;
FCKConfig.ImageBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL =  "../../../question_stuffList.action" ;
