							...
							<tr>
								...
								<td width="25" align="center" bgcolor="#EEEEEE">
									<a href="javascript:divNone();" class="bg001"><span
										style="font-size: 15px; color: #FF0000">X</span>
									</a>
								</td>
							</tr>
						</table>
									...
									<s:iterator value="zxNewss_tw_wb" status="zxNewss_st">
										<s:if test="#zxNewss_st.index > 0">
											<tr>
												...
												<td   class="gqtitle"> 
													<span style="color:red">[<s:date name="releasetime" format="yyyy-MM-dd HH:mm"/>]</span>
												</td>
											</tr> 
										</s:if>
									</s:iterator>
										...
										<tbody>
											<tr>
												...
												<td valign="center" align="right">
													...
													<input class="textbox" id="search_content" style="MARGIN-RIGHT: 20px; height: 22px;" />
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70" align="center">
														<a
															href="newsIndex.action?pN=0&pS=10&containsub=1&news.ntype.id=5"
					...
					<table width="98%" border="0" align="right" cellpadding="0"
						...
						<tr>
							<td height="100" valign="top">
								...
								<table style="margin-top: 8px;" width="100%" border="0" align="center" cellpadding="0"
									cellspacing="0" class="tdbkblue">
									<tr>
										<td height="30" valign="middle"
											background="elfrontimages/tbbg.gif" class="gqtitle"
