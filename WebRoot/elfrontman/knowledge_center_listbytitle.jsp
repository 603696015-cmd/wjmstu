...
.STYLE6 {
	...
	<BODY>
		...
		<table width="960px" border="0" align="center" cellpadding="0"
			cellspacing="0">
          <tr>
            <td width="270" valign="top"><table width="97%" border="0">
                <tr>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                        ...
                        <tr>
                          <td background="images/knowledge/zhao_24.gif"></td>
                          <td align="left" valign="top" style="PADDING: 8px; line-height:25px;"> <form action="knowledge_center_listbytitle.action"
																...
																<TD bgColor=#ffffff>
																	<LABEL>
																		<input style="WIDTH: 100%;height: 25px;border: 1px solid #000000;" type="text" id="knowledge.title"
																			name="knowledge.name" value="<s:property value="knowledge.name"/>"/>
																	</LABEL>
																</TD>
															</TR>
															<TR>
																...
																<TD bgColor=#ffffff>
																	<LABEL>
																		<s:radio list="#{'true':'是','false':'否'}" name="sysconf.search_need"></s:radio>
																	</LABEL>
																</TD>
															</TR>
															<TR>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                        ...
                        <tr>
                          <td background="images/knowledge/zhao_24.gif"></td>
                          <td height="200" align="left" valign="top" style="PADDING: 8px; line-height:25px;"><wysLib:kltype_center_list></wysLib:kltype_center_list></td>
                          <td background="images/knowledge/zhao_25.gif"></td>
                        </tr>
                        <tr>
                          <td height="6"><img height="5" src="images/knowledge/zhao_26.gif" width="5" /></td>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><!--当前位置：
								<a href="knowledge_center.action"> 知识中心首页</a>&gt;&gt; --><span class="STYLE6">符合<!--"
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                  ...
                  <tr>
                    ...
                    <form action="knowledge_center_listbytitle.action" method="post" name="ddd">
						<s:hidden name="pN" id="pageNow_2"></s:hidden>
						<s:hidden name="pS"></s:hidden>
						<s:hidden name="knowledge.name"></s:hidden>
						<s:hidden name="sysconf.search_need"></s:hidden>
					</form>
