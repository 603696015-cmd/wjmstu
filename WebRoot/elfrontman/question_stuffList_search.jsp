...
//	 }
  ...
  <TBODY>
    <TR>
      ...
      <td style="PADDING-LEFT: 50px"><input  name="stuffQuery.title" value="<s:property value="stuffQuery.title"/>" style="MARGIN-RIGHT: 20px"  />
          <select style="MARGIN-RIGHT: 20px" 
		   ...
		   <input type="button"  onClick="searchTree()" value="点此选择" />
                    | 时间
                    <input  onClick="setday(this)" name="stuffQuery.createTimeStart" value="<s:date name="stuffQuery.createTimeStart" format="yyyy-MM-dd HH:mm:ss" />"  style="MARGIN-RIGHT: 8px" value="从这个时间" />
                    至 
                    <input onClick="setday(this)" name="stuffQuery.createTimeEnd" value="<s:date name="stuffQuery.createTimeEnd" format="yyyy-MM-dd HH:mm:ss" />" style="MARGIN-RIGHT: 8px" value="到这个时间" /></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="33" class=picback><a href="" >最新资源</a></td>
      </tr>
    </table>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td class="dibaikuang2"><A 
                        href="" class=font01><s:property  value="title" /></A></td>
        </tr>
        </s:iterator>
      </table>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <table width="690" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
        	 <s:if test="qstuffs.size==0||qstuffs==null">暂无符合条件的资源</s:if>
		    <s:else>
          ...
          <TBODY>
            <TR>
              <TD class=heicu14 height=30 vAlign=middle><A 
                        href="question_stuffPreview_index.action?qstuff.id=<s:property value="id"/>" class=STYLE5><s:property  value="title" /></A></TD>
            </TR>
            <TR>
       ...
       <form action="question_stuffList_index.action" method="post" name="ddd">
										<s:hidden name="pN" id="pageNow"></s:hidden>
										<s:hidden name="pS"></s:hidden>
										<input type="hidden" name="isSeach" value="1"/>
										<input type="hidden" name="stuffQuery.stuffExt" value="<s:property value="stuffQuery.stuffExt"/>"/>
										<input type="hidden" name="stuffQuery.title" value="<s:property value="stuffQuery.title"/>"/>
										<input type="hidden" name="stuffQuery.parentid" value="<s:property value="stuffQuery.parentid"/>"/>
										<input type="hidden" name="stuffQuery.createTimeStart" value="<s:property value="stuffQuery.createTimeStart"/>"/>
										<input type="hidden" name="stuffQuery.createTimeEnd" value="<s:property value="stuffQuery.createTimeEnd"/>"/>
									</form>
									<script type="text/javascript">
						function page(i){
