...
<%@page import="com.sopia.questionman.entities.StuffLib"%>
...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function queding(){
				var cks= document.getElementsByName("stufflib.parent.id");
				var m =0;
				...
				<table width="100%" align="left" cellpadding="0" cellspacing="1">
					<tr>
						<td width="120" height="30" align="right" >
							<span class="neededitem">*</span>资源类别：<%
							StuffLib uu = ((StuffLib) request
											.getAttribute("StuffLib"));
									String xx = "0";
						...
						<td >&nbsp;
							<label>
								<wysLib:stuffTree did="0" iname="stufflib.parent.id"
										itype="ra_2no" ivalue="<%=xx%>" iid="${qstuff.id}" ></wysLib:stuffTree>
							</label>
						</td>
					</tr>
					<tr>
