...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="250" height="122" align="center" background="/images/newversion/bgbt001.jpg"><a href="myelclass_view.action?elclass.id=<s:property value="elclass.id" />&Return=stclalist" style="font-size:30px;font-weight:bold;color:white;" target="_blank">进入学习</a></td>
  </tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="250" height="122" align="center" background="/images/newversion/bgbt001.jpg"><a 
																onclick="javascript:applyClass(<s:property value="elclass.isuserApp"/>,<s:property value="elclass.id"/>,'class_view2');return true;" style="cursor: pointer;font-size:30px;font-weight:bold;color:white;">我要学习
															</a></td>
  </tr>
</table>
									...
									<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
										<TBODY>
											<TR>
												<TD height=200 align=left vAlign=top class="bline3"
		...
		<form action="submitAppalyClass.action" name="SQ" method="post">
			...
			<script type="text/javascript">
				function applyClass(is,id,Return){ 
							...
							//	alert('申请已提交，请等待审核结果！'); 
								SQ.submit();  
								window.open("myelclass_view.action?elclass.id="+id+"&Return=stclalist");
							} 
							if(is == 2){ 
