...
<HTML>
	<HEAD>
		...
		<TITLE>五矿发展员工职业发展系统--<s:property value="news.ntype.name" />--列表</TITLE>
		<base href="<%=basePath%>">
						...
						<tr>
										...
										<td>
											<table style="margin-top: 8px;" cellspacing="0"
												...
												<tbody>
													<tr>
														<td width="5" height="5">
															<img height="5" src="images/knowledge/zhao_21.gif"
																width="5" />
														</td>
														<td width="662" background="images/knowledge/zhao_22.gif"></td>
														<td width="5">
															<img height="5" src="images/knowledge/zhao_23.gif"
																width="5" />
														</td>
													</tr>
													<tr>
														...
														<td class="renmen2" id="renmen2"
															...
															<table width="96%" border="0" align="center"
																...
																<tr>
																	<td>
																		<span class="STYLE6">新闻资讯组合搜索</span>
																	</td>
													...
													<tr>
														<td height="6">
															<img height="5" src="images/knowledge/zhao_26.gif"
																width="5" />
														</td>
														<td background="images/knowledge/zhao_27.gif"></td>
														<td>
															<img height="5" src="images/knowledge/zhao_28.gif"
																width="5" />
														</td>
													</tr>
												</tbody>
													...
													<tr>
														...
														<td class="renmen2" id="renmen2"
															...
															<table width="96%" border="0" align="center"
																...
																<tr>
																	<td>
																		<span class="STYLE6">新闻资讯栏目导航</span>
																	</td>
																	<td width="60" align="center">
																		<a href="#"></a>
																	</td>
													...
													<tr>
														...
														<td height="200" align="left" valign="top"
															...
															<%
																...
																String url = "newsIndex.action?&news.ntype.id="
																		+ news.getNtype().getId() + "&ntype.id=";

																//String url = "newsIndex.action?news.title=" + news.getTitle()
																//+ "&news.ntype.id=" + news.getNtype().getId()
																//+ "&ntype.id=";
															%>
							...
							<td width="730" valign="top">
                              ...
                              <span class="STYLE6">当前位置：<a href="index.action">首页</a> &gt;&gt;<a href="newsIndex.action?news.title=null&news.ntype.id=15&ntype.id=1">新闻公告</a>&gt;&gt; <a href="stuff_listbyTitle.action?news.id=<s:property value="news.id"/>&news.title">
                                 ...
                                 <s:property value="news.ntype.name" />
                               --%>
															<wysLib:TreeNavigation oid="${ntype.id}" itype="newsTree"
																href="newsIndex.action?ntype.id=" />
														</td>
														<td width="60" align="center">
															<a href="#"></a>
														</td>
											...
											<td height="200" align="left" valign="top"
												...
												<s:iterator value="zxNews">
													<table width="100%" border="0" align="center"
														cellpadding="0" cellspacing="0" class="dibaikuang">
														<tr>
															<td height="35" valign="bottom" class="heicu14">
																<table width="100%" height="30" border="0"
																	...
																	<tr>
																		<td class="STYLE5">
																			<a
																				href="newsIndexView2.action?news.id=<s:property value="id"/>&ntype.id=<s:property value="ntype.id"/>"><s:property
																					value="title" /> </a>
																		</td>
																		<td align="center"></td>
																	</tr>
																	...
																	<tr>
																		<td height="85" valign="top">
																			...
																			<span class="h30">创建者：<s:property
																					value="owner.realname" /> <s:date
																					name="releasetime" format="yyyy-MM-dd HH:mm:ss" />
																			</span>
																		</td>
																	</tr>
																</table>
