											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="70" align="center">
														<a href="newsIndex.action?&amp;news.ntype.id=0&amp;ntype.id=12"
															target="_blank"><img src="elfrontimages/more_1.gif"
																width="34" height="7" border="0" /></a>	
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td height="155" valign="top">
											<table width="210" border="0" align="center" cellpadding="0"
												...
												<zdyLib:zdyloop lablename='前台教学公告重点1条'  xunhuan='' setnull='暂无数据' switches='' include=''  constraint=''    ></zdyLib:zdyloop>
		...
		<table style="margin-top: 5px;" width="960" height="50" border="0"
			...
			<tr>
				<td height="102" align="center" background="elfrontimages/botbg.png"
					...
					<p class="foot">
						湖南省电力公司检修公司运维一体远程培训系统 copyright 2012-2016 all rights reserved
						<br />
						地址：长沙市新韶山东路339号					</p>
			  </td>
			</tr>
