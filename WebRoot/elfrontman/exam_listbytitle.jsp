...
<HTML>
	<HEAD>
		...
		<TITLE>苏柏亚在线五矿发展员工职业发展系统----课程搜索结果列表</TITLE>
		<base href="<%=basePath%>">
          ...
          align="left" height="30"><table width="98%" border="0" align="center" cellpadding="0"
                      ...
                      <tr>
                        ...
                        <td><div style="float: left;">
                           ...
                           <div style="color:red;margin-left:10px;font-size:14px;">全部</div>
                          </div>
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                  ...
                  <tr>
					...
					<form action="exam_listbytitle.action" method="post"
										name="ddd">
													...
													<table width="100%" height="30" border="0" cellpadding="0"
														...
														<tr>
															...
															<td align="right" style="font-weight: bolder;"> 
																...
																erRegistration.PlanRecruitStudents > erRegistration.joinNumber">
