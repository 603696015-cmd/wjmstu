...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<s:form action="order_myorderlistinit.action" method="post" name="assignSearch_assignment" theme="simple">	
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D1E4F5"> 
		      ...
		      <td width="200" bgcolor="#F8FCFE"><s:textfield name="orderid" /></td>
				      <td width="100" align="right" bgcolor="#F8FCFE">订单状态 
				    ...
				    <td width="200" bgcolor="#F8FCFE"><s:select theme="simple"  headerValue="全部" headerKey="1"
							...
							<table width="100%" align="center" cellpadding="2"
								...
								<tr>
									...
									<th width="30" height="30" align="center" bgcolor="#F8FCFE" >
									  状态									</th>
									<th width="70" height="30" align="center" bgcolor="#F8FCFE" >
										详情								</th>
								...
								<s:iterator value="listo">
									...
									<td height="30" align="left" bgcolor="#F8FCFE" style="padding-left:8px;color:blue;">
										...
										<td width="70" height="30" align="center" bgcolor="#F8FCFE" >
