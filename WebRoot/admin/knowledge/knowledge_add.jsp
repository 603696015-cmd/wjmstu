		...
		<div style="margin-top: 0px;">
			<form action="knowledge_add.action" method="post"
				...
				<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CFDBE2">
					<tr>
						...
						<td height="40" align="left" bgcolor="#F8FCFE">
							<input type="text" name="knowledge.title" size="40" id="kTitle" style="margin-left:5px;">
					  </td>
					</tr>
					<tr>
						<td height="40" align="right" bgcolor="#F8FCFE">
							页面图片：						</td>
						<td height="40" align="left" bgcolor="#F8FCFE">
							<input type="text" onMouseOver="getUrlPath(this)"
								name="knowledge.mainimg" id='mainimg' size="40" style="margin-left:5px;">
							(
							<a style="color: black; font-weight: bolder;"
								href="javascript:setUrl('mainimg');" class="textbg5">浏览资源库</a>若该知识是图片类，必须填写！)
					  </td>
					</tr>
					<tr>
						<td height="40" align="right" bgcolor="#F8FCFE">
						...
						<td height="40" align="left" bgcolor="#F8FCFE">
							<input type="text" onMouseOver="getUrlPath(this)"
								name="knowledge.swf" id='swf' size="40" style="margin-left:5px;">
							
							<a style="color: black; font-weight: bolder;"
								href="javascript:setUrl('swf');" class="textbg5">浏览资源库</a>
					  </td>
					</tr>
					<!--<tr>
				...
				<div style="height: 500px; width: 100%; text-align: center;">
					...
					<input type="submit" value="确认提交" class="textbg"
						style="border: none;">
				</div>
			</form>
		</div>
