	...
	<BODY>
		<div id="OutlineDiv">
			 <table id="OutlineTable" width="100%" height="100%" border="0"
				...
				align="top"><br><!-- 
			<a style="clear: both;" href="account_headerAlterInit.action?elUser.id=<s:property value="elUser.id"/>">修改</a> -->
									</td>
								...
								<TR class="pg_add_bottom">
									<TD colspan="7">
										<DIV align="center">
											<!-- <a href="account_alterInit2.action?elUser.id=<s:property value="elUser.id"/>">修改</a> -->
											<a href="account_deleteInit.action?elUser.id=<s:property value="elUser.id"/>">删除</a>
										</div>
									</td>
								</tr>
							</table>
