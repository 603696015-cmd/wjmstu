...
tr {
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
					<wysLib:Navigation ivalue="基础数据添加" />
				</div>
			</li>
		</ul>
				</td>
		...
		<s:form action="eluser_addBasedb.action" method="post" theme="simple"
			...
			<table width="100%" cellpadding="2" cellspacing="1">
				<tr>
					...
					<td>
						<%-- 
							<s:select theme="simple" list="#{1:'工种',2:'职务',3:'职级',4:'岗位',5:'地市'}" name="baseDatat.typeid"/>
						 --%>
						&nbsp;<s:select id="selectTypeId" theme="simple" list="baseDataTypeList"
							name="baseDatat.typeid" value="baseDatat.typeid" listKey="id"
							listValue="name" />
					</td>
				</tr>
				<tr>
