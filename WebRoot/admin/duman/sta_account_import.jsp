...
<HTML>
	...
	<body>
		...
		<div style="margin-top: 0px; margin-left: 300px;">
			...
			<br>
			<form action="sta_accountImportCheck.action" enctype="multipart/form-data"
				method="post" name="impForm">
				选择需要导入的文档：
				<input type="file" name="st">
				<br>
				<br>
				<input type="submit" value="导 入" style="border: none" class="textbg">
				&nbsp;
		<!-- 		<a href="account_search.action" class="textbg">部门列表</a>
