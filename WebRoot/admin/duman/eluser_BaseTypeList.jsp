		...
		<script type="text/javascript">
			...
			function del(basedbId){
				if(window.confirm("确认删除？")){
					...
					basedb.action="eluser_BaseTypeDel.action";
					basedb.submit();
				}
			}
...
<style type="text/css">
	...
	<body onLoad=" myload()"><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<form action="eluser_BaseTypeList.action" method="post" name="basedb">
				<s:hidden name="bdt.id" id="basedbId" />
...
<!--					</s:if>-->
				...
				<tbody onMouseOut="changeback()" onMouseOver="changeto()">
					<s:iterator value="baseDataTypeList">
						<tr>
...
<!--								<a href="javascript:del1('<s:property value="id" />')">直接删除</a>-->
			...
			<div>
					...
					<span style="margin-right: 50px;"><a
						href="eluser_addBaseTypeInit.action" class=textbg>添加字段内容</a>
					</span>
				</div>
		  <script>
				function page(i){
