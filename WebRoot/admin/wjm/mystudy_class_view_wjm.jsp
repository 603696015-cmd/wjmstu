	...
	<head>
		...
		function refresh1(){
			...
			window.setInterval(function(){
				window.location.href="mystudy_class_view_wjm.action";
			},800);
		}
		</script>
		<style>
													...
													<s:iterator value="myclasses">
														<tr>
															...
															<td valign="middle" bgcolor="#F8FCFE">
																<s:if test="canLearn">
																	<a href="mystudy_course_view_wjm.action?peixunBatch.id=<s:property value="peixunBatch.id"/>&elClass.id=<s:property value='elClass.id' />" class="bt001" style="padding-left: 15px;">
																		<s:property value="elClass.name" />
																	</a>
																</s:if>
																<s:else>
																	<a href="javascript:void(0);" class="bt001" style="padding-left: 15px;">
																		<s:property value="elClass.name" />
																	</a>
																</s:else>
															</td>
															<s:if test="processForElc==100.00">
															...
															<s:elseif test="processForElc==0.00">
																<td width="150" height="40" align="left"
																	bgcolor="#F8FCFE">
																	<div
																		style="BORDER-BOTTOM: #ff6633 1px dotted; BORDER-LEFT: #ff6633 1px dotted; BORDER-TOP: #ff6633 1px dotted; BORDER-RIGHT: #ff6633 1px dotted">
																		<img src="images/jd.gif" width="1%" height="14" />
																	</div>
																</td>
																<td align="center" bgcolor="#F8FCFE">&nbsp;
																...
																<td width="150" height="40" align="left"
																	...
																	<div
																		...
																		<img src="images/jd.gif"
																			width="<s:property value="processForElc" />%"
																			height="14" />
																	</div>
																</td>
																<td align="center" bgcolor="#F8FCFE">
																	...
																	<tr>
																		<s:if test="canLearn">
																			<td height="28" align="center"
																				...
																				<a
																					href="mystudy_course_view_wjm.action?peixunBatch.id=<s:property value="peixunBatch.id"/>&elClass.id=<s:property value='elClass.id' />"
																					class="zc01 STYLE3" style="color: white;">进入学习</a>
																			</td>
																		</s:if>
																		<s:else>
																			<td height="28" align="center"
															...
															<s:if test="processForElc==100.00">
																<s:if test="examRoom==null || examRoom.id==0">
																...
																<s:else>
																	...
																	<s:else>
																		<td align="center" bgcolor="#F8FCFE" class="STYLE1">
																			学习中
																		</td>
																	</s:else>
																</s:else>
															...
															<s:else>
																<s:if test="canExam==1">
																	<td width="100" align="center" bgcolor="#F8FCFE">
																		<!-- 
																		<a name="startExam" target="_blank" href="quizpaperinit.action?classid=<s:property value="elClass.id" />&myroom.examroom.id=<s:property value="examRoom.id"/>"><img src="images/xtb021.gif" width="28"
																				height="27" border="0" /> </a>
																		 -->
																		<a name="startExam" 
																		   href="javascript:enterEroom(<s:property value="examRoom.id"/>,<s:property value="examRoom.examPaper.id"/>,<s:property value="elClass.id" />,0,0);"><img src="images/xtb021.gif" width="28"
																				height="27" border="0" /> </a>
																	</td>
																</s:if>
																<s:else>
																	<td width="100" align="center" bgcolor="#F8FCFE">
																		<img src="images/xtb0212.jpg" width="28" height="27"
																			border="0" />
																	</td>
																</s:else>
															</s:else>
