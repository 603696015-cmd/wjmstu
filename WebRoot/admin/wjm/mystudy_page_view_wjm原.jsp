										...
										<td height="240" valign="top" bgcolor="#F8FCFE">
											...
											<s:else>
												<table width="100%" border="0" cellpadding="5"
																	...
																	<tr>
																		<s:if test="canExam == 1">
																			<td height="28" align="left"
																				...
																				<!-- 
																				<a href='quizpaperinit.action?course.id=<s:property value="courseid" />&myroom.examroom.id=<s:property value="id" />&iscommon=0&elclass.id=<s:property value="elClass.id"/>&coursePage.id=<s:property value="cpage.id" />'
																					style="padding-left: 35px; color: white; font-weight: bold; font-size: 14px;">
																					开 始</a>
																				 -->
																					<a name="startExam" href="javascript:enterEroom(<s:property value="id" />,<s:property value="epid" />,<s:property value="elClass.id"/>,<s:property value="courseid" />,<s:property value="#cpid"/>);"  style="padding-left: 35px; color: white; font-weight: bold; font-size: 14px;">
																					开 始
																					</a>
																			</td>
																		</s:if>
													...
													<tr>
														<td align=center valign="center" bgcolor="#F8FCFE" colspan=8>
															<a href="vocabulary_search.action?vocabulary.status=1&course.id=<s:property value="course.id" />course.ctype.id=<s:property value="course.ctype.id" />" class="STYLE1" >--词汇--</a>
														</td>
													</tr>
												</table>
											</s:else>
