	...
	<body onload="iframe();">
		<div id="container">
							...
							<tr>
								...
								<td width="240">
									<DIV id=menu2_bg>
										<DIV class=menu2>
											<LI>
												<A href="wjm_user_center.action">个人首页</A>
											</LI>
											<LI>
			...
			<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><iframe src="${module}?intelligentLogin.loginType=<s:property value="intelligentLogin.loginType" />" id="rightFrame" name="rightFrame" align="middle" width="100%" height="100%"
