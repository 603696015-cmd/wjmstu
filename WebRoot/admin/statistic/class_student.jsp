...
<HTML>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<script type="text/javascript">
			function toexcel(id){     
				assignSearch_assignment.action = "class_student.action?export=true&dep.id="+id;
				assignSearch_assignment.submit();
			}
			function view(){     
				assignSearch_assignment.action = "class_student.action";
				assignSearch_assignment.submit();
			}						
		</script>
		<div style="margin-top: 0px;">
			<s:form action="class_student" method="post"
				...
				<table width="100%" cellpadding="1" cellspacing="1">
					...
					<tr>
						...
						<td colspan="2">
							<input type="button" class="textbg4" value="搜索" onClick="view()">&nbsp;&nbsp;<s:property value="deptid.id" /> 
				...
				<tr>
					<td valign="top" width="150px;">
						<%
							...
							String url = "class_student.action?elclass.id=" + elclass.getId()
									+ "&elUser.id=0&deptid=";
						%>
		...
		<form action="class_student.action" method="post" name="acc_list">
