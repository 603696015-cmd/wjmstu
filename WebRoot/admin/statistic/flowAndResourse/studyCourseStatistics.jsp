...
<HTML>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="在线学习统计" /></div>
			</li>
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			<form action="studyCourseStatistics.action" method="post" name="recordInfo">
			...
			<table width="100%" align="center" cellpadding="1" cellspacing="1">
				...
				<s:iterator value="statisticobj.queryobjs">
					<tr>
						...
						<td height="30" align="center" >
							<s:if test="coursePage.id==0"><font color="red">无章节</font></s:if>
							<s:else>
								<s:property value="coursePage.title" />
							</s:else>
						</td>
						<td height="30" align="center" >
							<s:date name="course.begintime" format="yy-MM-dd HH:mm:ss"/>
						</td>
						<td height="30" align="center" >
							<s:date name="course.endtime" format="yy-MM-dd HH:mm:ss"/>
						</td>
					</tr>
				</s:iterator></tbody>
		  </table>
