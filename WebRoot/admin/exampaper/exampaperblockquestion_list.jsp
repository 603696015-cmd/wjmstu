...
<s:if test="epBlock.questions.size!=0">
	<s:set name="blockquestionsize" value="epBlock.questions.size"></s:set>
	<table width="1000" align="center" cellspacing="1" style="margin: 0px">
		<tr>
			<td align="center" >
				编号
			</td>
		...
		<s:iterator value="epBlock.questions" status="epb">
			<tr>
				<td align="center" >
				...
				<td align="center" >
					<a class="textbg4"
						onclick="deleteexampaperblockquestions(<s:property value="epBlock.id"/>,<s:property value="id"/>);return false;"
						href="#">删除</a>
				</td>
				<s:if test="sortid!=1">
					<td align="center" >
						<a class="textbg4"
							onclick="upexampaperblockquestions(<s:property value="epBlock.id"/>,<s:property value="sortid"/>);return false;"
							href="#">上移 </a>
					</td>
				</s:if>
				<s:else>
				...
				<s:if test="sortid!=#blockquestionsize">
					<td align="center" >
						<a class="textbg4"
							onclick="downexampaperblockquestions(<s:property value="epBlock.id"/>,<s:property value="sortid"/>);return false;"
							href="#">下移 </a>
					</td>
				</s:if>
				<s:else>
			...
			<s:if test="qtype==8">
				<tr>
					<td align="left" bgcolor="#ECEDEB" colspan="8">
						<a class="textbg4"
							onclick="alterexampaperblockquestionsinit(<s:property value="epBlock.id"/>,<s:property value="id"/>);return false;"
							href="#">修改</a>评分规则 
						 范文字数： <s:property value="fwsize" />
						<!-- 分 ，准确分：
			...
			<s:if test="qtype==9">
				<tr>
					<td align="center" bgcolor="#ECEDEB" colspan="8">
						<a  class="textbg4"
							onclick="alterexampaperblockquestionsinit(<s:property value="epBlock.id"/>,<s:property value="id"/>);return false;"
							href="#">修改</a>评分规则 发 给：
