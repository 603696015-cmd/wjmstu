...
<table width="530" align="center" cellpadding="1" cellspacing="1"
		...
		<td >
			<label>
				<input name="epBlock.sortid" type="text" id="sortid"
					value="<s:property value="epBlock.readsort"/>" size="6" />
			</label>
		</td>
	</tr>
	<s:if test="epBlock.type == 15||epBlock.type == 16||epBlock.type == 17||epBlock.type == 18||epBlock.type == 19||epBlock.type == 20">
		<tr >
			<td width="100" align="center"  >
	...
	<s:if test="epBlock.type == 17">
	<tr>
		<td  align="center"  >
			角色扮演标注：					</td>
		<td  colspan="3">
			<label>	
			<input name="epBlock.cosPlayRemark" id="cosPlayRemark" size="40"
					value="<s:property value="epBlock.cosPlayRemark"/>" type="text"
					 />
				(
				<a style="color: black; font-weight: bolder;"
					href="javascript:setUrl('cosPlayRemark');" >浏览资源库</a>)</label>
	  </td>
	</tr>
	</s:if>
