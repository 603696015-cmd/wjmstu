...
<!--
	...
	function setEpbType(obj){
		obj.value=obj.options[obj.selectedIndex].value;
		if(obj.value>=15 && obj.value <=20){
			document.getElementById("wjmepbtype").style.display = "block";
		}else{
			document.getElementById("wjmepbtype").style.display = "none";
		}
	}
//-->
</script>
<table width="560" align="center" cellpadding="1" cellspacing="1"
	...
	<tr>
		<td width="100" align="center" >
			<span class="neededitem">*</span>大题名称1
		</td>
	...
	<tr>
		...
		<td >
			<select onchange="epblockshowrule();setEpbType(this);" name="epBlock.type" id="epbtype">
				...
				<option value="115" id="type_115">
					阅读题
				</option>
				<!-- 
				<option value="21" id="type_21">
					看图选择2
				</option>
				 -->
			</select>
	...
	<tr id="wjmepbtype" style="display:none;">
		<td width="100" align="center"  >
	...
	<tr>
		<td width="100" align="center" style="font-weight:bolder;">
			<span class="neededitem">*</span>排序
		</td>
		<td >
			<label>
				<input name="epBlock.sortid" type="text" id="sortid"
					value="0" size="6" />
			</label>
		</td>
	</tr>
...
<script type="text/javascript">
	...
	if( epbtype==15||epbtype==16||epbtype==17||epbtype==18||epbtype==19||epbtype==20){
