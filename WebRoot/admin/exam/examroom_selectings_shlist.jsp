...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="考场练习终审" /></div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">考场终审</span>
			</li>-->
		</ul>
		<!-- 内容 -->
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td width="200px" valign="top"
						...
						<wysLib:eroomLibTree
							href="examroom_selectings_shlist.action?sublibs=1&str=eroomlib&eroomLib.id="
					...
					<td> 
						<form action="examroom_selectings_shlist.action?eroomLib.id=<s:property value="eroomLib.id"/>" method="post" name="examFh">
								...
								<s:iterator value="examRooms"> 
									<tr>
										...
										<td width="80" height="30" align="center" >
											<font color="<s:if test="svalid==1">green</s:if>">
									  ...
									  <td width="70" height="30" align="center" >
										...
										<td width="220" height="30" align="center" >
											...
											<s:if test="svalid == 3">  
												...
												<a href="CRE_notelistInit.action?examRoom.id=<s:property value="id"/>&Return=examroom_selectings_shlist" target="_blank" class="textbg4">备 注</a> 									
											</s:if> 
										</td>
									</tr> 
								</s:iterator></tbody>
							...
							<form action="examroom_sh_s.action" name="examroom_sh_s" method="post">
								...
								<s:hidden name="Return" id="Return" value="examroom_selectings_shlist"></s:hidden>
							</form>  
