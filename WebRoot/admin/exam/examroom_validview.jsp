...
<HTML>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
				  	...
				  	<div>
				  		<div style="float:left">
				  		 ...
				  		 <div>
				  			  ...
				  			  <div >结&nbsp;束&nbsp;ip：<s:property value='ipEnd'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  			  </div>
				  	        </s:iterator>
				  		 </div>
				  	</div>
			...
			<br />	
			<s:if test="null==Return|Return==''"><input class="textbg" style="border: none;" type="button"
				value="返回考场复核"
				onclick="document.location='examroom_validlist.action'" />
			</s:if>
			<s:if test="Return=='clauvalid'"><input class="textbg" style="border: none;" type="button"
				value="返回结业复核"
				onclick="document.location='elclass_examroom_validlist.action'" /></s:if>
