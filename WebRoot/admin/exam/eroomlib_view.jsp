			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td width="200px;" valign="top">
						<wysLib:eroomLibTree did="0"
							href="eroomlib_view.action?eroomLib.id="></wysLib:eroomLibTree>
					</td>
					<td valign="top" style="padding: 0px;">
						<table width="100%" style="margin: 0px" height="100%" align="center"
							...
							<tr>
								...
								<td>
									<label>
										<s:property value="eroomLib.description" />
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label>
										<s:property value="eroomLib.parent.name" />
									</label>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<a
										href="eroomlib_alterInit.action?eroomLib.id=<s:property value="eroomLib.id" />"
										class=textbg5>编 辑</a>


									<s:if test="#session.roleid==1">
										<a
											href="eroomlib_deleteInit.action?eroomLib.id=<s:property value="eroomLib.id" />"
											class=textbg5>删 除</a>
									</s:if>
									<s:else>
									...
									<input style="border: none;" onClick="document.location='eroomlib_list.action'" class="textbg5" type="button" value="返回考场类别">
									<input style="border: none;" onClick="document.location='eroomlib_addInit.action'" class="textbg5" type="button" value="添加新类别">
