...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="类别添加" /></div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">添加考场批次新类别</span>
			</li>
			<li class="sep">
			</li>
			<li>
				<a style="cursor: hand"
					...
					href="eroom_batchlib_list.action">考场批次类别管理</a>
			</li>-->
		</ul>
		<!-- 内容 -->
		<div style="margin-top: 0px;">
			<s:form action="eroom_batchlib_add" method="post" name="catalog_info"
				...
				<table width="600px" align="left" cellpadding="1" cellspacing="1"
					...
					<tr>
						...
						<td >
							<input class="textbg6" style="height:35px;" type="submit" value="确认添加">
						</td>
					</tr>
				</table>
				<br>
