	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<table width="600" align="center" cellpadding="1" cellspacing="1">
			<caption>
				...
				<s:if test="examRoom.id != 0 && examRoom.id != 0 && elclass.id != 0">结业考场</s:if>
				<s:else>
			...
			<tr>
				<td bgcolor="#FFFFFF" style="font: 12px; padding: 5px;" align="center" colspan="6">
					<a
						href="CRE_note_addInit.action?examRoom.id=<s:property value="examRoom.id"/>&course.id=<s:property value="course.id"/>&elclass.id=<s:property value="elclass.id"/>&Return=<s:property value="Return"/>"
						style="width: 80px;padding: 3px 0px 3px 0px;" class="textbg4">填写备注</a>
