			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td width="200px" valign="top" id="tree_list_td" style="display:none">
						<wysLib:eroomLibTree
							href="examroom_application_delete_shlist.action?sublibs=1&str=eroomlib&eroomLib.id="
					...
					<td>
						<form action="examroom_application_delete_shlist.action"
				...
				<input size="16" type="text" onclick=setday(this)
							...
							<tbody onMouseOut="changeback()" onMouseOver="changeto()">
								<s:iterator value="examRooms">
									...
									<tr>
										...
										<td align="center">
											<a
												href="erwithout_view.action?examRoom.id=<s:property value="id"/>&Return=delsh"
												class="textbg4">查看</a>
											<a style="cursor: pointer;"
												onClick="sh(<s:property value="id"/>,9);" class="textbg4">允许</a>
											<a style="cursor: pointer;"
				      ...
				      <s:hidden name="examRoom.id" id="examRoom.id"></s:hidden>
							...
							<s:hidden name="Return" id="Return"
								value="examroom_application_delete_shlist"></s:hidden>
						</form>
