...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function doSubmit(op){
				if(op==1){
					myForm.action="examprac_quiz_Overview.action";
				}else{
					myForm.action="examprac_quiz_Detail.action";
				}
				myForm.submit();
			}
			function init(){
				//alert(document.getElementById("exampracId").value);
				//alert(document.getElementById("departmentId").value);
				if(document.getElementById("exampracId").value>0){
					document.getElementById("pracTitle").innerHTML= document.getElementById("exampracName").value;
				}
	...
	<body onload="init();">
		...
		<div style="font-size:15px;text-align:center;margin-top:10px;">练习答卷组合搜索</div>
				...
				<TBODY style="text-align:center;">
					<tr>
						...
						<td style="text-align:left;">
							<span id="pracTitle" style="font-size:14px;width:200px;text-align:center;"></span>
							<a href="#" onClick="searchExampracInit();return false;">点此进行选择</a>
						</td>
				    </tr>
				    <tr>
						<td width="150px" height="30px">
				    ...
				    <tr>
						...
						<td>
							<s:select cssStyle="width:150px;" headerKey="-1" headerValue="不限" name="elUser.gangwei" cssClass="g-select"
