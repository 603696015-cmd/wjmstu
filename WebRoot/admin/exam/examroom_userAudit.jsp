			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top" id="tree_list_td" style="display:none" width="200px">
						<wysLib:eroomLibTree
							href="examroom_userAudit.action?sublibs=1&str=eroomlib&eroomLib.id="
					...
					<td>
						<form
							action="examroom_userAudit.action?eroomLib.id=<s:property value="eroomLib.id"/>"
							...
							<tbody onMouseOut="changeback()" onMouseOver="changeto()">
								<s:iterator value="examRooms">
									<tr>
										...
										<td align="center">
											<a
												href="examroom_auditUserlist.action?examRoom.id=<s:property value="id" />"
												class="textbg6">查看人员</a>
										</td>
									</tr>
								</s:iterator>
							</tbody>
						...
						<form action="examroom_sh_p.action" name="examroom_sh_p"
							...
							<s:hidden name="Return" id="Return" value="examroom_userAudit"></s:hidden>
						</form>
