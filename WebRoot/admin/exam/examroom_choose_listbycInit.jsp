	...
	<script type="text/javascript">
		function del(id){
			if(window.confirm("确定删除？")){
				window.location.href="erwithout_delete.action?examRoom.id="+id;
			}
		}
	</script>
	</HEAD>
					...
					<table width="96%" align="center" cellspacing="1" cellpadding="1">
						...
						<tbody onMouseOut="changeback()" onMouseOver="changeto()">
						 ...
						 -->
									...
									<td height="30" align="center">
										<a href="javascript:del(<s:property value="id"/>);" class="textbg">删除</a>
										<s:if test="valid == 0 && uvalid == 0">
											...
											<a
												...
												class="textbg">分配学员</a>
											<a
												href="examroom_importScoreInit.action?examRoom.id=<s:property value="id"/>&course.id=<s:property value="course.id"/>&course.classid=<s:property value="classId"/>"
												class="textbg">导入成绩</a>
										</s:if>
