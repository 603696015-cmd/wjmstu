      ...
      <tr>
        <td align="center" valign="top"><table width="80%" height="80%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<br>
			<a href="examroom_choose_listbycInit.action?course.id=<s:property value="course.id" />&classId=<s:property value="course.classid" />&Return=elclass_alterInit">返回</a></td>
                </tr>
