	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
						...
						<div id="eps_div">
							<s:iterator value="examRoom.exampapers" status="epsst">
								<div>
									...
									<span style=""> 达标线<s:property value="passgrade" /> </span>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<a target="top" class="textbg4"
										href="exampaper_preview.action?examPaper.id=<s:property value='id' />">预览</a>
									达标线：
									<b><s:property value="passgrade" /> </b> %&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;可考次数：
									<b><s:property value="quizcount" /> </b> 成绩取：
									<b><s:if test="passmanner==1"> 平均分</s:if> <s:if
											test="passmanner==0">最高分 </s:if> </b> 答卷可看：
									<b><s:if test="quizlook==1">是</s:if> <s:if
											test="quizlook==0">否</s:if> </b> 成绩可看：
									<b><s:if test="scorelook==1">是</s:if> <s:if
											test="scorelook==0">否</s:if> </b>
									<%-- 
									<lable name="prac">
			...
			<s:if
				...
				<input class="textbg" style="border: none;" type="button"
					value="修改考场"
					onclick="document.location='erwithout_alterInit.action?examRoom.id=${examRoom.id }'" />
