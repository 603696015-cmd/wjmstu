				...
				<div id="ep_baseinfo">
				  <table width="100%" align="center" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<td bgcolor="#F8FCFE" colspan="3">
								<input type="text" name="vocabulary.yingwen" id="yingwen"/>
							</td>
						</tr>
						<tr>
							<td height="25px" align="right" bgcolor="#F8FCFE">
							...
							<td bgcolor="#F8FCFE" colspan="3">
								<input type="text" name="vocabulary.pinyin" id="pinyin"/>
							</td>
						</tr>
						<tr>
							<td height="25px" align="right" bgcolor="#F8FCFE">
								<span class="neededitem">*</span>例句：							</td>
							<td bgcolor="#F8FCFE" colspan="3">
								<script type="text/javascript">
								...
								function addSt(){
									...
									var stuff = document.createElement("div");
									stuff.id= "ds_"+ii;
									stuff.innerHTML="名称：<input type='text' style='width:200px;' name='vocabulary.wenziliju' id='stufftt_"+ii+"'/><input type='hidden' style='width:200px;' name='vocabulary.lijudizhi' id='stuff_"+ii+
						    ...
						    <div id="stuff"></div>
						<!-- 	 <input type="hidden" name="vocabulary.lijudizhi" id="stuff_1"
									size="40" />  -->
						...
						<tr>
							...
							<td bgcolor="#F8FCFE" colspan="3">
							  <label>
									<textarea name="vocabulary.wenzijieshi" id="ep_description"
