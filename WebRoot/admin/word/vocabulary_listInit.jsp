...
<HTML>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
			<s:form action="vocabulary_listInit" name="myelist" theme="simple">
				...
				<table width="100%" cellpadding="1" cellspacing="1">
					<tr>
						...
						<td valign="top">
											...
											<tr>
												...
												<td width="285" height="30" align="center" colspan="2">
													<a 
														...
														class=textbg4>查 看</a>
														<a
															href="vocabulary_alterInit.action?vocabulary.id=<s:property value="id" />&target=1"
															class=textbg4>修 改</a>
													<a
														href="vocabulary_delete.action?vocabulary.id=<s:property value="id" />&target=1"
														class=textbg4>删 除</a>												
												</td>
											</tr>
										</s:iterator>
							...
							<input class=textbg6 style="height: 35px;" type="button"
								value="导入词汇"
								onclick='window.location = "word_importInit.action"'>
