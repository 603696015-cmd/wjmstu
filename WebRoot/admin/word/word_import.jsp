...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; margin-left: 80px;">
			<h3>
				注意 ，系统当前支持导入excel文档，请注意文档格式要与下载格式一致!
		  </h3>
			<br>
			
			<form action="word_importCheck.action" onSubmit="return check_xx();"
				...
				<br>
				<br>
				<input class=textbg style="border: none;" type="submit" value="导入词汇">　　				
				　<a href="download.jsp?filename=elstuffs/all_type_words.xls"  class=textbg>词汇格式下载</a>
				　<a href="vocabulary_listInit.action"  class=textbg>返回词汇列表</a>
				<font color="red"><br>
				<br>
