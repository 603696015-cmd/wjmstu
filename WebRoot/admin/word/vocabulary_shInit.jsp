...
<HTML>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
			<s:form action="vocabulary_shInit" name="myelist" theme="simple">
									...
									<tbody onMouseOut="changeback()" onMouseOver="changeto()">
										<s:iterator value="vocabularys">
											<tr>
												...
												<td width="182" height="30" align="center">
													<a href="vocabulary_view.action?vocabulary.id=<s:property value="id" />">查看</a>
												</td>	
												<td width="285" height="30" align="center" colspan="2">
													<a href="vocabulary_alterInit.action?vocabulary.id=<s:property value="id" />&target=2">修改</a>
													<s:if test="status==1">
														<a href="alterVocaSta.action?vocabulary.status=0&vocabulary.id=<s:property value="id" />">不通过</a>
													</s:if>
													<s:else>
														<a href="alterVocaSta.action?vocabulary.status=1&vocabulary.id=<s:property value="id" />">通过</a>
													</s:else>											
												</td>
											</tr>
										</s:iterator>
