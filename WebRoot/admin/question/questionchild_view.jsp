...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			...
			<!--<li>
				<span style="font-weight: bold;">查看材料题小题</span>
			</li>
			<li class="sep">
			</li>
			<li>
				<a style="cursor: hand"
					...
					href="questionchild_alterInit.action?question.id=<s:property value="question.id"/>">编辑材料题小题</a>
			</li>
			<li class="sep">
			</li>
			<li>
		...
		<br>
								<a
									href="questionchild_add_type.action?question.parent.id=<s:property value="question.id"/>">添加小题</a>
							</s:if>
							<s:else>
				...
				<tr>
					<td height="30" align="center" bgcolor="#ECEDEB" colspan=2>
							<a
								href="questionchild_alterInit.action?question.id=<s:property value="question.id"/>">修改</a>
					</td>
				</tr>
			</table>
		</div>
