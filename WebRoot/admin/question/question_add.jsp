							...
							<table width="100%" align="center" cellpadding=0 cellspacing="1"
								...
								<tr>
									...
									<td align=left>
										...
										<a class="textbg4" href='javascript:addQuestion(21);'>看图选择2</a>
										<a class="textbg4" href='javascript:addQuestion(115);'>阅读题</a>
									</td>
								</tr>
								<tr>
											...
											<div>
												...
												<s:if test="question.qtype==17">
													<span>前半截媒体文件：<input type="text" size="65"
															name="question.frontHalfMediaFile" id="frontHalfMediaFile" /> <a
								...
								<s:if
									test="question.qtype==2||question.qtype==3||question.qtype==4||question.qtype==15||question.qtype==16||question.qtype==18||question.qtype==115">
									<tr>
										<td height="30" width="150" align="center">
