		...
		<script type="text/javascript">
			<s:if test="question.qtype==2||question.qtype==3||question.qtype==4">
				...
				function addOption(){
					...
					/*
					if(nowCount==0){
					obj.innerHTML ="选项"+String.fromCharCode(65+parseInt(nowCount))+"&nbsp;&nbsp;<input type='hidden' id='__option"+nowCount+"' name='question.options'></textarea>"+
			...
			function myload(){
				...
				<s:if test="question.qtype==5||question.qtype==6">addBlankAnswer( );</s:if>
			}
						...
						<td valign="top">
							<table width="120px" align="left" border="1" cellspacing="1"
								...
								<tr>
									<td height="20">
										<a
											href='questionchild_addInit.action?question.qtype=1&question.parent.id=<s:property value="question.parent.id"/>'>判断题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a
											href='questionchild_addInit.action?question.qtype=2&question.parent.id=<s:property value="question.parent.id"/>'>单选题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a
											href='questionchild_addInit.action?question.qtype=4&question.parent.id=<s:property value="question.parent.id"/>'>多选题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a
											href='questionchild_addInit.action?question.qtype=5&question.parent.id=<s:property value="question.parent.id"/>'>填空题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a
											href='questionchild_addInit.action?question.qtype=6&question.parent.id=<s:property value="question.parent.id"/>'>问答题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href="question_view.action?question.id=<s:property value="question.parent.id"/>">返回材料题</a>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" align="center" cellpadding=1 cellspacing="1"
								...
								<tr>
									...
									<td align="left" >
										<label style="font-size: 16px; font-weight: bold;">
											<s:property value="question.parent.title" />
										</label>
									</td>
								</tr>
								<tr>
								...
								<s:if test="question.parent.id!=0">
									<tr>
										...
										<td align="left" >
											<s:textfield name="question.scoreper" cssStyle="width:50px;"
												value="10" />%
										</td>
									</tr>
								</s:if>
								<tr>
									<td height="30" width="100px;" align="center" >
										<b>试题类别</b>
									</td>
									<td align=left >
										<label style="font-size: 16px; font-weight: bold;">
								...
								<tr>
									...
									<td align="left" >
										<s:textarea cols="50" rows="4" name="question.title"
											id="qtitle" />
										<s:hidden value="1" name="question.qlevel" />
									</td>
								</tr>
								 --%>
								<tr>
								...
								<tr>
									<td height="30" align="center" bgcolor="#ECEDEB" colspan=2>
										...
										<input type="hidden" value="<s:property value="question.parent.qlib.id" />" name="question.qlib.id" />
