			...
			<table width="100%" align="center" cellpadding="2" cellspacing="1" >
				...
				<s:iterator value="answers">
					<tr>
						...
						<td align="center" >
							<s:if test="status==1">
								<a href="noverifyAnswer.action?answer.id=<s:property value="id"/>&returnPage=verifyAnswerList">不通过</a>
							</s:if>
							<s:if test="status!=1">
								<a href="verifyAnswer.action?answer.id=<s:property value="id"/>&returnPage=verifyAnswerList">通过</a>
							</s:if>
						</td>
					</tr>
				</s:iterator>
