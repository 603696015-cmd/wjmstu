		...
		<table width="900" border="0" align="center" cellpadding="0"
					cellspacing="0" style="margin-top:20px;">
						<tr>
							...
							<td height="45" align="center" valign="middle" background="images/bg002.jpg"
								>
					...
					<s:form action="academicCourseInfo.action" method="post" theme="simple"
						name="academicCourseInfo" onsubmit="return _onSubmit();">
					<s:hidden name="pN" id="pageNow"></s:hidden>
					<s:hidden name="pS"></s:hidden>
					<s:hidden name="elClass.id" id="elClass.id"></s:hidden>
					<s:hidden name="course.id"  id="course.id"></s:hidden>
						<s:if test="academicCourseInfos.size()==0">
							<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="200" align="center" bgcolor="#F8FCFE"><span class="STYLE2">暂 无 数 据 </span></td>
  </tr>
</table>
 <p>&nbsp;</p>
				<p>&nbsp;</p>
...
<td valign="top"><table width="900" border="0" align="center" cellpadding="1"
					cellspacing="1" bgcolor="#CFDBE2">
								...
								<s:iterator value="academicCourseInfos">
									<tr>
										<td align="center" valign="middle" bgcolor="#F8FCFE"
											>
											<p align="center">
										...
										<td width="120" align="center" valign="middle" bgcolor="#F8FCFE"
											...
											<table width="95" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td height="28" align="center" valign="middle" background="images/textbg.jpg"><a href="myquizpaperlist.action?examPaper.id=<s:property value="course.examRoom.examPaper.id" />&examRoom.id=<s:property value="course.examRoom.id" />"><span style="font-size:14px;font-weight:bold;color:white;">查 看</span></a></td>
                                              </tr>
                                            </table>									  </td>
									</tr>
								</s:iterator>
