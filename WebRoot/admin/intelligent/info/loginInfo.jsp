...
.STYLE2 {
	...
	<s:else>
					<form action="loginInfo.action" name="loginInfo" method="post">
					...
					<table width="900" border="0" align="center" cellpadding="1"
						...
						<tr>
							...
							<td width="140" align="center" valign="middle" background="images/bg002.jpg"
								>
					...
					<s:iterator value="loginInfos">
						...
						<tr>
							<td height="50" align="center" valign="middle" bgcolor="#F8FCFE"
								>
								<p align="center">
									合计								</p>
						  </td>
							<td colspan=2 align="center" valign="middle" bgcolor="#F8FCFE"
								>
								<p align="center">
									学习天数：<s:property value="loginDays" />天
								</p>
						  </td>
							<td width="240" colspan=2 align="center" valign="middle" bgcolor="#F8FCFE"
								>
								<p align="center">
									<s:if test="intelligentTutoringPoints.scoreLogin>10">
										得分：<s:property value="intelligentTutoringPoints.scoreLogin" />分（超过10分按照10分计算）
									</s:if>
									<s:else>
										得分：<s:property value="intelligentTutoringPoints.scoreLogin" />分
									</s:else>
								</p>
						  </td>
						</tr>
					...
					<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="50" align="center" valign="middle" bgcolor="#F8FCFE"><wysLib:page></wysLib:page></td>
  </tr>
</table>
