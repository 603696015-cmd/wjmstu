...
<HTML>
	<HEAD>
		...
		function page(i){
			...
			intelligentStatistics.submit();
		}
		
		function showIntelligent(userid,classid){
			document.getElementById("exprot").value=false;
...
tr {
	...
	<BODY>
		...
		<div style="margin-top: 0px; text-align: center;" class="divClass">
			<form action="intelligentStatistics.action"
				name="intelligentStatistics" method="post">
				...
				<table width="980px" align="center" cellpadding="1" cellspacing="1">
					<tr>
						<td width="300" height="30" align="center">
							部门：<input type="text" name="searchDep.name" readOnly onclick="searchDepInit();" />
						</td>
						<td width="300" height="30" align="center">
							姓名：<input type="text" name="searchUser.realname"  />
						</td>
						<td width="300" height="30" align="center">
							<input type="button" name="查询" value="查询" onclick="intelligentStatistics.submit();" />
						</td>
					</tr>
				</table>
			</form>
			<form action="viewIntelligentByUserid.action" name="intelligent"
				method="post">
				...
				<s:iterator value="elUsers">
					<tr>
						...
						<td width="100" height="30" align="center">
							<s:if test="nowClass.id>0">
								<a class="textbg4"
									href="javascript:showIntelligent(<s:property value="id" />,<s:property value="nowClass.id" />);">查看</a>
							</s:if>
							<s:else>
							</s:else>
						</td>
