	...
	<BODY>
		...
		<div style="margin-top: 40px; text-align: left; margin-left: 20px;">
			<form name="message_management" id="message_management"
				action="template_add.action" method="post">
				<input type="hidden" name="operate" value="send" />
				<label>
					模 板 名
					<input name="template.name" type="text" id="title" value=""
						size="30" />
				</label>  
				<br/> 
				<label>
				说　　明
				<textarea rows="10" cols="40" name="template.remark"></textarea>
				</label> 
				<br/>
				<input class="textbg4" type="submit" name="submit" value="添加" />
