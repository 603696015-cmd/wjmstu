...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%">
				<tr> 
				<td>您本次订购共分配${classOrder.count}名学员，共有${classOrder.countCourse}门课程， 共花费${classOrder.zprice},确认，请点击我“我确认” 生成订单</td>
				</tr>
<tr>
	<td align="center"><a href="saveOrderCourseClass.action?sub_department=1&elclass.id=<s:property value="elclass.id" />&&elUser.isAssign=0" class="textbg">我确认</a></td>
</tr>
		  </table>
