		...
		<div  style="text-align: center;width: 100%;overflow-x: scroll;"> 
			<table width="100%">
				<tr>
					...
					<td valign="top">
						<s:form action="shopping_elclass_course_selectList" name="myclist" theme="simple">
			...
			<script>
			    function selectCourse(){
				   ...
				   if(confirm('确定选择？')){
				      location = "elclass_course_add.action?ids="+billIDs+"&status=${status}&elclassId=${elclassId}";
				   }
			    }
				function page(i) {
