						...
						<tr>
							<td valign="top" style="padding: 15px;">
								<table width=900 border=0 align="center" cellPadding=0
									cellSpacing=2 style="margin-right: 30px;">
									<TBODY>
										<TR>
											<TD width=150 height=39 align="center" bgcolor="#ECF6FD"></TD>
											<TD width=150 align="center" bgcolor="#ECF6FD">
												订单号
											</TD>
											<TD width=150 height=31 align="center" bgcolor="#ECF6FD">
												订购日期
											</TD>
											<TD width=150 align="center" bgcolor="#ECF6FD">
												价格
											...
											<TD width=150 height=31 align="center" bgcolor="#ECF6FD"></TD>
										</TR>
									</TBODY>
								</table>
								</H2>
								<s:if test="listC.size==0">
									<div style="MARGIN: 85px 260px 148px">
										...
										<span style="FONT-SIZE: 20px; FONT-FAMILY: Microsoft Yahei">您的购物车没有商品<a
											style="COLOR: #ee4e00"
								...
								<s:if test="successcount!=0">
									<TABLE cellSpacing=2 cellPadding=0 width=900 border=0>
										<TBODY>
											<TR>
												<TD width=150 bgcolor="#ECF6FD">
												</TD>
												<TD width=150 height=35 align="center" bgcolor="#ECF6FD" name="order.id">
													<EM> <s:property value="order.id" />
													</EM>
												</TD>
												<TD width=150 height=35 align="center" bgcolor="#ECF6FD" name="order.orderdate">
													<EM> <s:property value="order.orderdate" /> </EM>
												</TD>
												<TD width=150 height=35 align="center" bgcolor="#ECF6FD" name="order.sumpeice">
													<EM>￥ <s:property value="order.sumpeice" /> </EM>
												</TD>
												<TD width=150 height=35 align="center" bgcolor="#ECF6FD" name="order.username">
													<EM> <s:property value="order.username" /> </EM>
												</TD>
												<TD width=150 height=35 align="center" bgcolor="#ECF6FD">
													<span id="chenggongview"></span>
												</TD>
											</TR>
									...
									<s:if test="listsuccess.size!=0">
										<table width=900 bgcolor="#DEF0FC" style="margin-top: 20px;">
							...
							<td valign="top" style="padding: 15px;">
								...
								<p></p>
									<P class=onesp_a id="money_p">
										...
										</EM>元。 <s:if test="balance< order.sumpeice">您的余额不足请
						...
						<tr>
							<td valign="top" style="padding: 15px;">
								<H2>
									...
									<TABLE cellSpacing=２ cellPadding=0 width=900 border=0
										align="center">
										<TBODY>
											<TR>
											...
											<TR>
												<TD width=900 height="30" bgcolor="#ECF6FD">
													<s:if test="guoqicount!=0||cccount!=0||ordercount!=0">　本此订购中，有<EM>
															<s:property value="guoqicount" />件</EM>已经过期的培训班,添加失败</s:if>
												</TD>
											...
											<tr>
												<TD width=900 height="30" bgcolor="#ECF6FD">
													<s:if test="guoqicount!=0||cccount!=0||ordercount!=0">　本此订购中，有<EM>
															<s:property value="cccount" />件</EM>已经拥有的课程或培训班,添加失败</s:if>
												</TD>
											...
											<tr>
												<TD width=900 height="30" bgcolor="#ECF6FD">
													<s:if test="guoqicount!=0||cccount!=0||ordercount!=0">　本此订购中，有<EM>
															<s:property value="ordercount" />件</EM>课程或培训班已存在其他订单中,添加失败</s:if>
												</TD>
