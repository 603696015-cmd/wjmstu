			...
			<tr>
				<td>
					<div class="gouwu_xb center" align="center">
						<H2 align="center">
							<table cellSpacing=2 cellPadding=0 width=960 border=0
								align="center">
								...
								<TBODY align="center">
									<TR align="center">
										...
										<TD width=150 height=31 align="center">
											类型
										</TD>
						...
						<s:if test="listC.size==0">
							<div style="MARGIN: 85px 260px 148px">
								...
								<span style="FONT-SIZE: 20px; FONT-FAMILY: Microsoft Yahei">您没有选择任何课程<a
									style="COLOR: #ee4e00"
						...
						<s:else>
							...
							<TABLE cellSpacing=2 cellPadding=0 width=898 border=0
								align="center">
								<TBODY>
									<s:iterator value="listC">
										<TR>
											<TD width=300 bgcolor="#ECF6FD">
												<P align="center">
													<s:property value="commodityName" />
												</P>
											</TD>
											<TD width=150 align="center" bgcolor="#ECF6FD">
												<EM> <s:property value="CommoditytypeName" /> </EM>
											</TD>
											<TD width=150 height=35 align="center" bgcolor="#ECF6FD">
												<EM>￥ <s:property value="oldp" /> </EM>
											</TD>
											<TD width=150 height=35 align="center" bgcolor="#ECF6FD">
												<EM>￥ <s:property value="nowp" /> </EM>
											</TD>
											<TD width=200 height=35 align="center" bgcolor="#ECF6FD">
									...
									<tr align="center">
										<td colspan="6" align="center">
											<P class=onesp_a>
												<SPAN>应付总金额 <EM>合计：￥<s:property value="zongjia" />元</EM>
												</SPAN>
											</P>
											<s:if test="status==2">
																...
																<table width=900>
																	...
																	<tr>
																		...
																		<td align="left" bgcolor="#ECF6FD"
																			style="padding-left: 10px;">
																			<s:textfield style="width:200px;height:25px;"
																				id="tel" theme="simple" name="order.tel" />
																		</td>
																	</tr>
																	<tr>
																		<td width="120" height="30" align="center"
																		...
																		<td align="left" bgcolor="#ECF6FD"
																			style="padding-left: 10px;">
																			<s:textfield style="width:200px;height:25px;"
																				id="note" theme="simple" name="order.note" />
																		</td>
																	</tr>
													...
													<a
													 ...
													 <table width="95"   border="0" align="center" cellpadding="0" cellspacing="0">
											           <tr>
											             ...
											             <a 	href="shoppingCartToOrder.action?orderid=<s:property value="listC[0].id" />">
											             <span style="font-size:14px;font-weight:bold;color:white;cursor:hand;">立即缴费</span>
											             </a>
											             </td>
											           </tr>
											         </table>
