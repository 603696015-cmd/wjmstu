		...
		<script type="text/javascript">
			...
			function del(id){
				if(window.confirm("确认删除？")){
					...
					form_list_schedule.action="delSchedule.action";
					form_list_schedule.submit();
				}
			}
			function view(id){
					document.getElementById("scheduleid").value=id;
					form_list_schedule.action="getSchedule.action";
					form_list_schedule.submit();
			}
			function update(id){
				document.getElementById("scheduleid").value=id;
...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<!-- 内容 -->
			<form action="listSchedule.action?department.id=" method="post" name="form_list_schedule">
