...
tr {
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
					<wysLib:Navigation ivalue="生产效益一览表" />
				</div>
			</li>
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			<form action="production_efficiency.action" name="log" method="post">
				...
				<tr>
					<td valign="top" width="120" id="tree_list_td">
						...
						<wysLib:dep_list_aj rootAble="true"
							href="production_efficiency.action?sub_department=1&department.id="
					...
					<td valign="top">
						...
						<table width="98%" align="center" cellspacing="1" cellpadding="1">
							...
							<tbody onMouseOut="changeback()" onMouseOver="changeto()">
								<wysLib:production_efficiency></wysLib:production_efficiency>
							</tbody>
						</table>
					</td>
				</tr>
