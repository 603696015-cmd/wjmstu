...
<style type="text/css">
	...
	<BODY onLoad="opensearchdiv();load();add_info();"><%--  onLoad="initTable();" --%>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
					<wysLib:Navigation ivalue="生产效益查看详情" />
				</div>
			</li>
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			<!-- 组合查询 -->
			<form action="myContactTags1_.action" method="post" name="form_list_client">
