...
tr {
	...
	<body>
		<form action="hascertificateno.action" method="post" name="nmList">
					...
					<ul class="nav">
						<li>
							<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
								<wysLib:Navigation ivalue="已有证书学员列表页" />
							</div>
						</li>
					</ul>
				</td>
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top">
						...
						<s:form action="hascertificateno.action" method="post"
...
<td bgcolor="#F8FCFE"><div
						...
						<s:if test="hascertificatenoList.size==0">
							<span style="margin-top: 10px; padding-left: 15px;">没有搜到相关学员</span>
						</s:if>
						<s:else>
							<table width="100%" align="center" cellpadding="1"
								...
								<tbody onMouseOut="changeback()" onMouseOver="changeto()">
									<s:iterator value="hascertificatenoList" status="status">
										<tr>
