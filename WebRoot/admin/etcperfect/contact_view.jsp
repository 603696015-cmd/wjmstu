		...
		<s:form action="updateContact.action" method="post" theme="simple" onsubmit="return doSubmit();">
			...
			<table width="700px" cellpadding="2" cellspacing="1" >
				<tr>
						...
						<td >
							<label>
							<s:property value="contact.theme" />
							<!--  
					...
					<tr>
						...
						<td >
							<label>
							<s:property value="contact.content" />
							<!--  
					...
					<tr>
						...
						<td >
							<label><s:property value="contact.money" />
							<!--
					...
					<tr>
						...
						<td >
							<label>
							<s:property value="contact.re_client" />
							<!--
								...
								<div class="STYLE2" id="stuff">
									<s:iterator value="list_contactstuff" status="stst">
										...
										<!--  
											...
											-->  
											<a href="downContactstuff.action?contactstuff.id=<s:property value="id" />" ><s:property value="title" /></a>
											  </div>
