...
tr {
	...
	<body>
		<form action="haspaymoney.action" method="post" name="nmList">
					...
					<ul class="nav">
						<li>
							<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
								<wysLib:Navigation ivalue="已缴费学员列表页" />
							</div>
						</li>
					</ul>
				</td>
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top">
						...
						<s:form action="haspaymoney.action" method="post"
...
<td bgcolor="#F8FCFE"><div
						...
						<s:if test="haspaymoneyList.size==0">
						...
						<s:else>
							<table width="100%" align="center" cellpadding="1"
								...
								<tbody onMouseOut="changeback()" onMouseOver="changeto()">
									<s:iterator value="haspaymoneyList" status="status">
										<tr>
