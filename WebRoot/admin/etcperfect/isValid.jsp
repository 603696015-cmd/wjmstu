...
tr {
	...
	<body>
		<form action="isValid.action" method="post" name="nmList">
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top">
						...
						<s:form action="isValid.action" method="post"
						...
						<s:else>
							<table width="100%" align="center" cellpadding="1"
								...
								<tbody onMouseOut="changeback()" onMouseOver="changeto()">
									<s:iterator value="isValidList" status="status">
										<tr>
