...
tr {
	...
	<body>
		<form action="isOneWeek.action" method="post" name="nmList">
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top">
						...
						<s:form action="isOneWeek.action" method="post"
...
<td bgcolor="#F8FCFE"><div
						...
						<s:if test="isOneWeekList.size==0">
						...
						<s:else>
							<table width="100%" align="center" cellpadding="1"
								...
								<tbody onMouseOut="changeback()" onMouseOver="changeto()">
									<s:iterator value="isOneWeekList" status="status">
										<tr>
