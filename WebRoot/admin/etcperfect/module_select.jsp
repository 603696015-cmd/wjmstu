...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<!-- 组合查询 -->
			<form action="getModule.action" method="post" name="form_list_client" >
			...
			<table width="95%" align="center" cellpadding="1" cellspacing="1">
				...
				<tbody onMouseOut="changeback()" onMouseOver="changeto()">
					<s:iterator value="list_module">	
						<tr  >
							<td align="center">
								<input type="radio" name="radiobutton" value="<s:property value="modulename" />==<s:property value="tablename" />" >
							</td>
