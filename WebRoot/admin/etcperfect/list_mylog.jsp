		...
		<script type="text/javascript">
			...
			function del(id){
				if(window.confirm("确认删除？")){
					...
					form_list_log.action="delLog.action";
					form_list_log.submit();
				}
			}
			function view(id){;
					document.getElementById("logid").value=id;
					form_list_log.action="getLog.action";
					form_list_log.submit();
			}
			function update(id){
				document.getElementById("logid").value=id;
...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<!-- 组合查询 -->
			<form action="list_mylogs.action" method="post" name="form_list_log">
				<s:hidden name="log.id" id="logid" />
					...
					<s:iterator value="list_log">
						<tr>
							<td width="200" height="30" align="center" bgcolor="#FFFFFF"
								...
								<s:property value="log_createtime" />
							</td>
							<td width="100" height="30" align="center">
								<s:property value="log_title" />
							</td>
