...
<HTML>
		...
		<div style="margin-top:0px; text-align: center;">
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					...
					<s:else>
						<wysLib:newsTypeTree href="news_del_trial_list.action?news.ntype.id="
							rootAble="true"></wysLib:newsTypeTree>
				  </s:else></td>
					...
					<td valign="top">
							...
							<s:form action="news_del_trial_list.action" method="post" name="newsQuery" theme="simple">
						...
						<s:if test="newses.size==0"><span style="text-align:left; margin-top:10px;">没有搜到新闻公告</span></s:if>
						<s:else>
  ...
  <tr>
    ...
    <td><div id="Div_ToolsBar"></div></td>
									  ...
									  <input type="hidden" id="ntype_<s:property value='#status.index'/>" value="<s:property value="ntype.id" />"/>
										...
										<td width="150" align="left" bgcolor="#FFFFFF">
										    ...
										    <s:if test="status_tow!=7">
										   		 <a class="textbg4_2" href="javascript:doSubmit_2(1,'<s:property value="id"/>','
										   		 <s:property value="pN"/>','<s:property value="pS"/>',6);">申请删除</a>
									      </s:if>
									  </td>
									   -->
									</tr>
			...
			<form action="news_del_trial_list.action" method="post" name="nlist">
