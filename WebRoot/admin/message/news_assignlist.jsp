...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<div style="margin-top: 0px; text-align: center;">
			<table width="100%">
				<tr>
					<td valign="top" width="200" id="tree_list_td">
						<wysLib:newsTypeTree href="news_assignlist.action?ntype.id="
					...
					<td valign="top">
						...
						<td height="30" style="padding-left:8px;color:blue;" align="left">
										...
										<td bgcolor="#FFFFFF" align="center">
											<a href="newsassign.action?news.id=<s:property value="id"/>&pN=<s:property value="pN"/>&pS=10&status=3">通过</a>
										</td>
										<td bgcolor="#FFFFFF" align="center">
										    <a href="newsassign.action?news.id=<s:property value="id"/>&pN=<s:property value="pN"/>&pS=10&status=4">不通过</a>
										</td>
									</tr>
								</s:iterator>
							</table>
			...
			<form action="news_assignlist.action" method="post" name="nlist">
