	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function view(id){//alert(id);
					...
					form_list_client.action="html_viewContactTags.shtm";
			...
			function update(id){
				...
				form_list_client.action="html_updateContactTagsInit.shtm";
				form_list_client.submit();
			}
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<!-- 
				...
				联系时间：<input class="Wdate" name="contact.begintime" readonly="readonly"
				 ...
				 -->
				<!--  
				客户建立日期：<input class="Wdate" name="createdate" readonly="readonly"
