		...
		/*********************************** TableEdit.js  end *********************************/
			...
			function goon(){
				$("<tr >" +
							...
							"<td ><center><input type='text' name='values' onclick='setday(this);'/></td>" +
					  "</tr>")
					.insertAfter("#1_tr");
			}
				...
				if(holidays != ""){
					...
					if(array.length>=1){
						for(var i=0;i<array.length;i++){
							append += "<tr >" +
									"<td ><CENTER><span style='color:red'>节假日时间</span></CENTER></td>" + 	
									"<td ><center><input type='text' name='values' value='"+array[i]+"'/></center></td>" +
							  "</tr>";
						}
					}
					$(append).insertBefore("#1_tr");
				}
			}
	...
	<BODY onload="load();"><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<table width="95%" align="center" cellpadding="1" cellspacing="1">
				<caption><span style='CURSOR: hand' onclick='goon();'>继续添加</span></caption>
				<tr>
					<th width="280">
						操作
					</th>
				...
				<tbody onMouseOut="changeback()" onMouseOver="changeto()">
					<tr id='1_tr'>
						<td id='1_'>
							<CENTER><span style='color:red'>节假日时间</span></CENTER>
						</td>
						<td id='1__'>
							<center>
								<input id='1' type='text' name='values' onclick='setday(this);'/>
								<span style='color:red' onclick="remove(this);"></span>
							</center>
						</td>
					</tr>
				</tbody>
