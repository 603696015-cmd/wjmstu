...
<HTML>
	...
	<body>
		...
		<div style="margin-top: 0px; text-align: center;">
						...
						<s:else>
							<table width="100%" align="center" cellpadding="1"
								...
								<s:iterator value="kledges" status="status">
									...
									<br>
								设置
								<select name="kledge.hot" id="kledge.hot">
									<option value="0">
										取消
									</option>
									<option value="1">
			...
			function setHot(){
				var hot = document.getElementById("kledge.hot").value;
				var checkboxs = document.getElementsByName("id_");
				if(checkboxs.length>0){
					for(var i=0;i<checkboxs.length;i++){
						if(checkboxs[i].checked){
							alert(checkboxs[i].value);
							kledge.action="kledge_hotset.action?knowledge.id="+checkboxs[i].value+"&kledge.hot="+hot;
							kledge.submit();
						}
					}
				}
