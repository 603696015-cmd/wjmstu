...
<HTML>
	<HEAD>
		...
		<SCRIPT type="text/javascript">
			function searchUserInit(kledgeid,type){
				 var listType = document.getElementById("listType").value;
				 width=600;
				 height=500;
			  	 var sFeature="dialogWidth:"+width+"px;dialogHeight:"+height+"px;Status:0;resizable:1;help:0";
				 var rv =  window.showModalDialog("competenceByDepartmentInit.action?competenceType="+type+"&kledge.id="+kledgeid+"&x="+Math.random(),null,sFeature);
				 if(rv=="nihao"){
				 	alert("授权成功！！！");
				 	location.href="updateKledgeInit.action?listType="+listType+"&kledge.id="+<s:property value='kledge.id'/>+"&date="+new Date();
				 }
			}
			function myload(){
			...
			function Obj(departments_,depids_,users_,userids_){//部门、部门ids、用户、用户ids
			...
			function load(){
				...
				var department_obj;
				for(var i=1;i<6;i++){
					user_obj = loadUsers(i);
					//department_obj = loadDepartments(i);
					document.getElementById("users_div_1_"+i).innerHTML = "<table id=userids_table_"+i+" border='0'  cellspacing='1' cellpadding='1'><tr>"+arrayToString(user_obj.users)+"</tr></table>";
					//document.getElementById("departments_div_1_"+i).innerHTML = "<table id=departmentids_table_"+i+" border='0'  cellspacing='1' cellpadding='1'><tr>"+arrayToString(department_obj.departments)+"</tr></table>";
					document.getElementById("userids_"+getCompetenceType(i)).value = user_obj.userids.toString();
					//document.getElementById("departments_"+getCompetenceType(i)).value = department_obj.depids.toString();
				}
			}
			...
			function loadDepartments(type){
				...
				{
				case 1:
				<s:iterator value="kledge.ct_views" status="status">
				<s:if test="dt.name!=null||dt.name!=''">
					departments[temp] = "<td id=departmentids_td_"+type+"_<s:property value='#status.index' />><s:property value='dt.name' />" + "<a href='javascript:removeByDepartmentid(<s:property value='dt.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
					depids[temp] = "<s:property value='dt.id' />";
				</s:if>
				<s:else>
					temp--;
				</s:else>
				temp++;
					...
					break;
				case 2:
				<s:iterator value="kledge.ct_updates" status="status">
				<s:if test="dt.name!=null||dt.name!=''">
					departments[temp] = "<td id=departmentids_td_"+type+"_<s:property value='#status.index' />><s:property value='dt.name' />" + "<a href='javascript:removeByDepartmentid(<s:property value='dt.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
					depids[temp] = "<s:property value='dt.id' />";	
				</s:if>
				...
				temp++;
					...
					break;
				case 3:
				<s:iterator value="kledge.ct_deletes" status="status">
				<s:if test="dt.name!=null||dt.name!=''">
					departments[temp] = "<td id=departmentids_td_"+type+"_<s:property value='#status.index' />><s:property value='dt.name' />" + "<a href='javascript:removeByDepartmentid(<s:property value='dt.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
					depids[temp] = "<s:property value='dt.id' />";
				</s:if>
				...
				temp++;
					...
					break;
				case 4:
				<s:iterator value="kledge.ct_copys" status="status">
				<s:if test="dt.name!=null||dt.name!=''">
					departments[temp] = "<td id=departmentids_td_"+type+"_<s:property value='#status.index' />><s:property value='dt.name' />" + "<a href='javascript:removeByDepartmentid(<s:property value='dt.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
					depids[temp] = "<s:property value='dt.id' />";
				</s:if>
				...
				temp++;
					...
					break;
				case 5:
				<s:iterator value="kledge.ct_downloads" status="status">
				<s:if test="dt.name!=null||dt.name!=''">
					departments[temp] = "<td id=departmentids_td_"+type+"_<s:property value='#status.index' />><s:property value='dt.name' />" + "<a href='javascript:removeByDepartmentid(<s:property value='dt.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
					depids[temp] = "<s:property value='dt.id' />";
				</s:if>
				...
				return new Obj(departments,depids,null,"");
			}
			function loadUsers(type){
				...
				case 1://查看权限
				<s:iterator value="kledge.ct_views" status="status">
					<s:if test="eu.realname!=null||eu.realname!=''">
						users[temp] = "<td id=userids_td_"+type+"_<s:property value='#status.index' />><s:property value='eu.realname' />" + "<a href='javascript:removeByUserid(<s:property value='eu.id' />,"+type+",<s:property value='#status.index' />);' ><span style='color:blue;corsor:hand'>X</span></a>" + "&nbsp;&nbsp;"+"</td>";
						userids[temp] = "<s:property value='eu.id' />";
					</s:if>
					<s:else>
						temp--;
					</s:else>
				...
				return new Obj(null,"",users,userids);
			}
			...
			function doSubmit(){
				...
				knowledgeTree = konwledgeTreeObj.value.replace(/(\s*$)/g, "");
				if(knowledgeTree==""){
					alert("知识类别不能为空!");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<s:form action="updateKledge.action" method="post" name="kledge_info"
			theme="simple" onsubmit="return doSubmit();">
			<input type="hidden" name="kledge.klTree.id" id="kledge.klTree.id" value="<s:property value='kledge.klTree.id' />" />
			<input type="hidden" name="listType" id="listType" value="<s:property value='listType' />" />
			...
			<table width="100%" cellpadding="1" align="center" cellspacing="1"
				...
				<tr>
					<td width="90" height="30" align="right" bgcolor="#F0FAFF">
						<span class="neededitem STYLE1">*</span><span class="STYLE1">知识名称：					</span></td>
					<td bgcolor="#FFFFFF">
						<label>
				...
				<tr>
					<td width="90" height="30" align="right" bgcolor="#F0FAFF">
						<span class="neededitem STYLE1">*</span><span class="STYLE1">知识类别：					</span></td>
					<td bgcolor="#FFFFFF">
						<label>
							<s:textfield theme="simple" name="kledge.klTree.name" 
								size="20" readonly="true" id="kledge.klTree.name"/>
			 				<a href="#" onClick="searchKnowledgeTreeInit();return false;" class="textbg">点此进行选择</a>						</label>					</td>
				</tr>
				<tr>
					...
					<td align="left" bgcolor="#FFFFFF">
						开始时间：<input size="50" class="Wdate" name="kledge.begintime" readonly="readonly"
							type="text" onClick="setday(this)" id="kledge.begintime" value="<s:date name='kledge.begintime' format='yyyy-MM-dd HH:mm' />" />
						结束时间<input size="50" class="Wdate" name="kledge.endtime" readonly="readonly"
							type="text" onClick="setday(this)" id="kledge.endtime" value="<s:date name='kledge.endtime' format='yyyy-MM-dd HH:mm' />" />					</td>
				</tr>
				<tr>
					<td width="90" height="30" align="right" bgcolor="#F0FAFF"><span class="STYLE1">
					  制定部门：					</span></td>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span><s:property value="kledge.fabuUser.department.name" /></span>						</label>					</td>
				</tr>
				<tr>
					<td width="90" height="30" align="right" bgcolor="#F0FAFF"><span class="STYLE1">
					  发布时间：					</span></td>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							<span><s:property value="kledge.xiugaiUser.realname" /></span>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<span><s:property value="kledge.xiugaiUser.department.name" /></span>
							<input type="hidden" name="kledge.xiugaiuserid" id="kledge.xiugaiuserid" value="<s:property value="kledge.xiugaiUser.id" />" />						</label>					</td>
				</tr>
				<tr>
					<td width="90" height="30" align="right" bgcolor="#F0FAFF"><span class="STYLE1">
					  查看权限：					</span></td>
					<td bgcolor="#FFFFFF">
						<label>
							...
							<p>&nbsp;&nbsp;已授权<span style="color:red"><b><s:property value="kledge.count_view" /></b></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							<p>
								<input type="button" value="按人员授权" onClick="competence(1,1);return false;" />
							</p>
							<span id="users_div_1_1"></span>
							<p>
								<input type="button" value="按部门授权" onClick="searchUserInit('<s:property value="kledge.id"/>',1);return false;" />
							</p>
							<span id="departments_div_1_1"></span>
							<div style="margin-left: 0px; width: 150px;">
								<wysLib:dep_list_aj_competence did="1" rootAble="true" competenceType="1"/>
						    </div>
						</label>					
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							...
							<p>&nbsp;&nbsp;已授权<span style="color:red"><b><s:property value="kledge.count_update" /></b></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							<p ><input type="button" value="按人员授权" onClick="competence(2,1);return false;" /> </p>
							<div id="users_div_1_2"></div>
							<p ><input type="button" value="按部门授权" onClick="searchUserInit('<s:property value="kledge.id"/>',2);return false;" /></p>
							<span id="departments_div_1_2"></span>
							<div style="margin-left: 0px; width: 150px;">
								<wysLib:dep_list_aj_competence did="2" rootAble="true" competenceType="2"/>
						    </div>
						</label>					
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							...
							<p>&nbsp;&nbsp;已授权<span style="color:red"><b><s:property value="kledge.count_delete" /></b></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							<p ><input type="button" value="按人员授权" onClick="competence(3,1);return false;" /> </p>
							<div id="users_div_1_3"></div>
							<p ><input type="button" value="按部门授权" onClick="searchUserInit('<s:property value="kledge.id"/>',3);return false;" /> </p>
							<span id="departments_div_1_3"></span>
							<div style="margin-left: 0px; width: 150px;">
								<wysLib:dep_list_aj_competence did="3" rootAble="true" competenceType="3"/>
						    </div>
						</label>					
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							...
							<p>&nbsp;&nbsp;已授权<span style="color:red"><b><s:property value="kledge.count_copy" /></b></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							<p ><input type="button" value="按人员授权" onClick="competence(4,1);return false;" /> </p>
							<div id="users_div_1_4"></div>
							<p ><input type="button" value="按部门授权" onClick="searchUserInit('<s:property value="kledge.id"/>',4);return false;" /> </p>
							<span id="departments_div_1_4"></span>
							<div style="margin-left: 0px; width: 150px;">
								<wysLib:dep_list_aj_competence did="4" rootAble="true" competenceType="4"/>
						    </div>
						</label>					
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<label>
							...
							<p>&nbsp;&nbsp;已授权<span style="color:red"><b><s:property value="kledge.count_download" /></b></span>人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
							<p ><input type="button" value="按人员授权" onClick="competence(5,1);return false;" /> </p>
							<div id="users_div_1_5"></div>
							<p ><input type="button" value="按部门授权" onClick="searchUserInit('<s:property value="kledge.id"/>',5);return false;" /> </p>
							<span id="departments_div_1_5"></span>
							<div style="margin-left: 0px; width: 150px;">
								<wysLib:dep_list_aj_competence did="5" rootAble="true" competenceType="5"/>
						    </div>
						</label>					
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						...
						<a href="javascript:setUrl('fujian');" class="textbg">浏览资源库</a>
						<a href="javascript:preview('<s:property value='kledge.fujian' />');" class="textbg">预览</a>					
					</td>
				</tr>
				<tr>
