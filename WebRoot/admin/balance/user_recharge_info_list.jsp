				...
				<table width="100%">
					<tr>
						<td valign="top" width="120" id="tree_list_td">
							...
							<wysLib:dep_list_aj rootAble="true" href="geteluserzengzi_recharge_info1.action?sub_department==1&type=${type}&deptid="></wysLib:dep_list_aj>
						...
						<td valign="top">
							...
							<div style="text-align: center;">
								角色：
								<s:select  name="elUser.role.id" list="roles" listKey="id" listValue="name" theme="simple" headerKey="0"
					 headerValue="请选择" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 用户名：
								...
								操作者姓名：
								<label>
									<s:textfield name="caozuoname" />
								</label>
								操作者账号：
								<label>
									<s:textfield name="caozuousername" />
								</label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 包含下属部门：
								<label>
