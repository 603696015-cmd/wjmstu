			...
			$(function(){ 
			 	 $("#registerForm").validate({ 
	                rules: {
	                    ...
	                    "elUser.shenfenzheng":{required: false,idcardno:false,idcardnoIsExist:true,toDateValue:"#shengri"},
						  ...
						  <div id="mobileitem" class="g-collection-item">
							...
							<div id="mobileitem" class="g-collection-item">
								...
								<!-- <input type="text" name="elUser.shengri" readonly="readonly" class="g-ipt" id="shengri"> -->	
									<input class="Wdate" name="elUser.shengri" readonly="readonly"
												type="text" onClick="setday(this)"  />
										<span class="txt-info">点击空格</span>
							...
							<div id="mobileitem" class="g-collection-item">
								...
								<div id="mobileWrap" class="ipt-wraper">
									...
									<span class="txt-info">请填写国籍</span>
								</div>
							</div>
							...
							<div id="mobileitem" class="g-collection-item">
								...
								<div id="mobileWrap" class="ipt-wraper">
									...
									<span class="txt-info">请填写电话</span>
								</div>
							</div>
							...
							<div id="mobileitem" class="g-collection-item">
								...
								<div id="mobileWrap" class="ipt-wraper">
									<input id="danweiName" name="elUser.depName" readonly="readonly" style="font-size:15px;" />
