...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function returnImp(){
				...
				if(depid>0){
					document.impForm.action="wjm_account_importBydepInit.action";
				}else{
					document.impForm.action="wjm_accountImportCheck.action";
				}
				document.impForm.submit();
			}
		</script>
	...
	<body>
		...
		<div style="margin-top: 0px; margin-left: 300px;">
			<br>
			<form action="wjm_account_import.action" enctype="multipart/form-data"
