...
<!--<div class="slides" style="width:710px;margin-right: auto;margin-left: auto;margin-top: 0px;margin-bottom: 0px;">-->

<!--<div  id="div" class="slides" style="left:283px;top:257px; z-index:999; display:none;">-->
<!--</div> -->
												...
												<table width="100%" border="0" cellpadding="5"
													...
													<s:iterator value="myClassAll.myCourseB">
														<tr>
															...
															<td align="center" bgcolor="#F8FCFE">
<!--																<a href='quizpaperinit.action?course.id=<s:property value="course.id" />&course.getcredit=<s:property value="course.getcredit" />&course.firstLearn=<s:property value="course.firstLearn" />&myroom.examroom.id=<s:property value="examRoom.id" />&iscommon=0&elclass.id=<s:property value="elclass.id"/>' onClick="return isEroom2('<s:property value="examRoom.valid"/>','<s:property value="examRoom.svalid"/>','<s:property value="examRoom.isnormal"/>','<s:property value="examRoom.type"/>');"-->
<!--																	target="_blank"><img src="images/xtb021.gif"-->
<!--																		width="28" height="27" /> </a>															-->
...
<!--				</s:else>-->
		...
		<button id="btn" onclick="ceshi()">create1</button>
		<div id="ceshi"></div>
	...
	<script type="text/javascript">
		function cDiv(){
			...
			oDiv.style.top="50%";
			oDiv.style.left="50%";
			oDiv.style.margin="-150px 0 0 -200px";
			oDiv.style.width="400px";
			oDiv.style.height="300px";
			oDiv.style.background="url(images/datigaiban/text_bg.png) no-repeat 0 0";
...
function check(username){
	$.ajax({	async:false,  //   
	 ...
	 <script type="text/javascript">
  function closeDiv111(){
  		alert(11111);
  		alert(document.getElementById('slide1').parentNode);
		document.getElementById('slide1').parentNode.removeChild(document.getElementById('slide1'));
...
function showDialogue(){
				 ...
				 height=250;
			  	 var sFeature="dialogWidth:"+width+"px;dialogHeight:"+height+"px;Status:0;resizable:1;help:0";
				 var rv =  window.showModalDialog("three_menu.action?x="+Math.random(),null,sFeature);
			}
</script>
</html>
