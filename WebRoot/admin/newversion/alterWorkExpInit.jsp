...
<li class="optional"><a href="/MYZHAOPIN/editprac.asp?Ext_ID=JR475973035R90250006000&Language_ID=1&Resume_ID=206642320&Version_Number=1">在校实践经验</a></li>
	...
	<td colspan="6" valign="top" style="border-left:1px solid #B9B9D3;border-right:1px solid #B9B9D3">
              ...
              <tr style="display:none;">
				<td align="left" class="tab6Td1  " width="250">苏柏亚</span></td>
				<td width="150">2003/1---2003/1</td>
				<td width="150">开发部</td>
				<td width="210"><a href="#" class="blue12line" onClick="editItem(1);return false;">编辑</a>  |  <a href="#" class="blue12line" onClick="deleteItem(1,0);return false;">删除</a>  |  <a href="#" class="blue12line" onClick="editAdva(1);return false;">编辑团队管理经验</a></td>
			</tr>
            <tr class="nowEdit" style="display:;">
				<td align="left" class="tab6Td1  " width="250"><span class="grey12"><s:property value="experience.companyname"/></span></td>
				<td width="150"><s:property value="experience.workstartdate"/>---<s:property value="experience.workenddate"/></td>
				<td width="150"><s:property value="experience.bumen"/></td>
				<td width="210"><a class="blue12line">编辑</a>  |  <a class="blue12line">删除</a>  |  <a class="blue12line">编辑团队管理经验</a></td>
			</tr>
            </table>
</td>
</tr>
		...
		<!-- end 已添加的工作经验 -->
		<div class="rightRow1">修改工作经验（<span class="org14">*</span>为必填项）</div>
<span class="org12" id="editoldmess" style="display:;">[ 提示：如果您修改了选择项，则相应的英文简历该条记录也会自动被更改。请保持中英文内容的一致性。]</span>
		<form name="frmMain" action="alterWorkExp.action" method="post">
		<input name="experience.id" value="${experience.id }" type="hidden"/>
		...
		<tr><td><font class="org14">*</font></td>
			<td>企业名称</td>
			<td colspan="4"><input type="text" value="<s:property value="experience.companyname"/>" name="experience.companyname" size="59" id="cmpany_name" mzpmodule="resumeChEnFac" tiptext="" lang="en"></td></tr>
...
<option value="1" <s:if test='experience.xingzhi==1'>SELECTED</s:if> >国企</option>
<option value="2" <s:if test='experience.xingzhi==2'>SELECTED</s:if>>外商独资</option>
<option value="3" <s:if test='experience.xingzhi==3'>SELECTED</s:if>>代表处</option>
<option value="4" <s:if test='experience.xingzhi==4'>SELECTED</s:if>>合资</option>
<option value="5" <s:if test='experience.xingzhi==5'>SELECTED</s:if>>民营</option>
<option value="8" <s:if test='experience.xingzhi==8'>SELECTED</s:if>>股份制企业</option>
<option value="9" <s:if test='experience.xingzhi==9'>SELECTED</s:if>>上市公司</option>
<option value="6" <s:if test='experience.xingzhi==6'>SELECTED</s:if>>国家机关</option>
<option value="10" <s:if test='experience.xingzhi==10'>SELECTED</s:if>>事业单位</option>
...
<option value="1" <s:if test='experience.guimo==1'>SELECTED</s:if>>20人以下</option>
<option value="2" <s:if test='experience.guimo==2'>SELECTED</s:if>>20-99人</option>
<option value="3" <s:if test='experience.guimo==3'>SELECTED</s:if>>100-499人</option>
<option value="4" <s:if test='experience.guimo==4'>SELECTED</s:if>>500-999人</option>
<option value="5" <s:if test='experience.guimo==5'>SELECTED</s:if>>1000-9999人</option>
<option value="6" <s:if test='experience.guimo==6'>SELECTED</s:if>>10000人以上</option>
				</select>
			</td></tr>
		<tr id="conError_companytype" style="display:none;"><td></td><td></td><td id="txtError_companytype" colspan="3"></td></tr>
		<tr><td><font class="org14">*</font></td>
			<td>行业类别</td>
			<td colspan="4"><input type="button" id="button_industryF" class="selectBut2" mzpmodule="popupSingChooFac" hiddenname="document.frmMain.industry" data="industry" divwidth="660" titlename="行业类别" itemcol="3"><input type="hidden" name="industry" value="210500"></td></tr>
		<tr id="conError_industry" style="display:none;"><td></td><td></td><td id="txtError_industry" colspan="3"></td></tr>
		<tr><td></td>
			<td>所在的部门</td>
			<td colspan="4"><input type="text" name="experience.bumen" value="<s:property value="experience.bumen"/>" size="59" id="department" mzpmodule="resumeChEnFac" tiptext="" lang="en"></td></tr>
		<tr><td valign="top"><font class="org14">*</font></td>
			<td valign="top">职位类别</td>
			<td colspan="4"><input type="button" id="button_jobtypeF" class="selectBut2" mzpmodule="popupSingChooFac" hiddenname="document.frmMain.SchJobType" data="jobname" divwidth="480" titlename="职位类别" itemcol="3">&nbsp;&nbsp;<input type="button" id="button_subjobtypeF" class="selectBut2" mzpmodule="popupSingChooFac" parentobj="button_jobtypeF" hiddenname="document.frmMain.subJobType" data="jobname" divwidth="410" titlename="职位名称" clickitemfixfn="showCustomJobName" initfixfn="initCustomJobName"><input type="Hidden" name="SchJobType" value="4010200"><input type="Hidden" name="subJobType" value="006"></td></tr>
		<tr id="conError_jobtype" style="display:none;"><td></td><td></td><td id="txtError_jobtype" colspan="3"></td></tr>
		<tr><td><font class="org14">*</font></td>
        	<td>职位名称</td>
            <td colspan="4"><input type="text" name="experience.zhiyemingcheng" value="<s:property value="experience.zhiyemingcheng"/>" size="59" id="customSubJobtype" mzpmodule="resumeChEnFac" tiptext="" lang="en"><span style="color:#989898;">（此项可修改）</span></td></tr>
        <tr id="conError_customSubJobtype" style="display:none;"><td></td><td></td><td id="txtError_customSubJobtype" colspan="3"></td></tr>
        <tr><td><font class="org14">*</font></td>
			<td>工作时间</td>
			<td colspan="4">
				<input type="text" name="experience.workstartdate" value="<s:date format="yyyy-MM-dd" name="experience.workstartdate"/>" readonly="readonly" id="shengri" onclick="setday(this)" class="frame7"/> 至<span><input type="text" name="experience.workenddate" value="<s:date format="yyyy-MM-dd" name="experience.workenddate"/>" readonly="readonly" id="shengri" onclick="setday(this)" class="frame7"/></span>
			</td>
		</tr>
...
<option value="1000" <s:if test='experience.zhiweiyuexin==1000'>SELECTED</s:if>>1000元/月以下</option>
<option value="2000" <s:if test='experience.zhiweiyuexin==2000'>SELECTED</s:if>>1000-2000元/月</option>
<option value="4000" <s:if test='experience.zhiweiyuexin==4000'>SELECTED</s:if>>2001-4000元/月</option>
<option value="6000" <s:if test='experience.zhiweiyuexin==6000'>SELECTED</s:if>>4001-6000元/月</option>
<option value="8000" <s:if test='experience.zhiweiyuexin==8000'>SELECTED</s:if>>6001-8000元/月</option>
<option value="10000" <s:if test='experience.zhiweiyuexin==10000'>SELECTED</s:if>>8001-10000元/月</option>
<option value="15000" <s:if test='experience.zhiweiyuexin==15000'>SELECTED</s:if>>10001-15000元/月</option>
<option value="25000" <s:if test='experience.zhiweiyuexin==25000'>SELECTED</s:if>>15000-25000元/月</option>
<option value="99999" <s:if test='experience.zhiweiyuexin==99999'>SELECTED</s:if>>25000元/月以上</option>
<option value="0000" <s:if test='experience.zhiweiyuexin==0000'>SELECTED</s:if>>保密</option>
				</select>
			</td></tr>
