...
<input type="hidden" name="elclasses.id" value="<s:property value="elclass.id"/>"/>
...
<a
	...
	href=""
	onclick="javascript:deleteerinfo(this,<s:property value="elclass.id"/>);return false;">X</a>
