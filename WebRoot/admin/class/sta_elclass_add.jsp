	...
	<body onLoad="init();">
		...
		<s:form action="elclass_add" theme="simple" method="post"
			...
			<table width="100%" cellpadding="2" cellspacing="1">
				<tr>
					...
					<td height="30">
						<label>
							<s:textfield name="elclass.name" id="name" size="60" value="%{station.name}课程学习计划"/>
						</label>
					</td>
				</tr>
				<tr>
		...
		<!-- 	<tr>
				...
				<tr>
					...
					<td height="30">
						<label>
							<s:textfield name="elclass.certificatename" id="certificate_name" value="%{station.name}岗位结业证书"/>
						</label>
					</td>
				</tr>
