		...
		<table cellpadding="1" cellspacing="1" width="900px" align="center">
			...
			<tr>
				<td height="50" colspan="2" align="center">
					...
					<a href="sta_elclass_addInit.action?staid=${staid}"
						class=textbg>修改</a>
			<!-- 	<a href="elclass_alllist.action?staid=${staid }" class=textbg>班级列表</a> -->	
					<a href="elclass_course.action?elclass.id=${elclass.id }&staid=${staid }"
			...
			<!-- 	<a
						href="elclass_sh.action?elclass.id=${elclass.id }&staid=${staid}&status=${elclass.status}&sublibs=1"
						class=textbg style="color: red;">确认提交</a> -->	
						<a
						href="elclass_sh.action?elclass.id=${elclass.id }&staid=${staid}&status=${elclass.status}&sublibs=1"
						class=textbg style="color: red;">确认提交</a>
				</td>
