...
<HTML>
	...
	<body>
		...
		<div style="margin-top: 0px; margin-left: 300px;">
			...
			<br>
			<form action="classWriteUser.action" enctype="multipart/form-data"
				method="post">
				...
				<span style="color:red;">注意：学员用户名请放在文档的第1列</span> 
				<br><br>
				<input type="submit" value="导入">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a class="textbg6" style="width:100px;" href="download.jsp?filename=elstuffs/importUserToClassOrEroom.xls">导入格式下载</a>
				<a class="textbg4" href="elclass_assign2userInit.action?sub_department=1&elclass.id=<s:property value="elClass.id" />">返回</a>
