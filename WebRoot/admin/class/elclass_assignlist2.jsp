		...
		<table width="100%" cellpadding="1" cellspacing="1">
			<tr>
				<td width="165" valign="top" id="tree_list_td" style="display:none">
					<wysLib:clTypeTree
						href="elclass_assignlist2.action?sublibs=1&cltype.id="
						rootAble="true" />
				</td>
								...
								<s:iterator value="elclasses" status="elclasses_st">
									...
									<s:if test="examRooms.size==0">
									   ...
									   <s:else>
										...
										<td align="left">
											<a
												href="elclass_details_sh.action?elclassId=<s:property value="id" />&PageStatus=0&PageStatusint=2&Return=assign"
												class=textbg4>详情</a>
											<a
												href="elclass_check_students.action?sub_department=1&elclass.id=<s:property value="id"/>&Return=assign"
												class="textbg4">学员</a>
											<s:if test="status == 0 || status == 2">
												<a
													href="elclass_assign2userInit.action?sub_department=1&elclass.id=<s:property value="id" />&Return=assign"
													class="textbg4">分配</a>
