		...
		<table width="100%" cellpadding="1" cellspacing="1">
			<tr>
				<td width="165" valign="top" id="tree_list_td" style="display: none">
					<wysLib:clTypeTree
						href="elclass_assignRoom.action?sublibs=1&cltype.id="
						rootAble="true" />
				</td>
				...
				<td valign="top">
					...
					<s:form action="elclass_assignRoom.action" name="myclist"
						theme="simple">
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td width="100" rowspan="2" bgcolor="#F8FCFE">
							...
							<table width="100%" height="100%" align="center" cellpadding="1"
								...
								<tbody>
									<s:iterator value="elclasses" status="elclasses_st">
										<tr
											<s:if test="(#elclasses_st.index%2)==1">style="background:#f4f4f4"</s:if>>
											...
											<td align="left">
												<s:if test="test=examRooms.size()==0">
													<a
														href="assignRoomInit.action?elClass.id=<s:property value="id" />&resultPage=elclass_assignRoom"
														class=textbg4>分配</a>
												</s:if>
												<s:else>
													...
													<a
														...
														class=textbg4>分配</a>
													<a
														href="quitAssignRoom.action?elClass.id=<s:property value="id" />&examRoom.id=<s:property value="examRooms[0].id"/>&resultPage=elclass_assignRoom"
														class=textbg6>取消分配</a>
												</s:else>
											</td>
										</tr>
									</s:iterator>
