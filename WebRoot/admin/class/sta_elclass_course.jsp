		...
		<table cellpadding="1" cellspacing="1" align="center" width="100%">
			...
			<tr>
				...
				<!-- <a href="elclass_alterInit.action?elclass.id=${elclass.id }"
					...
					<a href="elclass_view_man.action?elclass.id=${elclass.id }&sublibs=1&staid=${staid }"
						class=textbg>返回</a>
					<a href="sta_view.action?station.id=${staid }"
						class=textbg>返回岗位管理</a>
				</td>
			</tr>
		</table>
	</body>
