...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<div style="margin-top: 0px; text-align: center;">
			<form action="elclass_examroom_selecting_prima_shlist.action" method="post"
				name="examXB">
			...
			<s:else>
				...
				<form action="examroom_sh_s.action" name="examroom_sh_s"
					...
					<s:hidden name="Return" id="Return"
						value="elclass_examroom_selecting_prima_shlist"></s:hidden>
				</form>
				<script> 
					function sh_s(id,svalid){
					    ...
					    document.getElementById("examRoomSvalid").value=svalid; 
					 	if(svalid==2 && window.confirm("确定不通过？")){
					 		document.forms.examroom_sh_s.submit();
					 	}
