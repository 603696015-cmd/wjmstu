						...
						<s:iterator value="planStage.planStuffs">
							<tr>
								...
								<td align=center bgcolor=#ffffff>
									...
									<a href="assist_plan_stuffdelete.action?planStage.id=<s:property value="#planStageid"/>&planStuff.stuff.id=<s:property value="stuff.id" />&planStuff.id=<s:property value="id"/>&plan.id=<s:property value="#planid"/>">删除</a>
								</td>
							</tr>
							</s:iterator>
					</tbody>
