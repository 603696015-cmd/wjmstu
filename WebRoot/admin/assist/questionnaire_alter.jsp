				...
				<table width="100%" align="center" cellpadding="1" cellspacing="1"
					...
					<tr>
						...
						<td bgcolor="#FFFFFF" style="padding: 0px;">
							<input type="radio" name="examRoom.stuViewResult" value="1" <s:if test="examRoom.stuViewResult==1">checked="checked"</s:if> />允许
							<input type="radio" name="examRoom.stuViewResult" value="0" <s:if test="examRoom.stuViewResult==0">checked="checked"</s:if>/>不允许
						</td>
					</tr>
				 ...
				 <br/> 
							...
							<s:if test="examRoom.exampapers.size==0">
								<a  href="" onClick="erep_addinit(); return false;" class="textbg5">添加试卷</a>
							</s:if>
							<s:else>
								<a  id="add" style="display:none" href="" onClick="erep_addinit(); return false;" class="textbg5">添加试卷</a>
							</s:else>
						</td>
					</tr>
				<tr style="display:none">
