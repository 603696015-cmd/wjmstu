...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<div style="margin-top: 0px; text-align: center;">
			<table cellspacing=1 cellpadding=2 width="70%" align=center
				...
				<form action="assist_plan_stuffadd.action" style="width:70%;text-align: center;" method="post"
				...
				<s:hidden name="planStage.id"></s:hidden>
				<input type="hidden" name="planStuff.planStage.id" value="<s:property value="planStage.id"/>"/>
