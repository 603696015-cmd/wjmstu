...
.textbg6{margin-top:2px;}
		...
		function viewDetail(){
			...
			window.location.href = "questionnaire_view.action?examRoom.id="+value+"&Return=ash";
			/**
			var value = pp[0].toString();
			...
			<table width="1100" cellpadding="1" cellspacing="1">
				<tr>
					...
					<td valign="top">
						...
						<form
							action="questionnaire_prima_shlist.action?eroomLib.id=<s:property value="eroomLib.id"/>"
								 ...
								 */
								 function FillInNoteksInit(id){
									 ...
									 if(document.getElementById("examRoomValid").value==3){
										 ...
										 var sFeature="dialogWidth:"+width+"px;dialogHeight:"+height+"px;Status:0;resizable:1;help:0";
										 rn =  window.showModalDialog("questionnaire_timeover_list.action?examRoom.id="+id+"&PageStatus=0&x="+Math.random(),null,sFeature);
										 //return false;
									 }
