	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<s:form id="examroom_add" name="form_exam_add" method="post"
				theme="simple" action="addQuestionnaire.action"
			 	...
			 	<tr style="display:none">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF" style="padding: 0px;">
							<input type="radio" name="examRoom.stuViewResult" value="1" checked="checked" />允许
							<input type="radio" name="examRoom.stuViewResult" value="0" />不允许
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div id="eps_div"></div>
							<a id="add" href="" onClick="erep_addinit(); return false;" class="textbg5">添加试卷</a>
						</td>
					</tr>
					<tr style="display:none">
						<td align="right">
						...
						<td>
							...
							<s:else>
								<input class="textbg" style="border: none;" type="button"
									value="返回问卷列表"
									onclick="document.location='questionnaireList.action'" />
						<!-- 	<input class="textbg" style="border: none;" type="button"
									value="返回绑定列表"
