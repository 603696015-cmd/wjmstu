		...
		<table width="100%" cellpadding="1" cellspacing="1">
			<tr>
			  <td width="150px" valign="top" id="tree_list_td">  
				...
				<td valign="top">
				<s:form action="peice_audit_elclass" name="myclist" theme="simple">
				<s:hidden name="pN" id = "pageNow"></s:hidden>
				<s:hidden name="pS"></s:hidden>
				<s:hidden name="biaoshi" ></s:hidden>
				...
				培训班名称：<s:textfield name="elClass.name" id="testname"></s:textfield> <input type="button"  value="搜索" onClick="newsSubmit()" />
			...
			<table width="100%" height="100%" align="center" cellpadding="1"
				...
				<s:iterator value="elclasses">
					...
					<!--  	<td align="center" bgcolor="#FFFFFF">
						...
						<td>
							<a style="cursor:pointer;"  href ="course_preview.action?elClass.id=<s:property value="elClass.id"/>"  class="textbg6"  target="_blank" >浏览</a>
						</td>
						-->
						...
						<td align="center" bgcolor="#FFFFFF">
							<s:if test="status!=1">
								<a style="cursor:pointer;"  onClick="sh(<s:property value="elClass.id"/>, 1);"  class="textbg6">通过</a>
							
							</s:if>
							<s:if test="status==3||status==1">
								<a style="cursor:pointer;"  onClick="sh(<s:property value="elClass.id"/>, 4);"  class="textbg6">不通过</a>
		...
		<input type="button" onClick=" document.getElementById('fee').style.display='none'" value="关闭"/>
			...
			function saveFee(){
				...
				if(window.confirm("确定为\""+clname+"\"设定价格为"+fee1+"？")){
					...
					myclist.action="peice_audit_elclass.action";
