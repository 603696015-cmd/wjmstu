...
<html>
	<head>
		...
		var bmarr = new Array();  
			...
			function _onsubmit(){
				...
				if(document.getElementById("t_hname").value==''){
					alert("讲师不能为空!");
					return false;
				}
				var ts=/^[\d]{0,}$/;
				...
				if(parseInt($("#xuexi").val()) > parseInt($("#cDuring").val())){
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">创建多媒体课堂</span>
			</li>-->
		</ul>
				</td>
		...
		<div>
			<s:form action="course_add" method="post" name="course_info"
				...
				<table cellpadding="1" cellspacing="1" bgcolor="#ECEDEB" width="700">
					...
					<tr>
						<td width="100" height="30" align="right" >
							<span class="neededitem">*</span>讲师姓名：
						</td>
						<td >
							<label>
					...
					<tr>
						...
						<td >
							<label>
								<wysLib:ctypeTree did="0" rootAble="false"
									iname="course.ctype.id" itype="ra_2no"  ></wysLib:ctypeTree> 
								<!-- ivalue="${course.ctype.id}" -->
								<!-- <s:property value="ctypeTree.child[0].id"/>  -->
					...
					<tr>
						<td align="right" bgcolor="#FFFFFF" style="color: black">
							<span class="neededitem">*</span>课程信息：
						</td>
						<td >
							<!--<label>
								标准课程
							...
							<input type="radio" name="course.islink" value="1"
								onclick="document.getElementById('div_link').style.display='block';document.getElementById('url_desc').innerHTML='外部课程链接地址';document.getElementById('div_link_tb').style.display='none';document.getElementById('div_link_xx').style.display='none';">
							&nbsp;&nbsp;
							<label>
								组合式外部课程
							</label>
							...
							<s:hidden name="course.islink" value="4"></s:hidden>
							<div id="div_link_tb" style="display: block">
									开始时间：
									<input name="course.roomstart" id="r_start" type="text"
										size="20" onclick="setday(this)" readonly="readonly"/>
									结束时间：
									<input name="course.roomend" id="r_end" type="text"
										size="20" onclick="setday(this)" readonly="readonly"/>
							</div>
							<div id="div_link_xx" style="display: block">
								学习时间：
								<input name="course.during" id="cDuring" type="text" size="5">
								分钟 学习询问时间：
								<input name="course.querytime" type="text"
									value="<s:property value="course.querytime"/>" id="xuexi" size="5">
								分钟
							</div>
						</td>
					</tr>
