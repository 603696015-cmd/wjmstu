...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">我创建的多媒体课堂</span>
			</li>-->
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			<table width="100%">
				<tr>
					<td width="200px" valign="top" id="tree_list_td">
						<wysLib:ctypeTree rootAble="true"
							href="mymulti-media_list.action?str=mymulti-media_list&ctype.id="  ></wysLib:ctypeTree>
					</td>
				...
				课程名称：<s:textfield name="course.name"></s:textfield>
						...
						<s:if test="mymultis.size==0">没有找到符合条件的课程</s:if>
						<s:else>
						...
						&nbsp;
									...
									<s:iterator value="mymultis">
										<tr>
											...
											<td align="center" >
												&nbsp;
												<s:property value="validName" />--<s:property value="course.status"/>
											</td>
											<td align="center" >
												<a target="_parent"
													href="courseman.action?course.id=<s:property value="id"/>" class="textbg">课件制作</a>
											</td>
											<!-- td align="center" >
			...
			<script>
				...
				function page(i){
										document.location.href="myCourse_list.action?pS=<s:property value="pS"/>&pN='"+i+"'&str=mymulti-media_list"
								}
			</script>
