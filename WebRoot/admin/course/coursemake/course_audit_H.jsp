...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<!-- 内容 -->
		<!--<s:form action="course_audit_reply" method="post" theme="simple">-->
			...
			<table cellpadding="1"   cellspacing="1" >
				...
				<tr>
				 <td   align="center" >
							...
							<textarea name="courseAudit.replycontent" cols="60" rows="7" disabled="disabled">
							<s:property value="courseAudit.replycontent"/>
							</textarea><br>
							<!--回复<br>
							<s:textarea name="courseAudit.content" cols="60" rows="7"></s:textarea> 
							<s:hidden name="courseAudit.id" /> 
							<input class="textbg6" name="submit" type="submit" value="回复" />-->
		</div>
							<!--</s:form>-->
		<!-- 内容 -->
	</BODY>
