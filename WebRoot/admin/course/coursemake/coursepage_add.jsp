				...
				<table width="100%" align="center" cellpadding="1" cellspacing="1"
					...
					<s:if test="course.islink==0">
						<tr>
							...
							<td >
								<label>
									<input type="text" size="4" name="coursePage.during" id="during" value=1>
									分钟
								</label>
								<label>
								&nbsp;询问学员是否学习间隔时间:	<input type="text" size="4" name="coursePage.queryTime"  id="queryTime" value=-1>
									分钟(-1是不询问)
								</label>
							</td>
						</tr>
					...
					<tr>
						...
						<td >
							<label>
								<input type="radio" name="coursePage.skipable" id="skipable" value="1" checked="checked">
								是&nbsp;&nbsp;&nbsp;
					...
					<tr>
						...
						<td >
							<label>
								<input type="radio" name="coursePage.isNull" id="isNull" value="1" >
								是&nbsp;&nbsp;&nbsp;
								<input type="radio" name="coursePage.isNull" id="isNull" value="0" checked="checked">
								否
							</label>
						</td>
					</tr>
					<tr>
						...
						<td >
							<label>
								<input type="radio" name="coursePage.islive" id="skipable" value="1" >
								是&nbsp;&nbsp;&nbsp;
								<input type="radio" name="coursePage.islive" id="skipable" value="0" checked="checked">
								否
							</label>
						</td>
					</tr>
					<tr>
						...
						<td >
							<label>
								<input type="radio" name="coursePage.isfree" id="skipable" value="1" checked="checked">
								是&nbsp;&nbsp;&nbsp;
								<input type="radio" name="coursePage.isfree" id="skipable" value="0">
								否
							</label>
						</td>
					</tr>
					<tr>
							...
							<td bgcolor="#F8FCFE" colspan="3">
								...
								function addSt(){
									...
									stuff.id= "ds_"+ii;
									stuff.innerHTML="名称：<input type='text' style='width:200px;' name='coursePage.stuffs.title' id='stufftt_"+ii+"'/><input type='hidden' style='width:200px;' name='coursePage.stuffs.description' id='stuff_"+ii+
					...
					<tr>
						...
						<td >
							<label>
								<input type="text" name="coursePage.pic_g" id="pic_g"
									style="width: 400px;" />
								<span ><a
					...
					<tr>
						...
						<td >
							<label>
								<input type="text" name="coursePage.pic_l" id="pic_l"
									style="width: 400px;" />
								<span ><a
					...
					<tr>
						...
						<td >
							<label>
								<input type="text" name="coursePage.pic_h" id="pic_h"
									style="width: 400px;" />
								<span><a
