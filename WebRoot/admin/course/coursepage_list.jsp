...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">管理网页</span>
			</li>
			<li class="sep">
			</li>
			<li>
				<a style="cursor: hand"
					...
					href="coursepage_addInit.action?course.id=<s:property value="course.id"/>&coursePage.course.id=<s:property value="course.id"/>">添加网页</a>
			</li>-->
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<s:elseif test="course.islink==1||course.islink==4">
				当前课程不需要设置章节
			</s:elseif>
			<s:else>
					...
					<table width="100%" align="center" cellspacing="1">
						...
						<s:iterator value="coursePages" id="cpid" status="cpst">
							<tr>
								...
								<td width="40" align="center" >
									<a
										href="coursepage_alterInit.action?coursePage.id=<s:property value="id"/>">编辑</a>								</td>
								<td width="70" align="center" >
									<a
										href="practicepaper_list.action?course.id=${course.id }&pracPaper.course.id=${course.id }&pracPaper.cpage.id=<s:property value="id"/>">编辑练习</a>								</td>
								<td width="40" align="center" >
									<s:if test="sortid!=1">
										<a
							...
							<s:iterator value="pracPapers">
								<tr bgcolor="#CCCDCB" background="#CCCDCB">
									<td width="80" align="center" background="#CCCDCB" bgcolor="#CCCDCB">
										<i>章节练习</i>									</td>
									<td height="30" align="center" bgcolor="#CCCDCB">
										<i>
									  <s:property value="examPaper.title" /> </i>
								  </td>
									...
									<td width="110" align="center" bgcolor="#CCCDCB">
										<i> 
									  <s:date name="examPaper.modifytime"
												format="yyyy-MM-dd HH:mm:ss" /> </i>
								  </td>
									<td width="80" align="center" bgcolor="#CCCDCB">
										<i> 
										<s:if test="examPaper.random">随机</s:if> <s:else>手工</s:else>
									  </i>
								  </td>
			...
			<br>
			<a
				href="coursepage_importInit.action?course.id=<s:property value="course.id"/>"
