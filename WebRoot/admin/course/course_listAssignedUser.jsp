...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<s:form action="course_assigntoUsersInit.action" method="post" name="assignSearch_assignment" theme="simple">
			<s:hidden name="course.id" />
		...
		<table width="100%">
			...
			<%
			   ...
			   String url="course_assigntoUsersInit.action?course.id="+course.getId()+"&deptid=";
			 %>
						...
						function unassign(){
						  if(window.confirm("确定取消分配？！")){
						     var checkObj = document.getElementsByName("id");
							  ...
							  var userids = document.getElementById("userids");
						      userids.value=billIDs;
							  course_assignment.action="course_newunassigntoUsers.action?status=0";
							  course_assignment.submit();
							}
						}
		...
		<form action="course_assigntoUsersInit.action" method="post" name="acc_list">
