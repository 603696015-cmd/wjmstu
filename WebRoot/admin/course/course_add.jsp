...
<%@page import="com.sopia.courseman.entities.CourseType"%>
...
<%
	...
	CourseType ctypeTree= (CourseType)request.getAttribute("ctypeTree");
%>
<html>
	<head>
			...
			function _onsubmit(){  
				...
				*/
				...
				if(checkValue==3||checkValue==1){
					...
					if (!checkNumber($("#xuexi").val())){
						alert("学习询问时间请输入数字！");
						return false;
					}
					if(parseInt($("#cDuring").val()) < parseInt($("#xuexi").val()) ){
	...
	<body>
		...
		<!-- 内容 -->
		<div>
			<s:form action="course_add" method="post" name="course_info"
				...
				-->
				<table cellpadding="1" cellspacing="1" bgcolor="#ECEDEB" width="100%">
					<tr>
					...
					<tr>
						...
						<td >
							<label> 
								...
								<s:hidden name="course.teacherId" id="t_id"/><input class="textbg6" type="button" onClick="searchUserInit('messUser')" value="查 找">
					...
					<tr>
						...
						<td >
							<label>
								...
								<a href="javascript:setUrl('pic');" style="width:80px;" class="textbg6">浏览资源库</a>
							</label>
						</td>
					</tr>
					...
					<tr>
						...
						<td >
							<label>
								...
								<!-- ivalue="${course.ctype.id}" -->
							</label>
						</td>
					</tr>
					<tr>
						<td width="100" height="30" align="right" >
							<span class="neededitem">*</span>对应论坛坛版块：
						</td>
						<td >
					...
					<tr>
						...
						<td >
							<label>
								<s:textfield name="course.credit" id="course.credit"></s:textfield>
							</label>
						</td>
					</tr>
					<!--<tr>
					...
					<tr>
						...
						<td >
							<input type="radio" checked="checked" name="course.islink"
								value="0"
								onclick="document.getElementById('div_link').style.display='none';document.getElementById('div_link_tb').style.display='block';document.getElementById('div_link_xx').style.display='none';">
							<label>
								标准课程
							</label>
							&nbsp;&nbsp;
							<input type="radio" name="course.islink" value="1"
								onclick="document.getElementById('div_link').style.display='block';document.getElementById('url_desc').innerHTML='外部课程链接地址';document.getElementById('div_link_tb').style.display='none';document.getElementById('div_link_xx').style.display='block';">
							<label>
								外部课程
							</label>
							&nbsp;&nbsp;
							...
							<input type="radio" name="course.islink" value="2"
								onclick="document.getElementById('div_link').style.display='none';document.getElementById('div_link_tb').style.display='none';document.getElementById('div_link_xx').style.display='none';">
							 -->
							&nbsp;&nbsp;
							<input type="radio" name="course.islink" value="3"
								onclick="document.getElementById('div_link').style.display='block';document.getElementById('url_desc').innerHTML='视频地址';document.getElementById('div_link_tb').style.display='none';document.getElementById('div_link_xx').style.display='block';">
							<label>
								单一视频课程
							</label>
							&nbsp;&nbsp;
							<input type="radio" name="course.islink" value="4" id="islink_4"
								onclick="document.getElementById('div_link').style.display='none';document.getElementById('div_link_tb').style.display='block';document.getElementById('div_link_xx').style.display='block';">
							...
							<input type="radio" name="course.islink" value="5"
								onclick="document.getElementById('div_link').style.display='none';document.getElementById('div_link_tb').style.display='none';document.getElementById('div_link_xx').style.display='none';">
							 --%>
							 <input type="radio"  name="course.islink"
								value="6"
								onclick="document.getElementById('div_link').style.display='none';document.getElementById('div_link_tb').style.display='block';document.getElementById('div_link_xx').style.display='none';">
							<label>
								线下课程
							...
							<div id="div_link" style="display: none">
								<label>
									...
									<!--<input name="course.exurl" type="text" id="exurl" value=""
										size="50">
										-->
										<input type="text" name="course.exurl" id='exurl' size="50"/> <span id="exurl_a"><a href="javascript:setUrl('exurl');" class="textbg4" style="width:80px">浏览资源库</a></span>
								</label>
							</div>
							<div id="div_link_tb" style="display: block">
								<label>
									开始时间：
							...
							<div id="div_link_xx" style="display: none">
								学习时间：
								<input name="course.during" id="cDuring" type="text" value="45" size="5">
								分钟 学习询问时间：
								<input name="course.querytime" type="text"
									value="<s:property value="course.querytime"/>" size="5" id="xuexi">
								分钟
							</div>
						</td>
					</tr>
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[0].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[1].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[2].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[3].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[4].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[5].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[6].name" />：</td>
						<td>   
					...
					<tr>
					  <td align="right"><s:property value="baseCourseTypeList[7].name" />：</td>
						<td>   
					...
					<tr>
						...
						<td height="30" >
							...
							<div id="divSQ_1" style="display: none;">
								...
								>
								<!-- <tr>
									<td  width="100" height="20" align="right" bgcolor="#E6F9F9">复核人员:</td>
									<td> 
										<div id="valids">
										<a href=""
								...
								<tr>
									...
									<td>
										<label>
											<input type="radio" name="coRegistration.isAudit" value="1" />
											需要
											<input type="radio" name="coRegistration.isAudit" value="0" checked="checked" />
											不需要
										</label>
									</td>
								</tr>
					...
					<tr> 
						...
						<td >
							...
							<input class="textbg6" name="submit" type="submit" value="确认添加" style="border:none" /> 
							&nbsp;&nbsp;&nbsp;<a class="textbg6" href="course_list.action">取消</a>
						</td>
					</tr>
			  </table> 
