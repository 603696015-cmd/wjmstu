			...
			<td>
				<table>
					<tbody>
						<tr><td>发布内容页操作</td></tr>
						<tr>
							<td height="35" align="center">发布最新添加</td>
							<td width="78%" height="35">
								<input type="text"  name="pb" id="new" value="50" style="20%"/>篇文章
						...
						<tr>
							...
							<td height="35">
								从<input type="text" id="start"/>到
								<input type="text" id="end"/>
								<input type="submit" onclick="NewPb(2)" border="0" value="发布>>"/>
							</td>
						</tr>
						<tr>
							<td height="50" align="center">按文章栏目发布</td>
							<td height="50">
								<table width="100%" cellspacing="0" cellpadding="0" border="0">
									<tbody>
										<tr>
											...
											<td width="61%">
												<input type="submit" border="0" onclick="NewPb(3)" value="发布选中栏目的文章>>"/>
											</td>
										</tr>
									</tbody>
								</table>
							...
							<tr>
							<td height="30" align="center">发布所有文章页面</td>
							<td height="30">
								<input type="radio" checked="checked" value="0" name="all" />仅发布未生成过Html的文章
								<input type="radio" value="1" name="all" />发布所有页面
							...
							<td>
								<table>
									<tbody>
										<tr>
											<td>
												<input type="radio" checked="checked" name="list" id="list_0" value="0"/>更新所有列表分页<br />
												<input type="radio"  value="1" name="list"/>仅发布每个列表页的前<input id="list_1" type="text"/>页
											</td>
								...
								<table>
									<tbody>
										<tr>
											...
											<td>
												<input type="radio" checked="checked" name="cata" value="0"/>更新所有列表分页<br />
												
												<input type="radio" value="1" name="cata"/>仅发布每个列表页的前<input type="text" style="text-align:center" size="6" id="number"/>页
												<input id="" type="submit" onclick="NewPb(6)" border="0" value="发布选中的栏目>>" name=""/>
											</td>
										</tr>
									</tbody>
								</table>
