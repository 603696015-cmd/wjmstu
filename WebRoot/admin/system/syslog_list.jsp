...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="日志列表" /></div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">系统日志列表</span>
			</li>-->
		</ul>
				</td>
		...
		<div style="margin-top: 0px; text-align: center;">
			<s:form theme="simple" action="syslog_list.action" method="post"
				name="acc_list">
				...
				<s:submit value="查询" cssClass="textbg4" onclick="document.getElementById('pageNow').value='0';"/>
			</s:form>
