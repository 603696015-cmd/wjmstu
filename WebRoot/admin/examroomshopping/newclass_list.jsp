...
<HTML>
	<HEAD>
		...
		<TITLE>五矿发展员工职业发展系统--考场搜索结果列表</TITLE>
		<base href="<%=basePath%>">
...
var ax={"statusId":'1'}
  ...
  <TBODY>
    <TR>
      <td width="120"  align="center"><span class="STYLE10">考场中心</span></td>
  ...
  <tr>
    <td background="images/shopping/pic_17.gif" class="STYLE10"> 　　<span class="STYLE11">位置导航：考场导航中心</span></td>
  </tr>
</table>
		<table width="960px" border="0" align="center" cellpadding="0"
          ...
          <tr>
            <td width="270" valign="top"><table width="100%" border="0">
                <tr>
                  <td>
				  <form action="forum_getAllRoom.action" name="class_listbytypeid"  method="post" >
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td height="60" align="left" valign="top" style="PADDING: 8px; line-height:25px;">
										...
										<wysLib:eroomLibTree itype="ra" iname="eroomLib.id"  ivalue="<%=eroomId %>"
							href="forum_getAllRoom.action?sublibs=1&examRoom.eroomLib.id="
							rootAble="true"></wysLib:eroomLibTree>
								<br/> 
						   
											<input
												style="WIDTH: 98%; border: 1px solid #000000;height:20px;line-height:20px; "
												type="text" id="elclassName" name="examRoom.title" value="填写考场名称...." 
												onclick="this.value=''"/> 
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <%-- 
											<td>
												<span class="STYLE6">当前位置：考场 &gt;&gt; <s:property
