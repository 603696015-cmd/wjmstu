...
<html>
	<head>
		...
		<link href="css/jquery.zdy.dialog.css" rel="stylesheet"
			...
			<link href="css/20140328style.css" rel="stylesheet"
			type="text/css" media="screen" />
...
body {
	...
	margin-right: 0px;
	margin-bottom: 0px;
	background-image: url(http://localhost:8080/wjm/images/images1113/xuexiye.png);
...
-->
		...
		debugger;
			...
			function myload_(status){
				...
				document.getElementById("next_course").src="images/bf/anniu_32h.png";
				debugger;
...
.daan {
	...
	<body OnLoad="myload_('<s:property value="status"/>');" style="min-height:650px;" ><!--sun 样式修改-->
		<!-- 新版页面格局 -->
		<table width="1003" height="610" border="0" align="center"
			cellpadding="0" cellspacing="0" style=c8px;display:none;">
			<tr>
				<td height="507">
                                                ...
                                                <td ></td>
													<s:if test="initCompliance">
														<td width="210" valign="middle">
																<img src="images/test.png" alt="test"  style="cursor:pointer;" 
													...
													<s:else>
														<s:if test="mycourse.passed && mycourse.examPass!=1">
															<td  align="center" valign="middle" style="padding:0;">
																	<img src="images/test1.gif" alt="test" style="cursor:pointer;" 
																		align="middle" onClick="enterEroom(<s:property value="mycourse.myRoom.examroom.id" />,<s:property value="epid" />,<s:property value="elclass.id"/>,<s:property value="course.id" />,0);"> 
															</td>
														</s:if>
														...
														<s:else>
															<td align="center" valign="middle" style="padding:0;">
																	<img src="images/test_h.png" alt="test" style="cursor:pointer;" 
		...
		<table width="1200" height="605" border="0" align="center"
			cellpadding="0" cellspacing="0">
          <tr>
            <td height="507"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="507" align="right" valign="top" style="padding-top:50px;"><!--高度样式修改--><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="54" height="74">&nbsp;</td>
						...
						<img height="55" src="images/datigaiban/fanhui.png" width="60" onClick="backup();" style="cursor:pointer;" />
						</td>
                      </tr>
                    <tr>
                        <td height="440">&nbsp;</td>
                      <td width="783" align="left" valign="top" style="padding-left:1px;"><div id="page_file" style="height: 552px; width:778px;overflow: hidden"></div></td>
                        <td>&nbsp;</td>
                    </tr>
                  </table></td>
                </tr>
          ...
          <tr>
            <td height="100" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0"
              ...
              <tr>
                ...
                <td  width="85" align="center" valign="middle"><img src="images/bf/anniu_35.png"  style="cursor:pointer;" 
									onmousedown="this.src='images/bf/ann_35.png'"
									onmouseup="this.src='images/bf/anniu_35.png'"
									onclick="js_stop();" width="50" height="50" /> </td>
                <td  width="85" align="center" valign="middle"><img src="images/bf/anniu_31.png" width="50" height="50" id="pause_play" style="cursor:pointer;" 
											 onclick="js_pause_play();" /> </td> 
                <td  width="85" align="center" valign="middle"><img src="images/bf/reset.png" style="cursor:pointer;" 
									onmousedown="this.src='images/bf/reseth.png'"
									onmouseup="this.src='images/bf/reset.png'"
									onClick="js_reset()" width="50" height="50" /> </td>
                <td  width="85" align="center" valign="middle"><img src="images/bf/cidian.png" style="cursor:pointer;" 
									onClick="showV();" width="50" height="50" /> </td>
                 <!--
							<td width="60" align="center" >
	                            	
	                        </td>
	                      
                <s:if test="myCPage.examRooms.size()>0">
								<s:iterator value="myCPage.examRooms" status="status">
									<s:if test="initCompliance">
										
										<td  width="65" align="center" valign="middle">
											<a onClick="return saveToUrl(this);" id="haha<s:property value="sortid" />" >
												<img src="images/bf/startquiz.png" name="<s:property value="title" />"
													 width="65" height="50" id="<s:property value="sortid" />" alt="<s:property value="id" />" cpid="<s:property value="cpid" />" epid="<s:property value="examPaper.id" />" />
											</a>
										</td>
										
										<td   align="center" valign="middle">
											<a onClick="return saveToUrl(this);" id="haha<s:property value="sortid" />" >
                                            <p class="xxdt" id="<s:property value="sortid" />" alt="<s:property value="id" />" cpid="<s:property value="cpid" />" epid="<s:property value="examPaper.id" />"> 
									...
									<s:else>
										<s:if test="canExam == 1">
											<td   align="center" valign="middle">
												<a onClick="return saveToUrl(this);" id="haha<s:property value="sortid" />" >
	                                            <p class="xxdt_g" id="<s:property value="sortid" />" alt="<s:property value="id" />" cpid="<s:property value="cpid" />" epid="<s:property value="examPaper.id" />"> 
	                                            	<s:property value="title" />
	                                            </p>
												</a>
											</td>
										...
										<s:else>
											<td   align="center" valign="middle">
												<a onClick="return saveToUrl(this);" id="haha<s:property value="sortid" />" >
	                                            <p class="xxdt_h" id="<s:property value="sortid" />" alt="<s:property value="id" />" cpid="<s:property value="cpid" />" epid="<s:property value="examPaper.id" />"> 
	                                            	<s:property value="title" />
	                                            </p>
												</a>
											</td> 
							...
							-->
                <td width="85"  align="right" valign="middle"><A id="choose_menu" onClick="return saveToUrl(this);"> <img
										src="images/bf/anniu_32h.png"  style="cursor:pointer;" 
										id="next_course" width="50" height="50" /> </A> </td>
                <td width="545" align="right" valign="middle"></td>
              </tr>
            </table></td>
          </tr>
        </table>
