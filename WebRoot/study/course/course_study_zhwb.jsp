...
<script type="text/javascript">
			function myload(){
				_cpst=new Cstudy(<s:property value="course.id"/>,
	...
	<script type="text/javascript">if(window.confirm("继续学习？")){
		document.location="course_study_zhwb_page.action?coursePage.id=-1&course.id=${course.id}";
	}</script>
									...
									<table height="100%" bgcolor="red" cellpadding="0" cellspacing="0">
										<tr>
											<TD width=300 height="250" vAlign=top bgColor=#dae9fe
												id="page_file">
													<a target="_blank" href="course_study_zhwb_page.action?coursePage.id=-1&course.id=<s:property value="course.id"/>"><img border="0" src="images/begin.jpg" width="100%" height="100%" /></a>
											</TD>
										</tr>
										<tr>
											<TD width=300 height="30" vAlign=top bgColor=#dae9fe>
												...
												<div style="width: 100%; height: 10px; text-align: center;margin-top: 5px;">
													<div
														style="width: 200px; height: 10px; background: buttonface; text-align: left;"
														id="processDiv">
													</div>
												...
												<ul>
														<s:iterator value="myCPages" id="cp">
															<LI style="font-size: 14px;">
																...
																<A target="_blank"
																	href="course_study_zhwb_page.action?coursePage.id=<s:property value="cpage.id" />&course.id=<s:property value="course.id"/>">
