							...
							<tr>
										...
										<tbody>
											<tr>
												<td vAlign="middle" align="center" width=300
													background="images/img/bfz_r1_c11.jpg"><table style="margin-left:15px;" width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
                                                  <tr>
                                                  ...
                                                  <tr>
                                                    <td valign="middle"><font style="font-size:12px;"><a href="displayStudyCpageInfo.action?course.id=<s:property value="course.id"/>&course.classid=<s:property value="course.classid"/>">各章节学习详情</a></font></td>
                                                  </tr>
                                              </table>												</td>
								...
								<td width=192>
									<table cellSpacing=0 cellPadding=0 width=192 border=0>
										<tbody>
											<tr>
												<td width="192px" height="47px"><img height="47px" src="images/img/t-6.jpg" width="192px" /></td>
											</tr>
											<tr>
												<td width="192px" background="images/img/t-7.jpg"
													height="21px">
													<table cellSpacing=0 cellPadding=0 width=192 border=0>
														<tbody>
															<tr>
																...
																<td style="FONT-SIZE: 12px" vAlign=bottom width=120>
																	<A href="javascript:void(0)" onclick="window.close();"><SPAN class=STYLE5>关闭</SPAN></A>
					...
					<table height="100%" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td width="300px" valign="top" height="100%" id="left"
								bgcolor="red">
								<table height="100%" width="300px" bgcolor="red" cellpadding="0"
									cellspacing="0">
									<tr>
									...
									<tr>
										<td width="300px" valign="top" bgcolor="#dae9fe" height="100%">
