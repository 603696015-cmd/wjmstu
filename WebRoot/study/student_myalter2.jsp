...
<HTML>
	...
	<BODY onload="setGd();">
		<s:form action="student_myalter2" method="post" theme="simple" name="form1" id="registerForm" onsubmit="return myCheck();">
			<div id="OutlineDiv">
						...
						<td>
							...
							<TABLE width="100%" border="0" align="center" cellPadding="0"
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;"> 
										<select name="elUser.suoxuezhuanye" id="qrz_sxzy"> 
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;">
											...
											value="<s:property value="elUser.feibiyeshijian" />" readonly
											onclick="setday(this)" readonly/>
									</td>
									<td align="right" class="pg_add_head">
										工作单位地址:
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;">
										<select onchange="setGd()" name="elUser.gaoduanrencai" id="xx">
											<option
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;">
										<select id="gd_lx" name="elUser.gaoduanrencaileixing">
											<option
								...
								<tr>
									...
									<td class="pg_add_content"
										...
										<input  id="gd_rq" type="text" name="elUser.gaoduanrencairiqi" size="13"
											value="<s:property value="elUser.gaoduanrencairiqi" />" onclick="setday(this)" readonly/>
								...
								<TR class="pg_add_bottom">
									<TD colspan="7">
										<DIV align="center">
											...
											<input type="hidden" name="elUser.department.id"
												value="<s:property value="elUser.department.id"/>" />
											<a href="#" onclick="history.back(-1);return false;"> 取消返回 </a>
										</div>
									</td>
								</tr>
							</table>
