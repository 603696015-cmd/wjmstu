...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function courseStudy(courseid,pageid,classid){
			window.parent.location.href = "course_study.action?course.id="+courseid+"&coursePage.id="+pageid+"&classid="+classid;
		}
		</script>
				...
				<tr>
					...
					<td valign="middle" bgcolor="#F8FCFE">
						<a href="javascript:void(0);" style="padding-left: 15px;"
							class="zc01"><s:property value="course.name" />
						</a>
					</td>
					...
					<td width="120" height="40" align="left" bgcolor="#F8FCFE">
						<div
							...
							<img src="images/jd.gif" width="<s:property value="process" />%"
								height="14" />
						</div>
					</td>
					<td width="60" align="center" bgcolor="#F8FCFE">
						<a 
							href="javascript:courseStudy(<s:property value="course.id" />,<s:property value="firstCpid" />,<s:property value="course.classid" />);"
							> <img src="images/xtb021.gif" width="28"
								height="27" /> </a>
					</td>
				</tr>
			</s:iterator>
