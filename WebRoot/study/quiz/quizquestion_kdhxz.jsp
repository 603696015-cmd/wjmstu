...
function playQmusicByObject(object){
 ...
 var questype = <s:property value="question.qtype" />;
   ...
   //董克修改2015-8-30
   function checkModelStateDK(type,atime,wrongCount){
   ...
   function checkVedio(){
	   ...
	   var flashViedo = getFlashMovieObject("video");
	   var totalFrames;    
		//IE与标准浏览器的差别    
		try{  //For Opera/FF    
		  totalFrames=flashViedo.TotalFrames();    
		}catch(e){  //For IE    
		  totalFrames=flashViedo.TotalFrames;    
		}    
		var curFrame=flashViedo.CurrentFrame()+1;    
...
$(function(){
		...
		var left = $(document.body).width()/2+240;
...
function check_bofang(){
	if(fashengQuestion.url!=""){
		if(fashengQuestion.playState == 3){
    ...
    <td><span class="STYLE1">得分：</span>
									...
									<tr>
										<td width="535" height="460">
											<div id="swfcontent" style="height:458px;width:650px;"></div>
										</td>
									</tr>
							  </table>
						  </td>
						  ...
						  <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td height="74" align="left" valign="top" class="STYLE1">
                                            <table border="0" cellspacing="0" style="margin-left:20px;margin-top:15px;">
                                            	<tr>
                                                	<td width="60" align="left" valign="top" style="padding-top:4px;"><img height="45" width="45" src="images/20140702/help_l.png" style="cursor:pointer;" 
														onmousedown="this.src='images/20140702/help_l.png'"
														onmouseup="this.src='images/20140702/help_l.png'"
														onclick="preview('http://10.1.1.40:8080/wjm/course/yanshi/tingke/index.swf');"/><!-- <s:property value="helpSwf" />-->													</td>
                                                    <td width="60" align="left" valign="top" style="padding-top:4px;"><img height="45" src="images/20140702/txt_s.png" width="45"  style="cursor:pointer;" onclick="showStemText();"/></td>
                                                    <td width="60" align="left" valign="top" style="padding-top:4px;"><img height="45" src="images/20140702/fanhui.png" width="45" style="cursor:pointer;" onclick="backup();" /></td>
                                                </tr>
                                          </table>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<s:if test="view==0">
								...
								<td width="65" align="center" valign="middle">
										<img src="images/tz_images/bf/anniu_35.png" width="50" height="50"
										    onmousedown="this.src='images/tz_images/bf/ann_35.png'" style="cursor:pointer;"
								...
								<!-- 暂停播放切换 -->	
								<td width="65" align="center" valign="middle">
										<img src="images/bf/anniu_31.png" width="50" id="pause_play" style="cursor:pointer;"
								...
								<td width="65" align="center" valign="middle">
										<img src="images/datigaiban/reset.png" width="50" height="50"
											onmousedown="this.src='images/bf/reseth.png'" style="cursor:pointer;"
								...
								<td width="65" align="center" valign="middle">
                                	...
                                	<img src="images/bf/cidian.png"  style="cursor:pointer;"
								...
								<s:if test="examType == 1"><!-- 章节考试 -->
									<td width="65" align="center" valign="middle">
		                                	<img id="next" 
		                                		src="images/datigaiban/anniu_32h.png"  style="cursor:pointer;"
							...
							<s:else>
								...
								<!-- 上一题 -->
								<td width="65" align="center" valign="middle">
										<img src="images/datigaiban/ann_37.png"  style="cursor:pointer;"
								...
								<!-- 停止 -->
								<td width="65" align="center" valign="middle"> 
										<img src="images/tz_images/bf/anniu_35.png" width="50" height="50" style="cursor:pointer;"
							    ...
							    <!-- 重置 -->
								<td width="65" align="center" valign="middle">
										<img src="images/datigaiban/reset.png" width="50" height="50" style="cursor:pointer;"
								...
								<td width="65" align="center" valign="middle">
										<img src="images/datigaiban/anniu_32h.png" 
		                                		onmousedown="this.src='images/datigaiban/anniu_32h_h.png'" style="cursor:pointer;"
												onmouseup="this.src='images/datigaiban/anniu_32h.png'"
		                                		width="50" height="50"
		...
		<div id="stem_Voc" style="display:none;overflow-y: scroll;overflow-x:no; scrollbar-face-color: #dbebfe; scrollbar-shadow-color: #b8d6fa; scrollbar-highlight-color: #ffffff; scrollbar-3dlight-color: #dbebfe; scrollbar-darkshadow-color:#458ce4; scrollbar-track-color: #ffffff; scrollbar-arrow-color: #458ce4  ">
			<div> 
				<span style="margin-left: 410px; color: #000;"><a href="javascript:void(0);" onclick="closeVoc();">
					<img src="images/datigaiban/wrong.png" width="15" height="15"  />
				</a></span>
			</div>
		...
		<div id="view_Voc" style="display:none;overflow: scroll; scrollbar-face-color: #dbebfe; scrollbar-shadow-color: #b8d6fa; scrollbar-highlight-color: #ffffff; scrollbar-3dlight-color: #dbebfe; scrollbar-darkshadow-color:#458ce4; scrollbar-track-color: #ffffff; scrollbar-arrow-color: #458ce4  ">
			<div>
		...
		<table width="280" border="0" align="right"  cellpadding="0" cellspacing="0">
             <tr>
                 ...
                 <td width="50px" ><div id="r_o_w_img" style="width:60px;height:55px;"></div></td>
                 <td width="50px">
                      <img src="images/datigaiban/tj.png" 
					       ...
					       id="tj" width="50" height="50" style=" float:right; cursor:pointer;" />
				 </td>
...
TINY.box.show({html:content3,boxid:'frameless',width:550,height:300,fixed:false,maskid:'bluemask',maskopacity:40,closejs:function(){closeJS(obj1)}});
		...
		obj.video.Play();
		obj.vedio_statu = null;
		obj.vedio_statu = setTimeout("checkVedio()", 1000);
			}
