...
.daan {
	...
	<body onload="load();" >
		...
		<table width="1003" height="612" border="0" align="center"
			...
			background="images/datigaiban/tingyin.jpg">
			<tr>
				<td height="507">
						...
						<tr>
							<td width="557" height="507" align="center" valign="top">
								<table width="94%" border="0" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td width="390" height="200" valign="top">
												<table width="100%" border="0" cellspacing="0"
													...
													<s:if test="view == 0">
														<tr>
	                                                    	<td align="right" valign="bottom" style="padding-right:40px;">
									...
									<s:else>
										<tr>
	                                    	<td height="180" align="right" valign="bottom" style="padding-right:40px;"><img src="images/datigaiban/tj.png" width="50" height="50"
											onclick="submittyxt()" /></td>
	                                    </tr>
									</s:else>	
