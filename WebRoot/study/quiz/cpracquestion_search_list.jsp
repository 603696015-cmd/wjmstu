...
.STYLE3 {
	...
	<body leftmargin="0" topmargin="0" class="ex4"
		...
		<div align="center">
					...
					<td align="center">
						...
						<div align="left">
							<center>
								...
								<form action="cpracquestioninit.action" name="q_form"
									method="post">
									...
									<script type="text/javascript">
										function setAnswer(id,title){
											if( window.confirm('确定选择“'+title+"‘为答案？")){
												...
												q_form.action="cpracquestion_submit.action";
												q_form.submit();
											}
										}
									</script>
			...
			<form action="cpracquestion_search.action" name="q_search" method="post">
