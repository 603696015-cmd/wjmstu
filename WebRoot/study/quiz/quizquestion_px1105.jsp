		   ...
		   //播放视频
			...
			if(view == 0){
				...
				$("#bx_answer table").click(function() {
					...
					//生成需要追加的html
					var jHTML = "<table  border='0' cellspacing='0' cellpadding='0' style='margin:10px;' >"+
							"<tr>"+
								"<td width='16'>"+
...
function submitpx(){
	...
	if(ifview == 0){
		if(endtime == 0){//时间到
			...
			if(endrec == 0 && endupload == 0){//录音并且上传成功后endrec == 0 && endupload==0
					var xx = $('#theform').formSerialize();
					$.ajax({
						beforeSend:function(){
							submitstatus = 0;
...
#apDiv1 {
	...
	<body onload="load();">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="596" height="507" align="right" valign="top">
								<table width="560" border="0" align="right" cellpadding="0"
									cellspacing="0" style="margin-right: 8px;">
									<tr>
										<td height="45" align="center" valign="middle">
											<img src="images/datigaiban/money.png" align="middle" />
											<span class="STYLE1">得分：</span>
											<span class="STYLE1" ><span
												style="color: red; font-size: 30px;" id="totalScore"><s:property
							...
							<td width="407" valign="top" >
							  <table border="0" align="right" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td width="390" height="114" valign="top">
									...
									<s:if test="view==0">
										<tr>
											<td width="390" valign="top" style="padding-top: 0px;">
									...
									<s:if test="view==0">
										<tr>
											<td width="390" valign="top" style="padding-top: 12px;">
												<div style="width:380px" >
													...
													<td>
														<table width="88%" height="44" border="0" align="center"
															...
															<tr>
																<td height="30">
																	录音文本:
																	<s:property value="question.stuAnswer_" />
																</td>
															</tr>
															<tr>
																<td>
									...
									<s:else>
										<tr>
											<td width="390" height="150" align="right" valign="bottom"
												style="padding-top: 12px;">
	                                            <s:if test="view == 0">
	                                            	<img src="images/datigaiban/tj.png" width="50" height="50" align="right" 
	            										style="float:right;margin-right:30px;" onclick="submitpx()" id="tj"/>
		...
		<div id="stem_text" style="display: none">
			<div>
				<span style="margin-left: 380px; color: #000;"><a
					href="javascript:void(0);" onclick="showStemText();"><span
						style="color: red">X</span>
				</a> </span> ${question.stemText }
			</div>
		</div>
