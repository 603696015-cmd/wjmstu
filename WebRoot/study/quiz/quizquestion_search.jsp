...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<LINK rel=stylesheet type=text/css href="search/exam.css">
		<LINK rel=stylesheet type=text/css href="search/css4.css">
		<LINK rel=stylesheet type=text/css href="search/menu1.css">  
...
.STYLE3 {
	...
	<SCRIPT type="text/javascript">
		...
		window.onload=function(){
		    //var qtimer = new QuizTimer('11',"examtime",<s:property value="examPaper.during"/>*60,<s:property value="myExamPaper.jiashi"/>*60,<s:property value="myExamPaper.passTime"/>,85,$("#content_search").offset().left+$("#content_search").width());
	...
	<BODY  oncontextmenu='return false' ondragstart='return false' onselectstart ='return false' onselect='document.selection.empty()' oncopy='document.selection.empty()' onbeforecopy='return false' class=ex4 leftMargin=0 topMargin=0
		bgColor=#ffffff>
		<DIV align=center>
			<TABLE border=0 id="content_search"  cellSpacing=2 cellPadding=0 width=778>
				<TBODY>
					<TR>
						<TD class=list1 height=50 align=middle>
							<%-- 
							<STRONG><FONT color=#000000>姓名：<s:property value="#session.realname"/>(<s:property value="#session.username"/>)&nbsp;&nbsp;&nbsp;
								  &nbsp;&nbsp;</FONT>
							</STRONG>
							 --%>
					...
					<TR>
						...
						<TD>
							<FORM id=frmMySearch method=post name=frmMySearch
								action=quizquestion_search.action>
