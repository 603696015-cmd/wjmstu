...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/quiz_questionnaire.js"></script>
		<script type="text/javascript" src="js/quiz_questionnaire_.js"></script>
		...
		{ 
			...
			<s:property value="myExamPaper.passTime"/>,"quizform","examtime","passTime",<s:property value="examPaper.epBlocks.size"/>);
			quizpaper.autosave();
		}
		</script>
	</HEAD>
	...
	<script type="text/javascript">
		...
		<div class="main">
			...
			<form action="questionnaire_quizpaper_submit.action" method="post" name="quizform"
				id="quizform">
				<wysLib:quizPaper></wysLib:quizPaper>
				<s:hidden name="myExamPaper.examRoom.id" />
				...
				<div align="center">
					...
					<input type="button" value="确认交卷"
						onclick="if(confirm('确定交卷？')) quizpaper.submit();"
						class="regbutton3" />
					<input type="button" value="保存答卷" onclick="quizpaper.save();"
						class="regbutton3" />
				</div>
			</form>
		</div>
