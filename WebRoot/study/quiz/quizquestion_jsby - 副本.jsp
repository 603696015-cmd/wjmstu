                                	...
                                	<td height="74" align="left" valign="middle">
                                    	<table border="0" cellpadding="0" cellspacing="0">
                                            	<tr>
                                                    ...
                                                    <td width="60" align="left" valign="top"  style="padding-top:4px;"><img height="45" src="images/20140702/txt_s.png" width="45" onclick="showStemText();"/></td>
                                                    <td width="60" align="left" valign="top"  style="padding-top:4px;"><img height="45" src="images/20140702/fanhui.png"  width="45" id="fanhui"/></td>
                                                    <td>
                                                    <script type="text/javascript">
    ...
    <td valign="top" style="line-height:25px;"><span id="ques_yangyinText" style="color:white;font-size:18px;font-weight:bold;"></span></td>
		...
		<table border="0"  cellpadding="0" cellspacing="0" width="280">
            <tr>
                ...
                <td width="100px">
				<APPLET ID="录音功能(record)" CODE="com.msc.applet.RecognizeApplet.class"
						CODEBASE="/wjm/record" ARCHIVE="Msc.jar,json-lib.jar" WIDTH="80" HEIGHT="30" MAYSCRIPT>
						<PARAM NAME="type" VALUE="application/x-java-applet;version=1.2.2">
						<PARAM NAME="scriptable" VALUE="false">
                ...
                <td width="70">
                	<img src="record/img/anniu_speaker.png" 
						...
						width='50' height='50' 
						style="float:right;"  onclick="userspeak()"
						id="speaker" />
				</td>
                <td width="50">
