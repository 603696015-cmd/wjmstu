...
.startNewWindow {
	...
	//alert(examType);
		...
		//初始化试卷倒计时
		qtimer = new QuizTimer('11',"examtime",<s:property value="examPaper.during"/>*60,<s:property value="myExamPaper.jiashi"/>*60,<s:property value="myExamPaper.passTime"/>,136,940,right);
		//初始化试卷
