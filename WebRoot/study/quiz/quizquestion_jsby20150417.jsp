...
function replaceImg(){
	...
	document.getElementById("swfcontent").innerHTML='<img src="http://10.1.1.40:8080/wjm/'+stuffImage+'"/>';
	jsbyRemark_=0;
	//jsbyRemark();
}
  ...
  function getApplet(){
	...
	<body onload="load();" style="overflow:hidden;">
		...
		<table width="1147" height="610" border="0" align="center"
			cellpadding="0" cellspacing="0" style="margin-top:117px;">
			<tr>
				<td height="507">
                                	...
                                	<td height="74" align="left" valign="middle">
                                    	<table border="0" cellpadding="0" cellspacing="0">
                                            	<tr>
                                                    ...
                                                    <td width="60" align="left" valign="top"  style="padding-top:4px;"><img height="45" src="images/20140702/fanhui.png"  width="45"  onclick="backup();" /></td>
                                                </tr>
                                      </table>
                                  </td>
                                </tr>
