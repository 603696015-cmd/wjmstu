			...
			<tr>
				<td height="507">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="597" height="507" align="right" valign="top">
								<table width="560" border="0" cellpadding="0" cellspacing="0" style="margin-right:8px;">
									<tr>
										<td height="33" align="center" valign="middle"
											...
											<span class="STYLE1" >
								      			<span style="color:red;font-size:30px;" id="totalScore"><s:property
						  ...
						  <table width="93%" border="0" align="right" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td height="53" align="center" valign="top" class="STYLE1"
											style="padding-top: 12px;" id="quiztime">
										</td>
									</tr>
									<tr>
										<td width="390" height="200" valign="top"
											...
											<form action="#" id="theform" method="post">
												...
												<table width="88%" border="0" align="center"
													cellpadding="0" cellspacing="0" style="color: #CCC; font-weight: bold;">
													<!-- 选项 -->
									...
									<s:else>
										<tr>
	                                    	<td height="200" align="right" valign="bottom" style="padding-right:30px;">
	                                        	<img src="images/datigaiban/tj.png" width="50" height="50"
												onclick="submitktxz()" />
	                                        </td>
	                                  </tr>
									</s:else>
