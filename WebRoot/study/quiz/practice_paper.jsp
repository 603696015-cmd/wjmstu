...
<html>	<head>
		...
		<script type="text/javascript" src="js/cprac_1b1.js"></script>
...
<script type="text/javascript">
	...
	function myload(){
		...
		1080,"quizform","examtime",0,0,"examtime_js","passTime");
		quizpaper.autosave();
	...
	function openNewWindowQ(obj,blockid,qid){
		...
		window.open(".action?myExamPaper.id=<s:property value="examPaper.id"/>&question.epblock.id="+blockid+"&question.id="+qid 
							...
							<table height="100%" bgcolor=#dae9fe cellspacing=0 cellpadding=0
								...
								<tbody>
									<tr>
										...
										<td width="100%" class="block_question_content" valign="top"> <wysLib:practicepaper /><br/>
