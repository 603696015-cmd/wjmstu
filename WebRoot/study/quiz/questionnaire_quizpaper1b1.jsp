...
<html>	<head>
		...
		<script type="text/javascript" src="js/questionnaire_quiz_1b1.js"></script>
		<script type="text/javascript" src="js/ajaxfileupload.js"></script>
		<script type="text/javascript" src="js/questionnaire_quiz_1b1_timer.js"></script>
		<style type="text/css">
body {
	margin: 0px;
	font-size: 12px;
...
<script type="text/javascript">
    ...
    */
	...
	/*document.onkeydown=function(){//左右方向键控制上下题。
	...
	function closeFrame(){
		...
		$("#oprate_question").attr("src","blank2.html");
	}
	...
	<body onload="myload()">
		...
		<table cellspacing=0 style="height: 100%" cellpadding=0 width="100%" border=0>
			<tbody>
				...
				<tr>
					<td valign=top>
						<form action="questionnaire_quizpaper_submit.action" method="post" name="quizform" id="quizform">
									...
									<tr>
										<td width="300px" height="100%" valign="top" id="page_file">
											...
											<s:iterator value="examPaper.epBlocks" status="epb_st">
												<table class="ca_tb" width="300px" blockid="<s:property value="id"/>" questionmount="<s:property value="questions.size"/>" id="ca_block_<s:property value="sortid"/>">
													<tbody>
										...
										<br/><br/><br/>
										 <a onclick="showQP();return false;" href="javascript:void(-1)" class="bt14"><img border=0 id="a_img_pre" src='images/img/preone.gif'/></a>
										 &nbsp;&nbsp;&nbsp;&nbsp;
										 <a onclick="showQN();return false;" href="javascript:void(-1)" class="bt14"><img border=0 id="a_img_next" src='images/img/nextone.gif'/></a> 
		...
		<iframe width="100%" height="100%" id="oprate_question" frameborder="0" src="blank2.html" style="z-index:1000;position: absolute;left:0px;top:0px;display: none;"></iframe>
	</body>
</html>
