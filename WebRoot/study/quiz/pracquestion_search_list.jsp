...
.STYLE3 {
	...
	<body leftmargin="0" topmargin="0" class="ex4"
					...
					<td align="center">
						...
						<div align="left">
							<center>
								...
								<form action="pracquestioninit.action" name="q_form"
									method="post">
									...
									<script type="text/javascript">
										function setAnswer(id,title){
											if( window.confirm('确定选择“'+title+"‘为答案？")){
												...
												q_form.action="pracquestion_submit.action";
												q_form.submit();
											}
										}
									</script>
		...
		<form action="pracquestion_search.action" name="q_search" method="post">
