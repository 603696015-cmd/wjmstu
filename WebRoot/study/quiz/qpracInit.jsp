    ...
    <TD bgColor=#005eac><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr>
		...
		<SCRIPT language=JScript>
		   ...
		   <%-- 
		   <span style="color:white;">网卡地址：</span><INPUT value=00:05:5D:0E:C7:FA name=txtMACAddr>
		   <span style="color:white;">IP地址：</span><INPUT value=192.168.0.2 name=txtIPAddr>
		   <span style="color:white;">域名：</span><INPUT value=typ name=txtDNSName></FORM><br>
		    --%>
		   <span style="color:white;">IP地址：</span><INPUT id="ipAddr" readonly="readonly" name="txtIPAddr" />	   
</td>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=803 align=center>
        ...
        <TR>
          ...
          align=middle><table width="100%" border="0">
              <tr>
                <td width="200">&nbsp;</td>
                <td align="center"><span class="STYLE29">考 前 须 知</span></td>
        ...
        <TR>
          <TD height=200 vAlign=top background=images/guodu002.gif>
            <table width="100%" border="0">
              <tr>
                <td width="80">&nbsp;</td>
                <td align="left"><span class="STYLE13">如果不能进入考试，请尝试以下操作：</span></td>
...
　　如下图所示：<br>
        ...
        <TR>
          <TD height=39 
      background=images/guodu003.gif>&nbsp;</TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
