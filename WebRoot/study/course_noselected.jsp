    ...
    <td align="center" valign="top"><table width="1000" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<div  style="text-align: center;padding-top: 40px;width:100%;font-size: 16px;" >
		 您没有选修 <span style="font-weight:bolder"><s:property value="course.name"/></span> 这门课程！
		 <br>
		 <a style="font-size: 16px;" href="submitAppalyCourse_front.action?course.id=<s:property value="course.id"/>">现在选修</a><br>
