							...
							<table width="100%" height="58" style="margin: 0px;padding: 0px" cellpadding="0" cellspacing="0" background="images/bg_admin.jpg" border="0">
								<tr>
									...
									<td><table width="100%" cellpadding="0" cellspacing="0">
										...
										|
										<a href="logout.action" class="white">退出登录</a> </td></tr>
										<tr><td style="padding: 0px;" align="right" valign="bottom"><ul id="menu" style="margin: 0px;">
											<li>
								...
								<TR>
									...
									<TD id=hide_doc_div vAlign=top width=4
										...
										<IMG id=show_menu_window_img onclick=show_menu_window(this);
											alt=显示菜单 src="images/leftm/hide-no.gif" border=0>
									</TD>
									<TD width="100%" align="center" valign="top">
										<!--右边的主页面-->
										<iframe name="rightFrame" scrolling="auto" src="exam_index.action" frameborder="0"
