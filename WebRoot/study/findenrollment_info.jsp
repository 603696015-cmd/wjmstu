...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			...
			<!--<li>
				<span style="font-weight: bold;">个人学籍</span>
			</li><!--
				<li class="sep">
			</li>
			<li>
		...
		<table width="76%" align="center" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td align="center" >
					<a href="elclass_view.action?elclass.id=<s:property value="elClass.id"/>&elUser.id=<s:property value="elUser.id"/>" class=textbg4>查 看</a>
				</td>
			</tr>
			</s:iterator></tbody>
		</table>
		...
		<table width="76%" align="center" cellpadding="2" cellspacing="1"
			...
			<tr>
		        ...
		        <td align="center" >
					<s:date name="trainstarttime" format="yyyy-MM-dd" />到<s:date name="trainendtime" format="yyyy-MM-dd" />
				</td>
				<td align="center" >
