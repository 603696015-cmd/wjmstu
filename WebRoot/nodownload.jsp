...
<script type="text/javascript">
		...
		function load_(){
			...
			if(window.top==window.self){ 
					document.getElementById("fanhui").style.display="none";//有父页面显示返回按钮
			}else{
					document.getElementById("guanbi").style.display="none"; //没有父页面显示关闭按钮
			}
		} 
		function fanghui(){
											...
											<table width="90%" border="0" cellspacing="0" cellpadding="0">
												...
												<tr>
													<td height="200" align="center" valign="middle">
														<h3
															style="text-align: center; padding-top: 40px; width:800px;list-style: 120%;word-wrap:break-word">
															无法下载
														</h3>
														<div
															style="text-align: center; padding-top: 40px; width: 100%">
															<a onClick="fanghui();return false;" href="#" id="fanhui">返回</a>
															<br>
															<a href="#" onclick="guanbi();return false;" id="guanbi">关闭页面</a>
														</div>
													</td>
												</tr>
