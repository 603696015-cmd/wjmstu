	...
	<head>
	    ...
	    <script type="text/javascript">
			function cv(){
				...
				quizquestion_form.submit();
			}
			 function myload(){
				//var qtimer = new QuizTimer('11',"examtime",<s:property value="examPaper.during"/>*60,<s:property value="myExamPaper.jiashi"/>*60,<s:property value="myExamPaper.passTime"/>,175,500);
				//var quizpaper=new QuizPaper("quizform","examtime","" ,qtimer);
	      		//quizpaper.autoquestionsave();
			}
			function showFj(){
			}
			function quizquestionsubmit(){quizquestion_form.submit();}
			window.onunload = function (){
		   		quizquestion_form.submit();
			}
		</script>
	</HEAD>
	<BODY onload="myload()" oncontextmenu='return false' ondragstart='return false' onselectstart ='return false' onselect='document.selection.empty()' oncopy='document.selection.empty()' onbeforecopy='return false' >
			...
			<TBODY>
				...
				<TR>
					<TD vAlign=top>
						...
						<form method="post" action="quizquestion_submit.action"
							id="quizquestion_form">
