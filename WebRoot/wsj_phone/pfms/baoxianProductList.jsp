		...
		<script type="text/javascript">
			...
			function delBaoxianProduct(id){
				...
				if(window.confirm("确定删除？")){
					assignProduct.action="deleteBaoxianProduct.action?id="+id;
			...
			<table width="100%">
				<tr>
					<td valign="top" width="100" id="tree_list_td">
						<wysLib:productTypeTree href="baoxianProductList.action?sublibs=1&baoxianProduct.ptype.id="
					...
					<td valign="top">
							<form action="baoxianProductList.action?baoxianProduct.ptype.id=<s:property value="baoxianProduct.ptype.id"/>" method="post" name="assignProduct" id="assignProduct">
								...
								<s:iterator value="baoxianProductList">
									<tr>
									    ...
									    <s:if test="is_product_fabu_can_alter==true">
										    <td align="center" valign="middle"><p><a href="updateBaoxianProductView.action?id=${id }" class="textbg4">修改</a></p></td>
										</s:if>
										<s:else>
