		...
		<script type="text/javascript">
			...
			function delBaoxianProduct(id){
				...
				if(window.confirm("确定删除？")){
					assignProduct.action="deleteBaoxianProduct.action?id="+id+"&delete_inallList="+"all";
		...
		<script type="text/javascript">
			...
			function sure_submit(){
				if(window.confirm("确定修改热度属性？")){
			        ...
			        assign.action="change_tuijian.action";
				    assign.submit();
				}
			}
			...
			function del(){
			  if(window.confirm("确定删除？")){
			     var checkObj = document.getElementsByName("id");
			       ...
			       baoxianProductids.value=billIDs;
			       assign.action="deleteBaoxianProduct.action?id="+id+"&delete_inallList="+"all";
				   assign.submit();
				}
			}
			...
			function showDialogue(){
				 ...
				 var rv =  window.showModalDialog("search_tuijian.action?x="+Math.random(),null,sFeature);
				 /*
				 if(rv!=undefined&&rv!=""){
					 var bh=rv.split("_");
					 var bh=rv.split("-=wys=-");
...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<div style="margin-top: 20px; text-align: center;">
			<table width="100%">
				<tr>
					<td valign="top" width="100" id="tree_list_td">
						<wysLib:productTypeTree href="baoxianAllProductList.action?sublibs=1&ptype.id="
					...
					<td valign="top">
							<form action="baoxianAllProductList.action?ptype.id=<s:property value="ptype.id"/>" method="post" name="assignProduct" id="assignProduct">
							...
							<table width="100%" align="center" cellpadding="2"
								...
								<s:iterator value="baoxianProductList" status="status">
									<tr>
									    ...
									    <td align="center" valign="middle"><p><a href="showBaoxianProduct.action?id=${id }" class="textbg4">查看</a></p></td>
									    <td align="center" valign="middle"><p><a href="updateBaoxianProductView.action?id=${id }&update_inallList=1" class="textbg4">修改</a></p></td>
									    
									    <s:if test="is_baoxian_product_sh==true">
	   								    	<s:if test="shenhezhuangtai==1">
	   								    		<td align="center" valign="middle"><p><a href="shenheBaoxianProductNotPass.action?id=${id }" class="textbg6">不通过</a></p></td>
	   								    		<td align="center" valign="middle"><p><a href="shenheBaoxianProduct.action?id=${id }" class="textbg4">通过</a></p></td>
	   								    	</s:if>
			...
			<s:form action="deleteBaoxianProduct.action" method="post" name="assign">
