...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="全部留言列表" /></div>
			</li>
			<!--<li class="sep">
			</li>
			<li>
		...
		<div style="margin-top: 20px; text-align: center;">
			<table width="100%">
				<tr>
					<td valign="top">
		<s:form action="allMessageList.action" method="post" name="assignSearch_assignment" theme="simple">	
			<table width="100%"> 
								...
								<s:iterator value="messageList">
									<tr>
										...
										<td bgcolor="#FFFFFF" align="left" width="150" height="30">
											 ...
											 <a style="cursor:pointer;"  href="messageView.action.action?courseComment.id=<s:property value="id"/>"  class="textbg4">浏览</a>
											<s:if test="status==2">
