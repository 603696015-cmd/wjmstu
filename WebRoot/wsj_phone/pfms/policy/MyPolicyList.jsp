			...
			<table width="100%">
				<tr>
					<td valign="top" width="100" id="tree_list_td"> 
						<wysLib:productTypeTree href="MyPolicyListInit.action?sublibs=1&ptype.id="
					...
					<td valign="top">
							<form action="MyPolicyListInit.action" method="post" name="assignProduct" id="assignProduct">
							...
							<table width="100%" align="center" cellpadding="2"
				   		    ...
				   		    <s:if test="valid == 0 || valid == 2 || valid == 4">
										   	  <a href="Policy_AuditInit.action?policy.id=${id }&policy.valid=1&actionName=MyPolicyListInit">提交</a>
										   	  <a href="IC_U_Info_AlertInit.action?policy.id=${id}&IC_U_ID=<s:property value="IC_U_ID" />&actionName=MyPolicyListInit">修改</a>									   		</s:if>
