								...
								<s:iterator value="policys">
									<tr>
								      ...
								      <td align="center" valign="middle"> 
									   	  <s:if test="valid == 3">
										   	  <a href="Policy_AuditInit.action?policy.id=${id }&policy.valid=4&actionName=Policy_Audit2ListInit">不通过</a>
										   	  <a href="Policy_AuditInit.action?policy.id=${id }&policy.valid=5&actionName=Policy_Audit2ListInit"  onClick="return delsure('<s:property value="scanning" />');">通过</a> 
									   	  </s:if>   
								   	    <!--  <s:if test="valid == 3">
