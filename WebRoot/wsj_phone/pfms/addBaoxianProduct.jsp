...
class=shadow id=locationid>保险产品管理</SPAN></DIV>
  ...
  <FORM id=myform name=myform action="addBaoxianProduct.action" method=post enctype="multipart/form-data" onSubmit="return check();">
	<TABLE cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
		  ...
		  <TR class=tdbg>
		    ...
		    <td width="80" ><span style="FONT-WEIGHT: bold">产品简称：</span></td>
		  ...
		  <tr>
		  	<td width="80">
				<SPAN style="FONT-WEIGHT: bold">产品图片：</SPAN>			</td>
			<td>&nbsp;&nbsp;
				<label>
