				 ...
				 <tr>
					...
					<td align="left" >
						<div id="trnorms" style="width: 100%;">
							<a href="student_talent_myztroom_view.action?myztroom.ztroom.id=<s:property value="myztroom.ztroom.id"/>&myztroom.evaltype=1">自我打分</a> 
							<a href="student_talent_myztroom_view.action?myztroom.ztroom.id=<s:property value="myztroom.ztroom.id"/>&myztroom.evaltype=2">给同事打分</a>
							<a href="student_talent_myztroom_view.action?myztroom.ztroom.id=<s:property value="myztroom.ztroom.id"/>&myztroom.evaltype=3">给下级打分</a>
							</div>
					</td>
				</tr>
			</table>
					...
					<table width="60%" cellpadding="1" cellspacing="1">
						...
						<tr>
							...
							<s:iterator value="myztroom.ztroom.norms" status="myst">
								<td>
									<strong> <s:property value="myztroom.tester.myZTRoom.evaldetails[#myst.index]"/> </strong>
								</td>
							</s:iterator>
						</tr>
					</table>
						...
						<s:iterator value="myztroom.testers" status="nsstat">
							<tr>
								...
								<s:iterator value="myztroom.ztroom.norms" status="st_001">
									<td>
										<strong> <s:property value="myZTRoom.evaldetails[#st_001.index]"/> </strong>
									</td>
								</s:iterator>
							</tr>
						</s:iterator>
