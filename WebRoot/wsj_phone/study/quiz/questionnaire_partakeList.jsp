						...
						<s:iterator value="myrooms">
							<tr>
								<td height="30" align="left">
									...
									<s:property value="examroom.title" />id=<s:property value="examroom.id"/>
								</td>
								...
								<td width="120" height="30" align="center">
									<s:if test="myExamPaper.status == 0">
										<a href='quizpaperinit_byepid.action?examRoom.id=<s:property value="examroom.id"/>&examPaper.id=<s:property value="myExamPaper.examPaper.id"/>'>参与</a>
									</s:if>
									<s:else>
