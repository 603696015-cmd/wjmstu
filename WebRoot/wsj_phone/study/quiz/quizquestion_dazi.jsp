...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function myload(){
		 	...
		 	flashvars.fanwen_ = $("#fanwen").text();//document.getElementById("fanwen").innerHTML;//"我是什么人呢、";    
		  	flashvars.myfw_= $("#myfanwen").text();
		  	flashvars.passtime_= "${ question.stuAnswers[0]}";
		    ...
		    //}
		    //that = window.parent.quizpaper.timer;
	 	...
	 	function quizquestionsubmit(){submitFsubmit();}
	 	function jscloseie(){
	 		window.parent.closeFrame();//window.close();
	 	}
	 	function submitFsubmit(){
	 		myFlash("flashcontent").flsubmit();
	 	}
	 	function myFlash( pP ) {
	...
	<body style="width:760px;margin: 0px auto; padding: 0px;" onload="myload();"
		...
		<div style="text-align:left;line-height:20px;">
			...
			</div><div style="width:133px;height:76px;float: left;border: green 1px solid;"><DIV style="BACKGROUND: #eeaaff; HEIGHT: 20px; CURSOR: move" jQuery1346980232818="3"></DIV>
...
<H2 style="TEXT-ALIGN: center; MARGIN: 3px 0px; FONT-FAMILY: 'Times New Roman',Georgia,Serif; COLOR: red" id=examtime>加载中..</H2></div>
		...
		<div id="fanwen" style="display: none;">${ question.content}</div>
		<div id="myfanwen" style="display: none;">${ question.stuAnswers[3]}</div>
