...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="images/jsby_images/css.css" type="text/css"
			rel="stylesheet" />
...
$(function(){
		...
		vedio_state = setTimeout("checkVedio()", 1000);	 
		
});
function submitjsby(){
	//判断flash是否正在播放
	if(video.IsPlaying()){
		alert("动画正在播放,请等待播放完成");
		return ;
	}else{
					...
					<div id="m_zz">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="324" height="400">
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										height="230">
										<tr>
											<td height="50" align="center">
												<table width="230" border="0" cellspacing="3"
													cellpadding="0" background="images/wdbg.png">
													<tr>
														<td width="44" height="44" align="right" valign="middle">
														...
														<td width="123" valign="middle">
															<form id="form1" name="form1" method="post" action="">
																...
																<span class="it_s"> <input id="voiceText"
																		name="textfield" type="text" class="it1"
																		style="width: 120px; height: 18px;"
																		onfocus="this.className='it2';"
																		onblur="this.className='it1';" value="" /> </span>
															</form>
														</td>
														<td width="51"></td>
													</tr>
