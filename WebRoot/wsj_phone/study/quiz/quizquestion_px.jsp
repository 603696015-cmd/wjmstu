										...
										<s:iterator value="question.answers_">
											<table width="20%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td bgcolor="#fb5b29" style="background-repeat: repeat-x;">
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<s:if test="view==0"><!-- 考试 -->
											...
											<td>
												<input type="button" value="" onclick="submitpx()"
													style="cursor: pointer; background-image: url(images/px_images/bf/tj.png); width: 64px; height: 50px;" />
											</td>
											<td height="79" width="74">
