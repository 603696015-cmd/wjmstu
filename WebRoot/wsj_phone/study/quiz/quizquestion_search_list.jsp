...
<SCRIPT type="text/javascript">
		...
		window.onload=function(){
		    //var qtimer = new QuizTimer('11',"examtime",<s:property value="examPaper.during"/>*60,<s:property value="myExamPaper.jiashi"/>*60,<s:property value="myExamPaper.passTime"/>,75,$("#content_search").offset().left+$("#content_search").width());
			//var quizpaper=new QuizPaper("quizform","examtime","" ,qtimer);
	       	//quizpaper.autoquestionsave();
	        //if (window.screen){ 
			//	window.moveTo(0, 0);
	    ...
	    function quizquestionsubmit(){
	    	q_form.action="quizquestion_submit.action";
	    	q_form.submit();
	    }
	</SCRIPT>
	</HEAD>
	<body leftmargin="0" topmargin="0" class="ex4"
		...
		<div align="center">
			<table width="778" id="content_search"  border="0" cellspacing="2" cellpadding="0">
				<tr>
							...
							<tr>
								<td bgcolor="#FF0000">
									<span class="STYLE2x">考试要求：请搜索以下标题的文章<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标题为：
										<s:property value="question.answers[0]" /> 
									</span>
								</td>
							</tr>
						</table>
					...
					<td align="center">
						...
						<div align="left">
							<center>
								...
								<form action="quizquestioninit.action" name="q_form"
									method="post">
				...
				<s:iterator value="questionarts" status="st">
					<tr>
						<td>
							<div align="left">
								<br>
								<a href="javascript:;" onclick="setAnswer(<s:property value="id"/>,'<s:property value="title"/>');return false;" class="link1" target="_self"><font class="baidu">
			...
			<form action="quizquestion_search.action" name="q_search" method="post">
