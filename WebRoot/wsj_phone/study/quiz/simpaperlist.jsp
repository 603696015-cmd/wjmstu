...
<HTML>
	<HEAD>
		...
		<TITLE>学习课程--模考中心---<s:property value="course.name" /></TITLE>
		<base href="<%=basePath%>">
											...
											<TBODY>
												<TR>
													...
													<TD align=middle background="images/img/bfz_r1_c11.jpg">
														<FONT class=bt>《<s:property value="course.name" />》——模拟考试</FONT>
													</TD>
												</TR>
												<TR>
								...
								<TR>
									<TD id=td_catalog vAlign=top bgColor=#dae9fe>
										<div class=muludiv2 id=div_catalog>
											<ul>											
											<s:iterator value="exampapers" status="eps">
												<LI style="font-size: 14px; ">
													【模考】&nbsp;	<a target="_blank" href="simpaper.action?course.id=<s:property value="course.id"/>&examPaper.id=<s:property value="id"/>"><s:property
															value="title" /></a>
												</LI>
												</s:iterator>
											</ul>
