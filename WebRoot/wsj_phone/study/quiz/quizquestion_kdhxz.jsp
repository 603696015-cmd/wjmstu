...
<link href="images/kdhxz_images/css.css" type="text/css"  rel="stylesheet" />
...
.bx_answer{}
.bx_answer table{float: left;cursor: pointer;margin:3px 0px 0px 10px;}
.s_answer table{float: left;}
</style>
<title>看动画选择题</title>
...
<body>
<APPLET ID="录音功能(record)" CODE="com.msc.applet.RecognizeApplet.class" CODEBASE="/wjm/record" ARCHIVE="mscclient.jar" WIDTH="0" HEIGHT="0">   
		<PARAM NAME = "type" VALUE="application/x-java-applet;version=1.2.2">
		<PARAM NAME = "scriptable" VALUE="false">
</APPLET>
<!-- 答对提示音 -->
<div style="display:none;">
<object id=right classid=CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6 width=280 height=60 codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab&#35;Version=5,1,52,701standby=Loading Microsoft? Windows Media? Player components... type=application/x-oleobject>  
...
<!-- 答错提示音 -->
  <object id=error classid=CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6 width=280 height=60 codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab&#35;Version=5,1,52,701standby=Loading Microsoft? Windows Media? Player components... type=application/x-oleobject>  
...
<!-- 正确的样音 -->
   <object id=modelVoice classid=CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6 width=280 height=60 codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab&#35;Version=5,1,52,701standby=Loading Microsoft? Windows Media? Player components... type=application/x-oleobject>  
...
<!-- 题干发问音 -->
   <object id=fashengQuestion classid=CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6 width=280 height=60 codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab&#35;Version=5,1,52,701standby=Loading Microsoft? Windows Media? Player components... type=application/x-oleobject>  
	<param name=URL value="<s:property value="question.fashengQuestion" />">  
	<PARAM NAME=UIMode value=full>
	<PARAM NAME=AutoStart value=false>  
	<PARAM NAME=Enabled value=true>  
	<PARAM NAME=enableContextMenu value=false>  
...
<!-- 新版页面格局 -->
		...
		<div id="content_zhong" style="position: relative;">
			...
			<div id="tigan">
				...
				<div id="m_t" style="width: 800px">
					<div style="float: left;">
						<img src="images/kdhxz_images/main_lt.png" />
					</div>
					<div id="main_t"></div>
					<div>
						<img src="images/kdhxz_images/main_rt.png" />
					</div>
				</div>
				<!--主体中部-->
				<div id="m_z">
				...
				<div id="m_b" style="width: 800px;">
					<div id="m_bl">
						<img src="images/kdhxz_images/main_lb.png" />
					</div>
					<div id="m_bz"></div>
					<div>
						<img src="images/kdhxz_images/main_rb.png" />
					</div>
				</div>
			</div>
			<!--下一题按钮-->
			...
			<div id="bfq">
				<div id="bfq_l">
					<img src="images/kdhxz_images/bf_l.png" />
				</div>
				<div id="bfq_z">
									...
									<tr>
										<s:if test="view==0"><!-- 考试 -->
											...
											<td height="79" width="74">
												<input type="image" src="images/kdhxz_images/bf/anniu_35.png"
													onmousedown="this.src='images/kdhxz_images/bf/ann_35.png'"
													onmouseup="this.src='images/kdhxz_images/bf/anniu_35.png'" onclick="js_stop()" />
											</td>
											<td height="79" width="83">
												<input type="image" src="images/kdhxz_images/bf/anniu_36.png"
													...
													old='images/kdhxz_images/bf/ann_36.png' />
											</td>
											<td height="79" width="74">
												<input type="image" src="images/kdhxz_images/bf/reset.png"
													" onmousedown="this.src='images/kdhxz_images/bf/reseth.png'"
													onmouseup="this.src='images/kdhxz_images/bf/reset.png'" onclick="js_reset()" />
											</td>
											<td height="79" width="74">
												此处可放倒计时
											</td>
											<td>
												<input type="button" value="" onclick="submitkdhxz()"
															style="cursor: pointer; background-image: url(images/kdhxz_images/bf/tj.png); width: 64px; height: 50px;" />
											</td>
											<td height="79" width="74">
				...
				<div id="bfq_r">
					<img src="images/kdhxz_images/bf_r.png" />
				</div>
			</div>
		</div>
		<!--主体播放条-->
