							...
							<s:if test="examPaper.title!=null">
								<tr>
									...
									<td height="30" align="center">
										<a href='lookStudyQuizpaperlist.action?examPaper.id=<s:property value="examPaper.id"/>&examRoom.id=<s:property value="myroom.examroom.id"/>&elUser.id=<s:property value="elUser.id"/>'
