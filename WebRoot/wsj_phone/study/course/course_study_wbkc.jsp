	...
	COLOR: #ffffff
		...
		<script type="text/javascript">
			...
			function div_ifr(){
				...
				_cpst.init();
			 var from = 0;
			 var html5_temp=<s:property value="course.html5_"/>;
			
			 if(!<s:property value="myCourse.passed"/>) 
			 	 from = <s:property value="myCourse.passtime"/>;
			//<s:if test="html5_temp==null">
			 var _cvideo = new C.ourseVideo(2,"<s:property value="course.exurl_"/>", from);
			// alert("exurl_");
			// </s:if>
			 //<s:else>
			 //	 var _cvideo = new CourseVideo(2,"<s:property value="course.html5_"/>", from);
			 //	  alert("html5");
			// </s:else>
			 if(!_cvideo.show("ifr")){
