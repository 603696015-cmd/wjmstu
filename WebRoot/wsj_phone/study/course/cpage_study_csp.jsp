...
<html>
	...
	<body onLoad="myload('<s:property value="status"/>');">
		...
		<table style="margin-top:8px;" width="960" height="50" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td height="102" align="center" background="elfrontimages/botbg.png" style="line-height:25px;font-size:12px;"><p class="foot">中国食品安全培训网 copyright 2011-2015 all rights reserved<br />
