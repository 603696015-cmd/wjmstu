...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			...
			<!--<li>
				<span style="font-weight: bold;">我的<s:property value="myCourse.statusName"/> </span>
			</li>-->
		</ul>
		<!-- 内容 -->
		<div style="margin-top: 0px; text-align: center;">
			<s:if test="myCourses.size==0">您没有<s:property value="myCourse.statusName"/></s:if>
			<s:else>
				<table width="90%" align="center" cellpadding="1" cellspacing="1"
					bgcolor="#EBEBEB">
					<caption>
						我的<s:property value="myCourse.statusName"/>
					</caption>
					<tr>
					...
					<s:iterator value="myCourses">
						...
						<td height="30" style="padding-left:8px;color:blue;" align="left">
							...
							<td height="30" align="center" >
								<a target="_blank"
									href="course_study.action?course.id=<s:property value="course.id"/>&coursePage.id=-1">进入学习</a>
							</td>
						</tr>
					</s:iterator>
				</table>
