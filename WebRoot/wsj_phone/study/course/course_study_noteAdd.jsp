...
tr {
	...
	<BODY style="">
		...
		<form action="course_study_noteAdd.action" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#F8FCFE;">
  <tr>
    <td><table width="320" align="left" cellpadding="1" cellspacing="1" bgcolor="#D1E4F5">
				<caption>
					课程:
				...
				<tr>
					...
					<td align="left" bgcolor="#F8FCFE">
						&nbsp;<input type="text" name="cnote.title" style="width:220px;" />
					</td>
				</tr>
				<tr bgcolor="#F4F4F4">
					<td align="center" bgcolor="#F8FCFE">
					...
					<td align="left" bgcolor="#F8FCFE">
						&nbsp;<textarea id='notecontent' onKeyUp="aa()" name="cnote.content"
							style="width: 220px; height: 145px;"></textarea><br/>
