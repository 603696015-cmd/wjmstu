...
tr {
	...
	<BODY style="">
		...
		<s:else>
        <table width="320" border="0" cellspacing="1" cellpadding="0" bgcolor="#D1E4F5">
  <tr>
  ...
  <tr>
    <th width="154" bgcolor="#F8FCFE">内容： </th>
    ...
    <th bgcolor="#F8FCFE">&nbsp;</th>
			...
			<table width="320" align="left" cellpadding="1" cellspacing="1" bgcolor="#D1E4F5">
				...
				<s:iterator value="cnotes">
					<tr>
						<td width="150" height="30" bgcolor="#F8FCFE"  style="padding-left:5px;">
							<a
