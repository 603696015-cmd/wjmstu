...
<script type="text/javascript">
			var _cpst;
			function myload(){
			if(window.confirm("继续学习？1")){
			
						showModelessDialog('course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}');
		...
		/*document.location="course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}";*/
		
	/*
	window.location.href="course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}";
	window.location.reload();
	window.location="course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}";
	window.showModalDialog('course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}');
	*/
	...
	<script type="text/javascript">
			$(
			function a(){
			if(window.confirm("继续学习？")){
			/*document.location="course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}";*/
			var comment = document.getElementById('reload');
...
<a id="reload" href="course_study.action?course.isLogout=1&coursePage.id=${coursePage.id}&course.id=${course.id}&course.classid=${course.classid}" ></a>
									...
									<table height="100%" bgcolor="red" cellpadding="0" cellspacing="0">
										<tr>
											<TD width=300 height="250" vAlign=top bgColor=#dae9fe
												id="page_file">
													<a target="_blank" href="course_study.action?course.isLogout=1&coursePage.id=-1&course.id=<s:property value="course.id"/>"><img border="0" src="images/begin.jpg" width="100%" height="100%" /></a>
											</TD>
										</tr>
										<tr>
											<TD width=300 height="30" vAlign=top bgColor=#dae9fe>
												
												<div style="width: 100%; height: 10px; text-align: center;margin-top: 5px;">
										...
										<TR>
											...
											<TD vAlign="middle" align="right"
												...
												<DIV class="leibie">
													...
													<a target="_blank" href="displayStudyCpageInfo.action?course.id=<s:property value="course.id"/>&course.classid=<s:property value="course.classid"/>">我的章节学习详情</a>
												</DIV>
											</TD>
											<TD width=17>
