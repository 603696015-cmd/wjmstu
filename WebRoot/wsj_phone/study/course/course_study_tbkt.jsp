...
<html>
	<head>
		...
		<base target="_self"> 
		<base href="<%=basePath%>" />
		<TITLE>学习课程（同步课堂）--<s:property value="course.name" />
		</TITLE>
...
.STYLE12 {
	...
	COLOR: #ffffff
		...
		function cnote_add_link(id,obj){
		    var url="newcourseNote_addInit.action?course.id="+id;
		    window.open(url, '做笔记', 'height=300, width=420, top=200,left=300, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
		function cnote_list_link(id,obj){
		    var url="newcourseNote_list.action?course.id="+id;
		    window.open(url, '做笔记', 'height=300, width=420, top=200,left=300, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
	...
	<body onload="myload();" style="overflow: visible;height:100%; padding: 0px; margin: 0px">
		<div style="position: absolute; margin:3px; margin-top: 10px;">
			...
			<div style="border: solid 1px buttonface; z-index: 1000; position: absolute; background: #ffffff; width: 300px; height: 300px; overflow: auto; display: none"
			id="cat">
			...
			<tbody>
											...
											<tbody>
												<tr>
													<td valign="bottom" align="center"
														...
														<table height=45 cellSpacing=0 cellPadding=0 width="100%">
															<tbody>
																<tr>
																    <td width="250">&nbsp;</td>
																	...
																	<td valign="middle" align="right" width=480>
																		...
																		<!-- <a class=dh style="cursor: hand"
																			onclick="javascript:cnote_add_link('${course.id }',this)">做笔记</a><span
																			class="STYLE12"> &gt;&gt; </span><a class="dh"
																			style="cursor: hand"
																			onclick="javascript:cnote_list_link('${course.id }',this)">查看笔记</A>
																		<span class="STYLE12">&gt;&gt;</span>
																		<A class=dh href="study.action">学习中心</A> -->
																	</td>
																</tr>
															</tbody>
														</table>
				...
				<tr>
					<td height="100%" style="padding: 0px;">
						<iframe width="100%" height="100%" style="margin: 0px;z-index: -100" marginheight="0" marginwidth="0" frameborder="0"
							id="course_content" src="intoRoom.action?room.id=<s:property value="course.room.id"/>&course.teacherId=<s:property value="course.teacherId"/>">
						</iframe>
					</td>
				</tr>
			</tbody>
