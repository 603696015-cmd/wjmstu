...
<tr>
  ...
  <tr >
					<td width="340" bgcolor="#F8FCFE" class="zc01"
						style="padding-left: 20px;" colspan="7" height="40" >
						必修课
						<span style="text-align:right" >必修课必须全部学完</span>
					</td>
				</tr>
				<tr>
					<!--<td height="30" align="center" valign="middle" bgcolor="#EBF7FC">&nbsp;
					...
					<td height="50" align="center" bgcolor="#EBF7FC">
						学分
					</td>-->
...
<!--					</td>-->
				...
				<tr>
					...
					<td width="60" align="center" bgcolor="#F8FCFE">
						<a href="course_study.action?course.id=<s:property value="course.id" />&coursePage.id=-1&classid=<s:property value="myClass.elClass.id"/>" target="_blank">
					...
					<!-- 	<s:if test="examRoom.type == 1">
							<s:if test="examRoom.id != 0 && examRoom.svalid == 5" >   
								<s:if test="course.getcredit == 2 || course.getcredit == 3"> 	
									<a href='quizpaperinit.action?course.id=<s:property value="course.id" />&course.getcredit=<s:property value="course.getcredit" />&course.firstLearn=<s:property value="course.firstLearn" />&myroom.examroom.id=<s:property value="examRoom.id" />&iscommon=0&elclass.id=<s:property value="elclass.id"/>' onClick="return isEroom2('<s:property value="examRoom.valid"/>','<s:property value="examRoom.svalid"/>','<s:property value="examRoom.isnormal"/>','<s:property value="examRoom.type"/>');" class="textbg4">考 试</a>	
								</s:if>
							</s:if>
							<s:else>
								无考场1
...
<!--					</td>-->
  ...
  <tr >
					<td width="340" bgcolor="#F8FCFE" class="zc01"
						...
						选修课
						选修课最少获得　
						<span style="color: red;"><b> <s:property value="myClass.elClass.optionalcredit" /> </b>
							</span>　学分
					</td>
				</tr>
				<tr>
...
<!--					</td>-->
			...
			<div style="display:<s:if test="elclass.examRooms[0]!=null">block</s:if><s:else>none</s:else>;">
			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" style="margin-top: 15px;">
				<tr>
					<td height="40" background="images/bg002.jpg"
			...
			<s:if test="elclass.examRooms[0].score!=0.0">
  <table width="100%" border="0" align="center" cellpadding="5"
					cellspacing="1" bgcolor="#CFDBE2">
					<tr>
							...
							<table width="95" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td height="28" align="center" background="images/textbg.jpg">
										<a href="quizpaperinit.action?myroom.examroom.id=<s:property value="elclass.examRooms[0].id" />&Return=list&myClass.elClass.id=<s:property value="myClass.elClass.id" />" class="zc01 STYLE3" style="color: white;">进入考场</a>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td width="200" align="center" bgcolor="#F8FCFE">
							<table width="95" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td height="28" align="center" background="images/textbg.jpg">
										<s:if test="elclass.firstlearnlaterexam==1">
										<s:if test="elclass.examRooms!=null&&elclass.examRooms.size!=0 && isexam">
											<a href="quizpaperinit.action?myroom.examroom.id=<s:property value="elclass.examRooms[0].id" />&myClass.elClass.id=<s:property value="myClass.elClass.id" />&Return=list" class="zc01 STYLE3" style="color: white;">进入考场</a>
										</s:if>
										<s:else>
											<a href="javascript:alert('未学满规定的学时，请学完后再进入考试!');" class="zc01 STYLE3" style="color: white;">进入考场</a>
										</s:else>
										</s:if>
										<s:else>
											<a href="quizpaperinit.action?myroom.examroom.id=<s:property value="elclass.examRooms[0].id" />&myClass.elClass.id=<s:property value="myClass.elClass.id" />&Return=list" class="zc01 STYLE3" style="color: white;">进入考场</a>
			...
			<s:if test="elclass.examRooms[0]!=null">
			<table width="100%" border="0" align="center" cellpadding="0"
				cellspacing="0" style="margin-top: 15px;">
				<tr>
					<td height="40" background="images/bg002.jpg"
