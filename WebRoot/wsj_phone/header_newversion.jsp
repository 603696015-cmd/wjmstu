	...
	<table width="100%" height="58" style="margin: 0px;padding: 0px" cellpadding="0" cellspacing="0" background="images/bg_admin.jpg" border="0">
		<tr>
			...
			<td><table width="100%" cellpadding="0" cellspacing="0">
				...
				<a href="index.action" class="white">网站首页</a></td>
				</tr> 
				
				<!-- 门户网站  网上课堂  竞赛中心  教务管理  资料管理  系统管理  个人中心  dk1-->				
				<tr>
				 <td style="padding: 0px;" align="right" valign="bottom"><ul id="menu" style="margin: 0px;">
					<s:iterator value="menus">
					<li>
						<a <s:if test="Return==funccode">class="on"</s:if> href="admin_newversion.action?module=<s:property value="funccode"/>"  title="<s:property value="name"/>"><span><s:property value="name"/></span>
						</a>
					</li>
					 </s:iterator>
					 <li>
