...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<form action="pop_list.action" method="post" name="popFh">
				<s:hidden name="pN" id="pageNow" />
				<s:hidden name="pS" />
				<div>
					弹窗标题&nbsp;
					<input type="text" name="pop.popTitle"
						value="<s:property value="pop.popTitle"/>">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 发送方式&nbsp;
					<s:select theme="simple"
						list="#{-2:'全部',0:'按人员',1:'按部门',2:'按考场',3:'按培训班'}"
						name="pop.sendmanner" value="pop.sendmanner" />
					状态&nbsp;
					<s:select theme="simple" list="#{-2:'全部',0:'无效',1:'有效'}"
						name="pop.status" value="pop.status" />
			...
			<s:else>
				<table width="100%" align="center" cellspacing="1" cellpadding="1">
					<tr>
						<th width="40" align="center" bgcolor="#ECEDEB">&nbsp;
							
						</th>
						<th width="220" align="center" bgcolor="#ECEDEB">
							弹窗标题
						</th>
						<th width="220" align="center" bgcolor="#ECEDEB">
							创建者
						</th>
						<th width="150" align="center" bgcolor="#ECEDEB">
							创建时间
						</th>
						<th width="100" align="center" bgcolor="#ECEDEB">
							发送方式
						</th>
						<th width="80" align="center" bgcolor="#ECEDEB">
							状态
						</th>
						<th align="center" bgcolor="#ECEDEB">&nbsp;
					...
					<tbody onMouseOut="changeback()" onMouseOver="changeto()">
						<s:iterator value="pops">
							<tr>
								...
								<td align="center">
									<a href="javascript:alterPop('<s:property value="id"/>');"
										class=textbg4>编辑</a>
									<s:if test="status==0">
										<a href="javascript:setPop('<s:property value="id"/>','1');"
											class=textbg6>设为弹窗</a>
									</s:if>
									<s:else>
										<a href="javascript:setPop('<s:property value="id"/>','0');"
											class=textbg6>取消弹窗</a>
									</s:else>
			...
			<div style="margin-top: 7px;">
				...
				<a href="javascript:select_Bux();" style="width: 60px"
					class="textbg4">全不选</a>
				...
				<a
					style="width:90px;" href="pop_addInit.action"
					class="textbg4">发布新弹窗</a>
			...
			<form action="pop_mylist.action" method="post" name="popForm">
				...
				<s:hidden name="pN" id="pageNow" />
				<s:hidden name="pS" />
				<s:hidden name="pageResult" value="pop_list" />
			</form>
		</div>
		<!-- 内容 -->
