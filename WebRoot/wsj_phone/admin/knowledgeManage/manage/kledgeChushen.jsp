...
<HTML>
	...
	<body>
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="知识初审" /></div>
			</li>
		</ul>
		<!-- 内容 -->
    ...
    <td><div id="Div_ToolsBar"></div></td>
		...
		<script type="text/javascript">
			...
			function view(id){
				...
				document.getElementById("listType").value = 2;
			...
			function verify_pass(ids){
				...
				kledge.action="verifypass.action";
			...
			function verify_nopass(ids){
				...
				document.getElementById("ids").value=ids;
				kledge.action="verifynopass.action";
				if(window.confirm("确认提交？")){
					if(document.getElementById("auditMark.audit_mark").value == null || 
						document.getElementById("auditMark.audit_mark").value == ""){
						alert("请重新填写备注!!!");
