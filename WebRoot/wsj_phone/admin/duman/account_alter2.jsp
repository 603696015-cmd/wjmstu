...
<HTML>
	<HEAD>
		...
		<script type="text/javascript"> 	
			...
			function headPhoto(){
         	  //var role = <s:property value="userRole"/>;
         	  //if(role != 1){ //超级管理员 不需要 
				//	alert('请先上传头像！'); 
				//	window.location.href="account_headerAlterInit.action?elUser.id="+<s:property value="elUser.id"/>; 
				//} 
			}
			 function myCheck()
            {  
         	  var role = <s:property value="userRole"/>;
         	  if(role != 1){  //超级管理员 不需要验证全部
               for(var i=0;i<document.form1.elements.length-1;i++)
               {
                  if(document.form1.elements[i].value=="" && document.form1.elements[i].id != "password" 
                  && document.form1.elements[i].id != "gd_rq" && document.form1.elements[i].id !=  "gd_lx" )
                  {
                     alert("当前表单不能有空项");
	...
	<BODY onload="setGd();">
		<s:form action="account_alter2.action" method="post" theme="simple" id="registerForm" name="form1" >
			<div id="OutlineDiv">
							...
							<TABLE width="100%" border="0" align="center" cellPadding="0"
								...
								<TR>
									<TD class="pg_add_title" colspan="7">
										基本信息 <s:hidden name="userRole" id="userRole"></s:hidden> 
									</TD>
								</TR>
								<tr>
									<td width="222" align="right" class="pg_add_head">
										姓名:
									</td>
									...
									<td class="pg_add_content"
										...
										<!-- <input type="text" name="elUser.zhengjianleixing"
											value="<s:property value="elUser.zhengjianleixing"/>" /> -->
									</td>
								...
								<tr>
									...
									<td colspan="2" class="pg_add_content">
										<select name="elUser.sex">
											<option	<s:if test="elUser.sexName== 1">selected='selected'</s:if> value="男">
												男
											</option> 
											<option <s:if test="elUser.sexName== 0">selected='selected'</s:if> value="女"> 
												女
											</option>
										</select>
									</td>
								...
								<tr>
									...
									<td class="pg_add_content"
										...
										<!-- <input type="text" name="elUser.peixunleibie"
											value="<s:property value="elUser.peixunleibie"/>" /> -->
									</td>
									<td align="right" class="pg_add_head">
										民族:
									</td>
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;">
										<select name="elUser.suoxuezhuanye"> 
										...
										<!--<input type="text" name="elUser.suoxuezhuanye"
											value="<s:property value="elUser.suoxuezhuanye" />" />--> 
									</td>
									<td align="right" class="pg_add_head">
										人员状态:
									</td>
								...
								<tr>
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;"> 
										<select name="elUser.feisuoxuezhuanye"> 
										...
										<!--  
										<input type="text" name="elUser.feisuoxuezhuanye"
											value="<s:property value="elUser.feisuoxuezhuanye" />" />-->
									</td>
									<td align="right" class="pg_add_head">
										现从事会计工作岗位:
									</td>
								...
								<tr>
									...
									<td colspan="2" class="pg_add_content"> 
										...
										<!-- <input type="text" name="elUser.suozaidixingzhengqu"
											value="<s:property value="elUser.suozaidixingzhengqu" />" /> -->
									</td>
								</tr>
								<tr>
									<td align="right" class="pg_add_head">
									...
									<td rowspan="9" class="pg_add_content"
										...
										<img id="head" width="120px" height="150px"
											src="elheaders/<s:property value="elUser.id"/>.<s:property value="elUser.headPhoto"/>"
											align="top" onerror="headPhoto()" >
										<br>
										<a style="clear: both;"
											href="account_headerAlterInit.action?elUser.id=<s:property value="elUser.id"/>">修改</a>
									</td>
								...
								<tr>
									...
									<td class="pg_add_content"
										...
										<input type="text" id="zyjs_3"  
											...
											value="<s:property value="elUser.zhuanyezigehuoquriqi" />" readonly/>
									</td>
								</tr>
								<tr>
									<td align="right" class="pg_add_head">
									...
									<td class="pg_add_content"
										style="border-right: 1px solid #FFFFFF;">
										<input type="text" name="elUser.zhuanyezigezhengshu" id="zyjs_6"
								...
								<tr>
									...
									<td class="pg_add_content"
										...
										<input type="text" name="elUser.gaoduanrencairiqi" size="13"
											...
											id="gd_rq" onclick="setday(this)" readonly/>
								...
								<TR class="pg_add_bottom">
									<TD colspan="7">
										<DIV align="center">
											<input type="button" name="bgsqSubmit" value="提交保存"
												class="button_normal" onfocus="return false;" onclick="return myCheck();">
											<s:hidden name="elUser.id"></s:hidden>
											<a
												href="account_deleteInit.action?elUser.id=<s:property value="elUser.id"/>">删除</a>
