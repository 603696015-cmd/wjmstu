		...
		<ul class="nav">
			...
			<li>
				<a style="cursor: hand"
					...
					href="talent_ztroom_assign_searchInit.action?ztroom.id=<s:property value="ztroom.id"/>">分配新学员</a>
			</li>
		</ul>
		<!-- 内容 -->
		<div style="margin-top: 0px; text-align: center;">
			...
			<table width="60%" cellpadding="1" cellspacing="1">
					...
					<td height="20" align="center">
						...
						<td height="20" align="center">
							<a href="talent_ztroom_assign_delete.action?ztroom.id=<s:property value="ztroom.id"/>&elUser.id=<s:property value="id"/>">删除</a>
						</td>
					</tr>
					</s:iterator>
				</table>
