...
<meta name="viewport" content="width=device-width, initial-scale=1" />
	...
	<BODY>
		...
		<!-- 内容 -->
		<div style="margin-top: 0px; text-align: center; background-color:#D1E4F5; width:320px;">

			<table align="center" cellpadding="0" cellspacing="1" width="320"
				 bgcolor="#ECEDEB">
				<tr>
...
<table align="center" cellpadding="0" cellspacing="1" width="320"
				 bgcolor="#ECEDEB">
				<tr>
				<td height="40" align="right" bgcolor="#F8FCFE"><a href="order_chongzhi.action" class="textbg">&nbsp;&nbsp;我要充值</a>
				    </td>
					</tr>
			</table>
		</div>
