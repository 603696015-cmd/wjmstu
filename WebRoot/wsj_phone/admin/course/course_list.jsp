...
.textbg6{margin-top: 2px;}
  ...
  <tr>
    ...
    <td bgcolor="#F8FCFE"><s:form action="course_list" name="myclist" theme="simple">
  ...
  <tr>
    ...
    <td width="675"><div id="Div_ToolsBar"></div></td>
						...
						<a href="course_scormaddinit.action" class="textbg6" style="width:130px;">导入SCORM课程</a>(支持1.2版本的课件)   
					</td>
				</tr>
			</table>
			<script>
