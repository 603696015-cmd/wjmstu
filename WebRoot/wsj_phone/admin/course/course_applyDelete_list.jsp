...
<HTML>
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">课程申请删除列表</span>
			</li>-->
		</ul>
				</td>
		...
		<form action="course_applyDelete_list.action" name="caform" method="post">
		...
		<table width="100%" border="0" cellpadding="1" cellspacing="0">
				<tr>
					<td valign="top" id="tree_list_td" style="display:none">
						<wysLib:ctypeTree rootAble="true" href="course_applyDelete_list.action?ctype.id="  ></wysLib:ctypeTree>
				  <td valign="middle" width="5px;" style="padding: 0px">
					...
					<s:form action="course_applyDelete_list" name="myclist" theme="simple">
...
<td width="600" bgcolor="#F8FCFE"><input type="hidden" name="ctype.id" value="<s:property value='ctype.id'/>" />
						课程名称：
    ...
    <td rowspan="2" bgcolor="#F8FCFE"><s:submit value="搜索"></s:submit></td>
  </tr>
  <tr>
    <td bgcolor="#F8FCFE">创建时间
							从<INPUT  id="begintime"  name="course.begintime" onClick="setday(this)" />
	     				&nbsp;&nbsp;&nbsp;&nbsp;到&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  id="endtime"  name="course.endtime" onClick="setday(this)" /></td>
    </tr>
</table>					
					</s:form>
		...
		<s:else>
					...
					<tr>
					 ...
					 <!-- <td width="50" align="center" >
					  ...
					  <td width="220" align="left" >
					    ...
					    <s:if test="status != 8"> 
					    <a style="cursor:pointer;"  onClick="sh(<s:property value="id"/>,8,<s:property value="status" />
			...
			<!--<form action="myCoursemake_list.action" name="myclist">
			  ...
			  <form action="course_sh.action" name="course_sh" method="post">
								...
								<s:hidden name="Return" id="Return" value="course_applyDelete_list"></s:hidden>
							</form> 
			<script>
