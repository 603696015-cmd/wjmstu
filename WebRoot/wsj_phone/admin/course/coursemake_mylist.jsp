...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">课件制作</span>
			</li>-->
		</ul>
				</td>
		...
		<table width="100%">
			<tr>
				<td width="200px" valign="top" id="tree_list_td"><wysLib:ctypeTree href="myCoursemake_list.action?ctype.id=" rootAble="true"></wysLib:ctypeTree></td>
				<td valign="middle" width="5px;" style="padding: 0px" >
							<img src="images/leftmenu/main_55.gif" style="cursor: hand"
										onclick="changeTreeDisplay(this)" />
					</td>
			<td valign="top"><s:if test="courses.size==0">没有找到符合条件的课程</s:if>
				<s:form action="myCoursemake_list" name="myclist" theme="simple">
				...
				<s:iterator value="courses">
					<tr>
						...
						<td align="center" >
						 ...
						 <td align="center" >
							<a target="_parent" href="courseman.action?course.id=<s:property value="id"/>" class="textbg">课件制作</a>
						</td>
					 	<!-- <td align="center" >
