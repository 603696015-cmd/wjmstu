...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
				...
				<table width="100%"> 
					 ...
					 <td><s:property value="course.ctype.name" /></td>
						...
						<tr>
							...
							<td>开始时间：</td> 
							<td colspan="2"><input name="course.roomstart" id="r_start" type="text" size="20" onClick="setday(this)" ></td>
							<td>结束时间：</td>
							<td colspan="2"><input name="course.roomend" id="r_end" type="text" size="20" onClick="setday(this)"></td>
						</tr>
			</table>
	     </form>
		<div style="margin-top: 0px; text-align: center;">
		<form action="course_assigntoUsers2Init.action" method="post" name="assignSearch_assignment">
			<s:hidden name="course.id" />
		...
		<table width="100%">
			...
			<%
			   ...
			   String url="course_assigntoUsers2Init.action?course.id="+course.getId()+"&deptid=";
			 %>
			...
			<script type="text/javascript">
						...
						function assign(){
						 ...
						 if(window.confirm("确定分配？！")){
							...
							course_assignment.action="course_newassigntoUsers2.action?status=3";
						...
						function unassign(){
						  if(window.confirm("确定取消分配？！")){
						     var checkObj = document.getElementsByName("id");
							  ...
							  var userids = document.getElementById("userids");
						      userids.value=billIDs;
							  course_assignment.action="course_newunassigntoUsers2.action?status=0";
							  course_assignment.submit();
							}
						}
						  function assignSearch(){
							...
							course_assignment.action="course_allassigntoUsers2.action?status=0";
							course_assignment.submit();
						  }
					</script>
		...
		<form action="course_assigntoUsers2Init.action" method="post" name="acc_list">
