...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
  			<tr>
    			<td valign="middle" class="tablequiz">
    				<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="添加模考试卷" /></div>
			</li>
			<!--<li>
		...
		<div style="margin-top: 0px; text-align: center;">
			<form action="simexampaper_addInit.action" method="post"
				...
				<label>
					所属试卷库
					<wysLib:elibtree itype="ra" iname="examPaper.epl.id"></wysLib:elibtree>
				</label>
				<br>
				<br>
				<label>
