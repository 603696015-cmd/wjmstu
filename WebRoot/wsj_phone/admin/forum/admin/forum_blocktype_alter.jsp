...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
					<wysLib:Navigation ivalue="修改版面分类" />
				</div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">编辑新版面类别</span>
			</li>
			<li class="sep">
			</li>
			<li>
		...
		<form action="forum_blocktype_alter.action" method="post"
			...
			<table width="56%" align="center" cellpadding="1" cellspacing="1">
				<tr>
					...
					<td align="left">
						<input name="fbtype.name" size="30"
							value="<s:property value="fbtype.name"/>" type="text"
							id="typeName">
					</td>
				</tr>
				<tr>
					...
					<td align="left">
						<textarea rows="6" cols="40" name="fbtype.description"><s:property value="fbtype.description" /></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center" height="40px">
						<input name="fbtype.id" size="30"
							value="<s:property value="fbtype.id"/>" type="hidden">
