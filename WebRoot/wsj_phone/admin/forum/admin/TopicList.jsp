										...
										<tr>
											...
											<td width="140" align="center">
												...
												<s:if test="valid==0||valid==2">
													<a
														href="javascript:void(0);" onClick="return doSubmit_4('<s:property value="forum.id"/>','<s:property value="id"/>','<s:property value="pN"/>','<s:property value="pS"/>',2);"
														class="textbg4">通过</a>
													<a
														href="javascript:void(0);" onClick="return doSubmit_4('<s:property value="forum.id"/>','<s:property value="id"/>','<s:property value="pN"/>','<s:property value="pS"/>',3);"
														class="textbg4">删除</a>
												</s:if>
											</td>
										</tr>
