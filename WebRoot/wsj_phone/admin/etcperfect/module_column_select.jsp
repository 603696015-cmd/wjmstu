...
<HTML>
	<HEAD>
			 ...
			 function setRv()
		{
			...
			var str="";
			var flag=false;
			var code_Values = document.getElementsByName("radiobutton");
			...
			<table width="95%" align="center" cellpadding="1" cellspacing="1">
				...
				<tbody onMouseOut="changeback()" onMouseOver="changeto()">
					<s:iterator value="list_tags">	
						<tr  align="center" >
							<td>
								<input type="radio" name="radiobutton" value="<s:property value="table_name" />==<s:property value="column_name" />==<s:property value="name_display" />==<s:property value="column_type" />" >
							</td>
