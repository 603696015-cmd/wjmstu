		...
		<script type="text/javascript">
			...
			function del(id){
				if(window.confirm("确认删除？")){
					...
					form_list_client.action="deleteContact.action";
					form_list_client.submit();
				}
			}
			function view(id){//alert(id);
					document.getElementById("contactid").value=id;
					form_list_client.action="viewContact.action";
					form_list_client.submit();
			}
			function update(id){
				document.getElementById("contactid").value=id;
				//document.getElementById("ismodify").value="modify";
				form_list_client.action="updateContactInit.action";
				form_list_client.submit();
			}
		</script>
		<script type="text/javascript">
...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<!-- 组合查询 -->
			<form action="myContact.action" method="post" name="form_list_client">
