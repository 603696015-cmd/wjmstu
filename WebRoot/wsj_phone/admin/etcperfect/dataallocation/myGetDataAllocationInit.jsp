...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="js/newversion/mydataallocation.js"></script>
...
<style type="text/css">
	...
	<BODY >
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<!-- 组合查询 -->
			<form action="myGetDataAllocationInit.action" method="post" name="form_list_client">
				<s:hidden name="tablename"></s:hidden>
				<s:hidden name="pN" id="pageNow"></s:hidden>
				<s:hidden name="pS"></s:hidden>
			</form>
			<wysLib:myGetDataAllocationList type="1"/>
