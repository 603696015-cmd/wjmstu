...
<HTML>
	<HEAD>
			 ...
			 function setRv()
		{
			...
			var str="";
			var flag=false;
			var code_Values = document.getElementsByName("checkboxbutton");
		//	alert(code_Values.value);
...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: 0px; text-align: center;">
			<!-- 组合查询 -->
			<form action="getModule_checkbox.action" method="post" name="form_list_client">
			...
			<table width="95%" align="center" cellpadding="1" cellspacing="1">
				...
				<tbody onMouseOut="changeback()" onMouseOver="changeto()">
					<s:iterator value="list_module">	
						<tr  align="center" >
						<td>
						<input type="checkbox" name="checkboxbutton" value="<s:property value="modulename" />==<s:property value="tablename" />" >
						</td>
			...
			<div><center><wysLib:page></wysLib:page></center></div>
