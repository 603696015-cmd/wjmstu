...
<HTML>
	...
	<body>
		...
		<s:form action="updateLog.action" method="post" theme="simple" onsubmit="return doSubmit();">
			...
			<table width="700px" cellpadding="2" cellspacing="1" >
				<tr>
					...
					<input class="Wdate" name="schedule.datetime" readonly="readonly"
							type="text" onClick="setday(this)" id="releasetime" value =<s:property value="log.log_createtime"/> />
					</td>
				</tr>
									...
									<s:iterator value="list_logstuff" status="stst">
										<div id="ds_">
											<span id='stufft_'>名称：<input type="hidden"
											  ...
											  <a href="delLogStuff.action?log.id=<s:property value="log.id"/>&logStuff.id=<s:property value="id"/>">删除</a>									
											  </div>
