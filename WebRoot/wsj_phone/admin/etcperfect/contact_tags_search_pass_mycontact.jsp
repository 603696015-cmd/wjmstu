...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="js/newversion/mypasscontacttags.js"></script>
		<script type="text/javascript">
...
<style type="text/css">
	...
	<BODY><%--  onLoad="initTable();" --%>
		...
		<div style="margin-top: px; text-align: center;">
			<!-- 组合查询 -->
			<form action="myPassSearchContactTags.action" method="post" name="form_list_client">
