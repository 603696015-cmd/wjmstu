...
<HTML>
	<HEAD>
		...
		<TITLE><s:property value="menu.name"/> </TITLE>
		<base href="<%=basePath%>">
...
ICONPATH = "images/leftm/" 
<wysLib:funcMenu_newversion></wysLib:funcMenu_newversion>
			...
			<TBODY>
				<TR id="header">
					<TD style="padding: 0px;" width="100%"  height=58>
						<%@include file="../header_newversion.jsp" %>
					</TD>
				</TR>
				<TR>
					<TD height="100%">
							...
							<TBODY>
								<TR>
									...
									<TD width="100%" align="center" valign="top">
										<!--右边的主页面-->
										<iframe id="rightFrame" id="rightFrame" name="rightFrame" scrolling="auto" src="<s:property value="module"/>" frameborder="0"
