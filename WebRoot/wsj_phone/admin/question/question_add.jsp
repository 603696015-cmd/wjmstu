...
.neededitem {
	...
	padding-right: 3px;
		...
		<script type="text/javascript">
			<s:if test="question.qtype==2||question.qtype==3||question.qtype==4||question.qtype==15||question.qtype==16||question.qtype==18">
		  	    var optCount=4;
				var nowCount=0;
				function addOption(){
			...
			<s:if test="question.qtype==6">
				...
				<s:if test="question.qtype==5||question.qtype==17||question.qtype==20">
				...
				//	}
		  		...
		  		<s:if test="question.qtype==19">
		            if(document.getElementsByName("question.options").length < document.getElementsByName("question.fenContents").length){
		            	alert("答案不能少于分题干！");
		            	return false;
						}
		  		</s:if>
			...
			function myload(){
				...
				<s:if test="question.qtype==5||question.qtype==6||question.qtype==19||question.qtype==20">addBlankAnswer( );</s:if>
				<s:if test="question.qtype==19">addTigan();</s:if>
			}
		</script>
		<script type="text/javascript">
	...
	<body onload="myload()">
		...
		<div style="margin-top: 0px; text-align: center;">
			<s:form id="form_question_create" name="form_question_create"
				method="post" action="question_add" onsubmit="return _onsubmit();"
				theme="simple">
				<table width="100%">
					<tr>
						<td valign="top">
							<table width="120px" align="left" border="1" cellspacing="1"
								...
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(1);'>判断题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(2);'>单选题</a>
									</td>
								</tr>
								<!--<tr>
									<td height="20">
										<a href='question_addInit.action?question.qtype=3'>不定项选择题</a>
									</td>
								</tr>
								-->
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(4);'>多选题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(5);'>填空题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(6);'>问答题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(7);'>材料题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(8);'>打字题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(9);'>邮件题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(10);'>搜索题</a>
									</td>
								</tr>
								<tr>
									<td height="20">
										<a href='javascript:addQuestion(11);'>office题</a>
									</td>
								</tr>
								 --%>
							</table>
						...
						<td>
							<table width="100%" align="center" cellpadding=0 cellspacing="1"
								border="0">
								<tr>
									<td height="60" width="150" align="center">
										<b>题型切换</b>
									</td>
									<td align=left>
										<a class="textbg4" href='javascript:addQuestion(1);'>判断题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(2);'>单选题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(4);'>多选题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(5);'>填空题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(6);'>问答题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(7);'>材料题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(8);'>打字题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(9);'>邮件题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(10);'>搜索题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(11);'>office题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(15);'>看图选择</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(16);'>看动画选择</a>&nbsp;&nbsp;&nbsp;&nbsp;<br/>
										<a class="textbg4" href='javascript:addQuestion(17);'>角色扮演</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(18);'>听音选图</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(19);'>拖拽题</a>&nbsp;&nbsp;&nbsp;&nbsp;
										<a class="textbg4" href='javascript:addQuestion(20);'>排序题</a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td height="30" width="150" align="center" >
										<b>所属知识点</b>									</td>
									<td align=left >
										<wysLib:qlibtree did="1" itype="ra_2no" iname="question.qlib.id"
								...
								<tr>
									...
									<td align=left>
										<select name="question.qlevel" id="level">
											<option value="1" id="level_">
												1
											</option>
											<option value="2" id="level_">
												2
											</option>
											<option value="3" id="level_">
												3
											</option>
											<option value="4" id="level_">
												4
											</option>
											<option value="5" id="level_">
												5
											</option>
										</select>
										级
								...
								<tr>
									<td height="30" width="150" align="center" >
										<b>试题标题</b>									</td>
									<td align="left" >
										<s:textarea cols="50" rows="4" name="question.title"
											id="qtitle" />
									</td>
								</tr>
								 --%>
								<s:if test="question.qtype!=9&&question.qtype!=10">
									<tr>
										...
										<td align="left">
											<div>
												<s:if test="question.qtype==15||question.qtype==16||question.qtype==18">
													<span>发声提问：<input type="text" size="65"
															name="question.fashengQuestion" id="fashengQuestion" />
														<a href="javascript:setUrl('fashengQuestion');"
														class="textbg4" style="width: 80px">浏览资源库</a>
													</span>
													<br />
												</s:if>
												<s:if test="question.qtype==16||question.qtype==17">
													<span>媒体文件：<input type="text" size="65"
															name="question.mediaFile" id="mediaFile" /> <a
								...
								<s:if test="question.qtype==1">
									<tr>
										...
										<td align="left">
											<input id="correct_yes" name="question.answers" type="radio"
												checked value="yes" />
											&nbsp;&nbsp;正确 &nbsp;&nbsp;&nbsp;&nbsp;
											<input id="correct_no" name="question.answers" type="radio"
												value="no" />
											&nbsp;&nbsp;错误
										</td>
									</tr>
								...
								<s:if test="question.qtype==6||question.qtype==7">
									<tr>
										...
										<td align="left">
											<div>
												<textarea name="question.answer" id="answer" rows="6"
													cols="80"></textarea>
											</div>
										</td>
									</tr>
								...
								<s:if
									test="question.qtype==2||question.qtype==3||question.qtype==4||question.qtype==15||question.qtype==16||question.qtype==18">
									<tr>
										<td height="30" width="150" align="center">
										...
										<td align="left">
											<div>
												<span>样&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;音： <input
														...
														id="modelVoice" /> 
														<a href="javascript:setUrl('modelVoice');" class="textbg4"
													style="width: 80px">浏览资源库</a>
												</span>
												<br />
												样音文字：
												<textarea name="question.modelVoiceText" id="modelVoiceText"
								...
								<s:if test="question.qtype==6">
									...
									<tr>
										...
										<td align="left" >
											<input type="text" name="question.minWord" id="textfield" />
										</td>
									</tr>
								-->
								</s:if>
									...
									<!--<tr>
										...
										<td align="left" >
											<div>
												...
												<s:textarea name="question.answer"
													cssStyle="width: 0px;height: 0px;visibility:hidden;" />
											</div>
											-->
									<input type="hidden" name="question.answer" value="" />
									<!--</td>
								...
								<s:if test="question.qtype==9">
									<tr>
										<td height="30" width="150" align="center">
											<b><span class="neededitem">*</span>试题内容</b>
										</td>
										<td align="left">
											发 给：
											...
											<br /> -->
											密 送：
											<input type="text" size="65" name="question.answers" id="min" />
											<br />
											<!--分值:
											<input type="text"
											...
											<br />-->
											主 题：
											<input type="text" size="65" name="question.answers" id="zhu" />
											<br />
											<!--分值:
											<input type="text"
								...
								<s:if test="question.qtype==10">
									<tr>
										<td height="30" width="150" align="center">
											<b><span class="neededitem">*</span>标准答案/标题</b>
										</td>
										<td align="left">
											<script type="text/javascript">
											...
											<input type="button" onclick="qanswer_search();" value="搜索" />
											<a href="#" onclick="qsearch_list();return false;">管理列表</a>
											<br />
											 -->
											<!-- 分值:
											<input type="text"
												value="<s:property value="question.oldrules[0]"/>" size="4"
												name="question.oldrules" />正确答案：-->

											<input type="text" id="qanswer_ans" size="45"
								...
								<s:if
									...
									<tr>
										...
										<td align="left">
											...
											<span>样&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;音： <input
														type="text" size="65" name="question.modelVoice"
														id="modelVoice" value="${question.modelVoice}" /> 
														<a href="javascript:setUrl('modelVoice');" class="textbg4"
													style="width: 80px">浏览资源库</a>
												</span><br/>
											...
											<div id="answer_text">
												答案文本：<!-- <input type='text' value="${question.modelVoiceText}"
																name='question.modelVoiceText' /> -->
																<s:textfield name="question.modelVoiceText" id="modelVoiceText" size="100"/>
											</div>
											<!--  <div>
												<input type="button" onclick="addAnswer();" value="添加" />
												&nbsp;&nbsp;
												<input type="button" value="删除" onclick="removeAnswer();" />
											</div>
											-->
											</s:if>
										</td>
								...
								<tr>
									...
									<td align="left">
										<s:textfield name="question.oldscore" value="2" size="4" />

									</td>
								</tr>
								<tr>
									<td height="30" align="center" bgcolor="#ECEDEB" colspan=2>
										<input type="hidden" name="question.parent.id"
										...
										<s:if test="question.qtype==15||question.qtype==16||question.qtype==17||question.qtype==18||question.qtype==19||question.qtype==20">
											<input type="submit" class="textbg"
												style="border: none; color: red;" value="确认添加"
										...
										<script type="text/javascript">
								            ...
								            if(document.getElementById("mediaFile").value==""){
								            	...
								            	<s:if test="question.qtype==15||question.qtype==16||question.qtype==17||question.qtype==19||question.qtype==20">
