	...
	<!--<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<div style="margin-top: 0px; width:320px;">
			<s:form action="knowledge_alter" method="post" theme="simple"
				...
				<table width="320" align="center" cellpadding="2" cellspacing="1"
					bgcolor="#ABE2E2">
					<tr>
						...
						<td height="30" align="left" bgcolor="#F8FCFE">
							&nbsp;<s:textfield name="knowledge.title" size="20" id="kTitle" />
						</td>
					</tr>
					<!--<tr>
								...
								<s:iterator value="knowledge.stuffs" status="stst">
									<div id="ds_">
										<span id='stufft_'>名称：<input type="hidden"
												...
												style='width: 100px;' name='knowledge.stuffs.title'
