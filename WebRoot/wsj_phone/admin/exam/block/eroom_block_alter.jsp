	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top: 3px; color: #077ac7; font-size: 12px;">
					<wysLib:Navigation ivalue="修改考场模块" />
				</div>
			</li>
		</ul>
				</td>
		...
		<div style="margin-top: 0px;">
			<s:form action="eroom_block_alter" method="post" name="catalog_info"
				...
				<table width="740px" align="left" cellpadding="1" cellspacing="1">
					<tr>
						...
						<td>
							<label>
								<s:textfield name="erblock.title" id="name" size="60" />
							</label>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<a href="stat_eroom_block_list.action" class="textbg4" style="width:90px">返回</a>
						</td>
					</tr>
				</table>
				<br>
