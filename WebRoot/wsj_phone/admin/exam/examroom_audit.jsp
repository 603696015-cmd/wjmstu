...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			...
			<!--<li>
				<span style="font-weight: bold;">考场申请审核详情</span>
			</li>-->
		</ul>
		<!-- 内容 -->
		<div style="margin-top: 0px; text-align: center;">
			...
			<table width="90%" align="center" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td >
						<font color="<s:if test="examRoom.uvalid==1">green</s:if>"><s:property
								value="examRoom.uvalidName" />
						</font>
							...
							<script type="text/javascript">
								function page(i){
										document.location.href="examroom_audit.action?examRoom.id=<s:property value="examRoom.id"/>&pS=<s:property value="pS"/>&pN="+i
								}
							</script>
		<s:form action="examroom_modify_application" method="post" theme="simple">  
		...
		<!--		<td width="160"  align="center" >
			...
			<tr>
				...
				<td > 
					<s:if test="erAuditdes.replycontent != null">
						<textarea name="erAuditdes.replycontent" cols="60" rows="7" disabled="disabled">审核人员：<s:property value="erAuditdes.replycontent"/></textarea> 
					</s:if>
					<s:textarea name="erAuditdes.content" cols="60" rows="7"></s:textarea>  
					<s:hidden name="examRoom.id" /> 
					<s:hidden name="examRoom.avalid" value="1"/>   
				</td>
			</tr>  
			<tr>
				<td width="160"  align="center" > 
				...
				<td width="160"  align="center" >
				<input class="textbg6" name="submit" type="submit" value="提交申请" />
				</td>
			</tr>   
			</table>
		</s:form>
