	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function assign( ){
				...
				course_assignment.action="examprac_assigndep_add.action";
				course_assignment.submit();
				}
			}
			function unassign( ){
				if(window.confirm('确定不分配到该部门？注意，之前分配的学员将会被除掉！')){
				course_assignment.action="examprac_assigndep_delete.action";
				course_assignment.submit();
				}
			}
		</script>
...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			...
			<!--<li>
				<span style="font-weight: bold;">为练习分配部门 </span>
			</li>
			<li class="sep">
			</li>
			<li>
		...
		<div style="margin-top: 0px; text-align: center;">
			<label style="font-size: 15px;">
				为考场
				<b><s:property value="examprac.title" /> </b> 分配部门
			</label>
