...
.textbg4{margin-top:2px;}
		...
		function editDetail(){
			...
			var value = pp[0].toString();
			window.location.href = "erwithout_alterInit.action?examRoom.id="+value+"&&Return=sh";
		}
			...
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top" width="200px" id="tree_list_td" style="display:none">
						<wysLib:eroomLibTree
							href="examroom_shlist.action?sublibs=1&str=eroomlib&eroomLib.id="
					...
					<td valign="top">
						<form
							action="examroom_shlist.action?eroomLib.id=<s:property value="eroomLib.id"/>"
