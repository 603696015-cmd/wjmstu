				...
				<table width="100%" cellpadding="1" cellspacing="1">
					<tr>
						<td width="150px" valign="top"
							...
							<wysLib:eroomLibTree  href="eroomAuditJingzhongList.action?sublibs=1&str=libids&eroomLib.id=" rootAble="true"></wysLib:eroomLibTree>
						</td>
						...
						<td width="1000">
							<form action="eroomAuditJingzhongList.action?eroomLib.id=<s:property value="eroomLib.id"/>" name="erform" method="post">
									...
									<tr>
									  ...
									  <s:property value="creater.realname" />									  </td>
										...
										<td width="150" height="30" align="left" >
											<a href="eroomAuditJingzhong.action?examRoom.id=<s:property value="id" />" class="textbg4">审核</a>
										</td>
									</tr>
								</s:iterator></tbody>
						  </table>　
