...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="考场时间重叠查看" /></div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">我创建的培训班</span>
			</li>-->
		</ul>
		<s:form action="eroom_timeover_list.action" name="myclist" theme="simple">
		...
		<table width="100%" align="center" cellpadding="1" cellspacing="1" >
			...
			<s:if test="examRooms.size==0">当前考场和其他已开通的考场没有时间交叉。</s:if>
			<s:else>
