...
tr {
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<!--<li>
				<span style="font-weight: bold;">申请删除列表</span>
			</li>-->
		</ul>
				</td>
			...
			<table width="1100" cellpadding="1" cellspacing="1">
				<tr>
					<td valign="top" id="tree_list_td" style="display:none">
						<wysLib:eroomLibTree
							href="examroom_application_delete.action?sublibs=1&str=eroomlib&eroomLib.id="
					...
					<td>
						<form
							action="examroom_application_delete.action?eroomLib.id=<s:property value="eroomLib.id"/>"
			  ...
			  <input size="16" type="text" onclick=setday(this)
				  ...
				  <table width="100%" align="center" cellpadding="1" cellspacing="1">
										...
										<td align="left">
											...
											<s:if test="valid != 8">
												<a style="cursor: pointer;"
													onClick="sh(<s:property value="id"/>,8);" class="textbg6">申请删除</a>
												<a
													href="CRE_notelistInit.action?examRoom.id=<s:property value="id"/>&Return=examroom_application_delete"
													onclick="showCre(<s:property value="id"/>);return false;"
													class="textbg4">备 注</a>
											</s:if>
											<a
												href="examroom_sh_view.action?examRoom.id=<s:property value="id"/>&Return=del"
												class="textbg4">查 看</a>
										</td>
									</tr>
								</s:iterator>
					    ...
					    <s:hidden name="examRoom.id" id="examRoom.id"></s:hidden>
							...
							<s:hidden name="deleteValid" id="deleteValid" value="true"></s:hidden>
							<s:hidden name="Return" id="Return"
								value="examroom_application_delete"></s:hidden>
						</form>
						...
						<script>  
								function sh(id,valid){
								    ...
								    document.getElementById("examRoomValid").value=valid; 
								 	if(valid==8 && window.confirm("确定执行此操作？")){
