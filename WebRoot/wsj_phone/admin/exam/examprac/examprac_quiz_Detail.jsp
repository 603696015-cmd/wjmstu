...
<HTML> 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<!-- 内容 -->
		<s:form action="examprac_quiz_Detail" method="post" name="epform">
		...
		<div style="font-size:15px;text-align:center;margin-top:10px;">练习答卷详情</div>
				...
				<table width="100%" align="center" cellpadding="1" cellspacing="1">
					...
					<s:iterator value="myExamPapers">
						<tr>
							...
							<td height="30" align="center" >
								<a class="textbg6" target="_blank" href="examprac_view.action?myExamPaper.id=<s:property value="id" />">查看答卷</a>
							</td>
						</tr>
					</s:iterator></tbody>
			  </table>
