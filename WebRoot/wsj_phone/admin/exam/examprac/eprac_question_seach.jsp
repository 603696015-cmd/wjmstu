...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			function doSubmit(){
				myForm.action="eprac_question_list.action";
				myForm.submit();
			}
			function init(){
	...
	<body onload="init();">
		...
		<div style="font-size:15px;text-align:center;margin-top:10px;">练习试题组合搜索</div>
			...
			<TABLE cellSpacing=1 cellPadding=1 width="600" align=center bgColor=#ebebeb>
				<TBODY style="text-align:center;">
				    ...
				    <tr>
						...
						<td>
							<s:select name="question.qtype" list="#{2:'单选题'}" />
						</td>
				    </tr>
				</TBODY>
			</TABLE>
