...
tr {
	background-color: expression((           this .           sectionRowIndex %           2 ==
		...
		<div style="margin-top: 0px; text-align: center;">
			...
			<table width="800" align="center" cellpadding="1" cellspacing="1"
				bgcolor="#EBEBEB">
				<tr>
				...
				<s:else>
					<s:iterator value="erbatchs">
						<tr>
							...
							<td width="80" height="30" align="center">
								<a
									href="quiz_detail_view.action?examRoom.id=0&batchstat=1&erbatch.id=<s:property value="id"/>"
									class=textbg6>查 看</a>
							</td>
							<td width="80" height="30" align="center">
								<a
							...
							<td width="70" height="30" align="center">
								<a
									href="eroom_batch_alterInit.action?erbatch.id=<s:property value="id"/>"
									class="textbg4">修 改</a>
								<a onClick="return window.confirm('确定删除？')"
									style="margin-top: 3px"
									href="eroom_batch_delete.action?erbatch.id=<s:property value="id"/>"
									class="textbg4">删 除</a>
							</td>
						</tr>
					</s:iterator>
			...
			<a href="eroom_batch_addInit.action" class="textbg4"
				style="width: 70px">增加新批次</a>
