...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="线下培训列表" /></div>
			</li>
			<!--<li>
				<span style="font-weight: bold;">活动统计列表</span>
			</li>-->
		</ul>
		<!-- 内容 -->
				...
				<tbody>
					...
					<s:iterator value="offlines">
						<tr>
							...
							<td>
								<a
									href="offline_stat_detail.action?offline.id=<s:property value="id"/>" >概况</a>
								<a
									href="offline_stat_userdetail.action?offline.id=<s:property value="id"/>">详情</a>
							</td>
						</tr>
					</s:iterator>
					<tr>
