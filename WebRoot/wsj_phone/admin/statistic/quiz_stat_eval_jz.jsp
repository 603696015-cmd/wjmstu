...
tr {
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<SCRIPT type="text/javascript"> 
			function toexcel(){   
				statEval.action = "quiz_stat_eval_jz.action?exprot=true";
				statEval.submit();
			} 
			function view(){   
				statEval.action = "quiz_stat_eval_jz.action";
				statEval.submit();
			}
		</SCRIPT>
				...
				<table width="100%" cellpadding="1" cellspacing="1">
					<tr>
						<td valign="top" id="tree_list_td" style="display: block;">
							<form action="quiz_stat_eval_jz.action" method="post"
								name="statEval">
								...
								<s:iterator value="myExamPapers">
									<input type="checkbox"
										<s:if test="status==5">checked='checked'</s:if>
										value="<s:property value="examPaper.id" />"
										name="examPapers.id" />
									<b><s:property value="examPaper.title" /> </b>
									<br />
								</s:iterator>
								<hr />
								...
								<s:iterator value="jzs">
									<input type="checkbox" name="jzs2.id"
										value="<s:property value="id"/>"
										<s:if test="selected == 1">checked="true" </s:if>
										alt="<s:property value="id"/>" />
									<b><s:property value="basevalue" /> </b>
									<br />
								</s:iterator>
							</form>
						</td>
								...
								<s:iterator value="jzs1" status="st">
									...
									<s:else>
										<tr height="30px">
											...
											<td align="center">
												<s:property value="userCount-qkuserCount-userCount_jg" />
											</td>
											<td align="center">
