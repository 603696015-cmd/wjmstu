...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<s:if test="elusers.size==0">当前还没有分配学员</s:if>
	     ...
	     <s:form action="elclass_Modify_application" method="post" theme="simple" name="sh">  
		     <table width="100%">
			     <!-- <tr>
						<td height="30" style="padding-left:8px;color:blue;" align="left">
					  不通过标题：
					...
					<td height="30" align="center" >
					 <textarea name="ecAudit.title" cols="30" rows="1"   disabled="disabled"><s:property value="ecAudit.title" />  </textarea> 
					</td>
				</tr> --> 
			     <tr>
						<td height="30" style="padding-left:8px;color:blue;" align="left">
					...
					<s:hidden name="elclass.id" />  
					<s:hidden name="ecAudit.status" value="4"/>   
					</td>
				</tr>
			     <tr>
						<td height="30" style="padding-left:8px;color:blue;" align="left"> 
