...
tr {
	...
	<body
		...
		<s:form action="elclass_alter" method="post" name="class_info"
			...
			<s:hidden name="staid" value="%{staid}" />
			<table width="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td width="160" height="30" align="right" bgcolor="#FFFFFF">
						<span class="neededitem">*</span>岗位课学习计划：
					</td>
					<td height="30">
						<label>
		...
		<!-- 	<tr>
				...
				<tr>
					<td height="30" align="right" bgcolor="#FFFFFF">
						<span class="neededitem">*</span>岗位结业证书：
					</td>
					<td height="30">
						<label>
				...
				<tr>
					...
					<td height="30">
						...
						<input style="height: 30px; width: 70px;"
							onclick="document.location.href='elclass_view_man.action?elclass.id=${elclass.id}&sublibs=1&staid=${staid }'"
							class="textbg6" type="button" title="返回培训班详情" value="班级详情" />
				<!-- 	<input style="height: 30px; color: red; width: 70px;"
							onclick="document.location.href='elclass_newassign2user_add.action?elclass.id=${elclass.id }&staid=${staid}'"
							class="textbg6" type="button" title="分配当前岗位人员到培训班" value="确认分配" /> -->	
						<input style="height: 30px; color: red; width: 70px;"
							onclick="document.location.href='elclass_course.action?elclass.id=${elclass.id }&staid=${staid }'"
							class="textbg6" type="button" title="管理当前培训班中的课程" value="课程管理" />
			<!-- 		<s:if test="Return==''||null==Return">
							<input style="height: 30px; width: 100px;"
								onclick="document.location.href='elclass_alllist.action?elclass.id=${elclass.id }&staid=${staid }'"
