...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<form action="elclass_assign2userInit2.action" method="post" name="assignSearch_assignment">
		...
		<table width="100%">
			...
			<%
			   ...
			   String url="elclass_assign2userInit2.action?elclass.id="+elclass.getId()+"&deptid=";
			 %>
		...
		<s:if test="elusers.size==0">当前还没有分配学员</s:if>
			...
			<script type="text/javascript">
						...
						function assign(){
						 if(window.confirm("确定分配？！")){
							...
							course_assignment.action="elclass_newassign2user_add2.action";
			...
			<form action="elclass_assign2userInit2.action" method="post" name="course_assignment">
		...
		<form action="elclass_assign2userInit2.action" method="post" name="acc_list">
