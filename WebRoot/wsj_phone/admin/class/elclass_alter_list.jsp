		...
		<table width="100%" cellpadding="1" cellspacing="1">
			<tr>
				<td width="165" valign="top" id="tree_list_td" style="display:none">
					<wysLib:clTypeTree
						href="elclass_alter_list.action?sublibs=1&cltype.id="
						rootAble="true" />
				</td>
				...
				<td valign="top">
					<s:form action="elclass_alter_list" name="myclist" theme="simple">
  ...
  <tr>
    <td bgcolor="#F8FCFE">时间段范围&nbsp;&nbsp;&nbsp;从&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tbody onMouseOut="changeback()" onMouseOver="changeto()">
								<s:iterator value="elclasses">
									<tr>
										...
										<td align="center">
											<a
												href="elclass_details_sh.action?elclassId=<s:property value="id" />&PageStatus=6&PageStatusint=6&Return=alsh"
												class="textbg4">详情</a>
											<s:if test="status == 6">
											...
											<a
												href="elclass_check_students.action?elclass.id=<s:property value="id"/>&sub_department=1&Return=alsh"
												class="textbg4">学员</a>
											<s:if test="status == 6">
												<a style="cursor: pointer;"
													...
													class="textbg4">不允许</a>
												<a
													href="CRE_notelistInit.action?elclass.id=<s:property value="id"/>&Return=elclass_alter_list"
		...
		<form action="elclass_sh.action" name="elclass_sh" method="post">
			...
			<s:hidden name="Return" id="Return" value="elclass_alter_list"></s:hidden>
		</form>
		<script>   
