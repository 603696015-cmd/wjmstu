...
tr {background-color:expression((this.sectionRowIndex%2==0)?"#ffffff":"#f4f4f4")} 
		...
		<table width="100%">
				<tr> 
				<td valign="top" id="tree_list_td" width="150px;" style="display:none">
					<wysLib:dep_list_aj rootAble="true"
					href="allLineTrainingCourse.action?department.id=" iname="department.id" ></wysLib:dep_list_aj>	
				</td>
			...
			<s:form action="allLineTrainingCourse.action" method="post" name="assignSearch_assignment" theme="simple">	
			<table width="100%"> 
		...
		<table width="100%">
			...
			<s:if test="lineTrainingCourseList.size==0"><table height="80" align="center" width="150"><tr align="center"><td align="center" > 没有线下培训班</td></tr></table></s:if>
			<s:else>
			<table width="100%" cellpadding="1" cellspacing="1" bgcolor="#EBEBEB">
				<tr>
					<th width="30"></th>
					<th height="30" align="center" >培训名称</th>
					<th width="6%" height="30" align="center" >学分</th>
					<th width="90" align="center" >发布时间</th>
					...
					<th width="7%" height="30" align="center" >开通审核</th>
					<th width="9%" height="30" align="center" >报名/总人数</th>
					<th width="7%" height="30" align="center" >操作</th> 
				</tr>
				<tbody onMouseOut="changeback()" onMouseOver="changeto()" >
				<s:iterator value="allLineTrainingCourseList" status="status">
					<tr>
						...
						<td height="30" align="center" bgcolor="#FFFFFF" style="color:#CC0099;" onClick="show_div(<s:property value='#status.index+1'/>);">
						...
						<td width="90" height="30" align="center" bgcolor="#FFFFFF" style="color:#CC0099;">
						...
						<td width="70"  height="30" align="center" >
							<a href="allocation_person.action?lineTrainingCourse.id=<s:property value='id'/>&sub_department=<s:property value='sub_department'/>" class="textbg4">分配</a>						</td> 
						<td width="70"  height="30" align="center" >
							<a href="goto_shenhe.action?lineTrainingCourse.id=<s:property value='id'/>" class="textbg4">审核</a>						</td> 
						<td width="70"  height="30" align="center" >
							<a href="result_entry.action?lineTrainingCourse.id=<s:property value='id'/>" class="textbg4">开始</a>						</td> 
						<td width="70"  height="30" align="center" >
							<s:property value="Is_open_chinese" />
					  </td> 
						<td  height="30" align="center" >
							<s:if test="is_open==0">
								<a href="lineTrainingCourseByIds.action?id=<s:property value='id'/>" class="textbg4">开通</a>
							</s:if>
							<s:else>
								<a href="lineTrainingCourseByIds.action?not_open=1&id=<s:property value='id'/>" class="textbg4">关闭</a></s:else></td> 
						<td  height="30" align="center" >
		  ...
		  <div>
			  <center>
					...
					<a href="javascript:open()" />开通</a>
					<a href="trainTypeTreeList.action" class="textbg6">管理类别</a>
			  </center>
		  </div>
