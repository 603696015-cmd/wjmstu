...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="线下培训类别" /></div>
			</li>
		...
		<div style="margin-top: 15px; margin-left: 80px;">
			<a href="trainType_addInit.action" class=textbg>添加类别</a>
		</div>
		<!-- 内容 -->
