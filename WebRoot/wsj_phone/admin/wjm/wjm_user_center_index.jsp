...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function needAllocation(){
			...
			if(!inDingjiRoom){
				if(window.confirm("您当前尚未参加定级考试,点击确定进入定级考场")){
					window.location.href = "quizpaperinit.action?myroom.examroom.id=<s:property value="roomid" />";
				}
			}
		}
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="205" align="left" valign="top"
									...
									<p>
										+++
										<span class="zc01"><s:property value="elUser.realname" /></span> +++&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="logout_wjm.action">退出</a></span>
										<br />
													...
													<s:iterator value="myclasses">
														<tr>
															...
															<td valign="middle" bgcolor="#F8FCFE">
																<a href="#" class="bt001" style="padding-left: 15px;"><s:property
																		value="elClass.name" /> </a>
															</td>
															...
															<s:if test="processForElc==100.00 && examRoom.id!=0">
