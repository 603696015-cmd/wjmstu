...
function aaa(){
			...
			$.ajax({
			  ...
			  data: {tableName:"lable_circulation",lableName:name},
			  async:true,//
		...
		$.ajax({
			  ...
			  data: {tableName:"lable_circulation",'lable.name':name},
			  async:true,//
			  success: function(data){
...
var ltype=$("#labletype").val();
			$.ajax({
			  ...
			  data: {tableName:"lable_circulation",'lable.name':name,orderstr:seleval,'type':ltype},
			  async:true,//
			  success: function(data){
...
$("#orderfield").click(function(){
		...
		$.ajax({
			  ...
			  data: {tableName:"lable_circulation",'lable.name':name,fieldName:fieldsele},
			  async:true,//
			  success: function(data){
			  $("#showorderfield").empty();
		...
		$.ajax({
			  ...
			  data: {tableName:"lable_circulation",'lable.name':name,'type':ltype},
			  async:true,//
			  success: function(data){
...
$(function(){
 $("#deldiv").click(function(){
			...
			$.ajax({
			  ...
			  data: {tableName:"lable_circulation",'lable.name':name,fieldName:divtitle},
			  async:true,//
			  success: function(data){
			  $("#showorderfield").empty();
 ...
 $( function(){
			...
			$.ajax({
			  type: 'POST',
			  url: "lableajax_updorderfielddele.action",
			  data: {tableName:"lable_circulation",'lable.name':name,fieldName:""},
			  async:true,//
			  success: function(data){
			  $("#showorderfield").empty();
...
<input type="radio" name="shu" value="2" /> 百分数
	...
	标签名称：<s:property value="circulationListLable.name" />
	<form action="lable_cirualtionListLableHTML.action" name ="myform" method="post">
			<s:hidden name="circulationListLable.name" id="lablename"></s:hidden>
			<s:hidden name="circulationListLable.type" id="labletype"></s:hidden>
			
			<table width="1060">
					<tr>
						<td valign="bottom">sql语句预览
							<s:textarea rows="10" cols="100" name="circulationListLable.sql"  id="sql" style="white-space: 10px;border-color: black;" theme="simple"></s:textarea>
		...
		<tr>
			...
			<table width="100%">
				<tr>
					<td rowspan="2" width="200"><s:textarea rows="10" cols="80" name="circulationListLable.lable" id="circulationListLablelable" style="white-space: 10px;border-color: black;" theme="simple" onclick='setPos()' onkeyup='setPos()'></s:textarea></td>
					<td width="100px">当前排序状态状态:<span id="orderstatus"><s:property  value="circulationListLable.Ordername" /></span><br>
