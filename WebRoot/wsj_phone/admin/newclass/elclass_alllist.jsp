...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<table width="100%" cellpadding="1" cellspacing="1">
			<tr>
			  <td valign="top" id="tree_list_td">  
					<wysLib:clTypeTree href="newelclass_alllist.action?sublibs=1&cltype.id=" rootAble="true" />
			  </td>
				...
				<td valign="top">
				<s:form action="newelclass_alllist" name="myclist" theme="simple">
			...
			<tr>
				...
				<td width="200" align="left" >
				 <a href="newelclass_copy.action?elclass.id=<s:property value="id" />" class="textbg4">复制</a>
				<s:if test="status == 0 || status == 2"> 
					<!-- <a href="elclass_view.action?elclass.id=<s:property value="id" />" class=textbg4>编辑</a>  -->
					<a href="newelclass_alterInit.action?elclass.id=<s:property value="id" />" class="textbg4">编辑</a>
		...
		<input class="textbg6" style="height:35px;width:100px;" type="button"
			 value="创建培训班" onClick="javascript:document.location.href='newelclass_addInit.action';">
		</td>
	  </tr>
	</table> 
