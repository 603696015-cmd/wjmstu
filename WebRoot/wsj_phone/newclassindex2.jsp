...
<%
	...
	if (request.getAttribute("course") != null) {
		cltypeId = ((Course) request.getAttribute("course")).getCtype()
				.getId()
				+ "";
	} else {
		cltypeId = "1";
...
//	 }
	...
	<body onload="setImgs();">
		<!--<form action="bookinfocourseclass.action" method="post"
				...
				<TBODY>
					<TR>
						<td width="120" height=30 align="center">
							<span class="STYLE10">搜索中心</span>
						</td>
						<td style="PADDING-LEFT: 50px">
							<input onclick="this.value=''" name=name id=search_content
								style="MARGIN-RIGHT: 20px" value="填写名称...." />
							<select style="MARGIN-RIGHT: 20px" id="nametype" name="nametype">
						...
						<td width="300">
							购物车内有
							<span id="ms" class="h30"></span> 门商品
							<a href="getShoppingCart.action"><span class="h30">查看购物车&gt;&gt;</span>
							</a>
						</TD>
					</TR>
				</TBODY>
		...
		<!--<table width="960" height="51" border="0" align="center"
			cellpadding="0" cellspacing="0">
			<tr>
				<td background="images/shopping/pic_17.gif" class="STYLE10">
					<span class="STYLE11">位置导航：选班中心</span>
				</td>
			</tr>
		</table>-->


		<!--<s:iterator value="classlistList">
			<table width="960" border="0" align="center" cellpadding="0"
				cellspacing="0" class=kc_content>
				<tr>
					<td width="270" height="200" valign="top" bgcolor="#f8f9fa">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="33" class=picback>
									<a
										href="forum_getAllclass.action?&isCorrespond=0&cltype.id=<s:property value="elClType.id"/>"><s:property
											value="elClType.name" />
									</a>
								</td>
							</tr>
						...
						<table width="90%" border="0" align="center" cellpadding="0"
							cellspacing="0">
							<s:iterator value="zuixinelClass">
								<tr>
									<td width="30" height="33" align="center" valign="middle"
										class="dibaikuang2">
										<img src="images/shopping/pic_02.gif" width="5" height="9" />
									</td>
									<td class="dibaikuang2">
										<A
											href="newclass_view2.action?elclass.id=<s:property value="id"/>&ctype=2"
											class=font01><s:property value="name" />
										</A>
									</td>
								</tr>
							</s:iterator>
						...
						<table width="90%" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td height="40" align="right" valign="middle">
									<a
										href="forum_getAllclass.action?&isCorrespond=0&cltype.id=<s:property value="elClType.id"/>"><img
											src="images/shopping/more_1.gif" width="34" height="7">
									</a>
								</td>
							</tr>
						</table>
					...
					<td class=hotback width="690">
						...
						<table width="690" border="0" align="right" cellpadding="0"
							cellspacing="0">

							<tr>
								<td>
									<s:if test="hotcours.size==0||hotcours==null">暂无热门培训班信息</s:if>
									<s:else>
										<s:iterator value="hotelClass">
											<TABLE class=dibaikuang border=0 cellSpacing=0 cellPadding=0
												width="100%" align=center>
												<TBODY>
													<TR>
														<TD class=heicu14 height=30 vAlign=middle>
															<A
																href="newclass_view2.action?elclass.id=<s:property value="id"/>&ctype=2"
																class=STYLE5><s:property value="name" />
															</A>
														</TD>
													</TR>
													<TR>
																	...
																	<TR>
																		<TD width=110 height="100" align=left vAlign=top>
																			<s:if test="mainimg != null">
																				<img src="<s:property value="mainimg_"/>"
																					width="100" height="80" />
																			</s:if>
																			<s:else>
																				<img
																		...
																		<TD height=85 vAlign=top style="padding-right: 20px;">
																			简介：
																			<s:property value="description" />
																			<span class="h30">创建：<s:property
																					value="creater.realname" /> <s:date
																					name="createtime" format="yyyy-MM-dd HH:mm:ss" />
																			</span>
																			<br />
																		</TD>
																	</TR>
...
<table width="320" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    <td height="120" valign="top"><div class="menu_bg">
		      <div>
    ...
    <table width="320" border="0" cellspacing="0" cellpadding="0">
       	  <tr>
       	    <td><table width="320" height="51" border="0" align="center" cellpadding="0" cellspacing="0">
       	      <tr>
       	        <td background="images/shopping/pic_17.gif" class="STYLE101"> 　　<span class="STYLE111">位置导航：选班中心</span></td>
   	          </tr>
   	        </table></td>
   	      </tr>
       	  <tr>
