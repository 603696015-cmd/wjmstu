...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>设备管理</TITLE>
...
class=shadow id=locationid>设备管理</SPAN></DIV>
<DIV class=tabs>
<UL>
  ...
  <FORM id=myform name=myform action="PG_updateBaoxianProduct.action?updateType=${updateType }" method=post onsubmit="return check();">
	...
	<TABLE cellSpacing=1 cellPadding=3 width="98%" align=center border=0>
		  ...
		  <TR class=tdbg>
		    ...
		    <td width="25%" >
				<SPAN style="FONT-WEIGHT: bold">对应保单：</SPAN>
			</td>
			<td width="25%" >
		  ...
		  <TR class=tdbg>
		    <TD width="25%" height=22>
		    	<SPAN style="FONT-WEIGHT: bold">设备特色：</SPAN>
		    </TD>
		  ...
		  <tr>
		  	<td width="25%">
				<SPAN  style="FONT-WEIGHT: bold">设备亮点：</SPAN>
			</td>
			<td width="25%">
				<script type="text/javascript">
					var ii = 0;
		    ...
		    <TD width="25%">
		    	<SPAN  style="FONT-WEIGHT: bold">设备介绍：</SPAN>
		    </TD>
