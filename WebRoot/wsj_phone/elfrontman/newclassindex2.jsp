...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	  <tr>
       	    <td><table width="100%" height="51" border="0" align="right" cellpadding="0" cellspacing="0" style="background-color:#00A2FC;">
       	      <tr>
       	        <td  class="STYLE101"> 　　<span class="STYLE111">位置导航：选班中心</span></td>
   	          </tr>
   	        </table></td>
   	      </tr>
       	  <tr>
