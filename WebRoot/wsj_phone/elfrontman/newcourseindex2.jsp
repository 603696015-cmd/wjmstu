...
<link href="wsj_phone/elfrontimages/nav_style_0903.css" type=text/css rel=stylesheet />
...
.STYLE111 {font-size: 16px;color: #006699;
	font-weight: bold;
	font-size: 18px;
}
...
//	 }
  ...
  <tr>
    ...
    <table width="690" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
        	 <s:if test="hotcours.size==0||hotcours==null">该课程分类暂无热门课程</s:if>
		    <s:else>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
       	...
       	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
       	  <tr>
       	    <td><table width="100%" height="51" border="0" align="left" cellpadding="0" cellspacing="0">
       	      <tr>
       	        <td  class="STYLE101" style="background-color:#00A2FC;"> 　　<span class="STYLE111">位置导航：课程导航中心</span></td>
   	          </tr>
   	        </table></td>
   	      </tr>
       	  <tr>
