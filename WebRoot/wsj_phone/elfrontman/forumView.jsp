	...
	<BODY onLoad="init();"><%@include file="frontheader.jsp"%>
        ...
        border="0">
          ...
          align="left" class="renmen2" id="renmen2" ><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style=" background-color:#00A2FC;">
                        ...
                        <tr>
                          <td align="left" valign="top" style="PADDING: 8px; line-height:25px;"> <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
										<TBODY>
											<TR>
        ...
        border="0">
          ...
          ><table width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" bgcolor="#F7FBFE" style="PADDING: 8px; line-height:25px;"> <table width="320" height="200" border="0" align="left"
