...
<HTML>
	<HEAD>
		...
		<TITLE>中国食品安全培训网--培训班搜索结果列表</TITLE>
		<base href="<%=basePath%>">
			...
			<tr>
				<td width="270" valign="top">
					<table style="margin-top: 8px;" cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td width="5" height="5"><img height="5" src="images/knowledge/zhao_21.gif" width="5" /></td>
								<td width="662" background="images/knowledge/zhao_22.gif"></td>
								<td width="5"><img height="5" src="images/knowledge/zhao_23.gif" width="5" /></td>
							</tr>
							<tr>
								...
								<td class="renmen2" id="renmen2"
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<span class="STYLE6">培训班栏目导航</span>
											</td>
							...
							<tr>
								<td background="images/knowledge/zhao_24.gif"></td>
								<td align="left" bgcolor="#a2ceea" height="3"><img height="3" src="images/knowledge/zhao_29.gif" width="222" />
								</td>
								<td background="images/knowledge/zhao_25.gif"></td>
							</tr>
							<tr>
								...
								<td height="200" align="left" valign="top"
									...
									<wysLib:clTypeTree></wysLib:clTypeTree>
								</td>
								<td background="images/knowledge/zhao_25.gif"></td>
							</tr>
							<tr>
					...
					<table style="margin-top: 8px;" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								...
								<td class="renmen2" id="renmen2"
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<span class="STYLE6">当前位置：培训班搜索&gt;&gt; 符合条件：”<s:property
														value="course.name" />“培训班如下<br> </span>
											</td>
											<td width="60" align="center">
												<a href="#"></a>
											</td>
							...
							<tr>
								...
								<td height="200" align="left" valign="top"
									style="PADDING: 8px; line-height: 25px;">
									<form action="course_listbytitle.action" method="post"
										name="ddd">
												...
												<td height="35" valign="bottom" class="heicu14">
													<table width="100%" height="30" border="0" cellpadding="0"
														...
														<tr>
															<td class="STYLE5">
																<a
																	href="class_view.action?elclass.id=<s:property value="id"/>"><s:property
																		value="name" />
																</a>
															</td>
															<td align="center">
