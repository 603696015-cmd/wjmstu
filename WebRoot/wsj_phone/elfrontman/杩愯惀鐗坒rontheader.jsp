							...
							<ul id="navigation">
								...
								<li onMouseOver="displaySubMenu(this)"
									...
									<a href="courseIndex.action?pN=0&pS=10&containsub=0&course.ctype.id=1"
										...
										<li onMouseOver="displaySubMenu(this)"
													onMouseOut="hideSubMenu(this)">
											<a href="front_bookinfo_allistview.action?pN=0&pS=10&containsub=0&btype.id=1"
														class="parent"> <span> 图书中心 </span> </a> 
										<!--<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">
											<a href="newcourseIndex.action?pN=0&pS=10&containsub=0&course.ctype.id=1"
												class="parent"> <span> 课程导航 </span> </a> 
										<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">
											<a href="study.action?module=mycourselist.action"
										...
										<li onMouseOver="displaySubMenu(this)"
											...
											<a href="forum_getAllclass.action?pN=0&pS=10&isCorrespond=1"
										...
										<li onMouseOver="displaySubMenu(this)"
											...
											<a href="user_center_list.action?pN=0&pS=10"
												class="parent"> <span> 会员中心 </span> </a>
										<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">

											<a href="product_center_list.action?pN=0&pS=10"
												class="parent"> <span> 产品中心 </span> </a>
										<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">

											<a href="baoxianProduct_center_list.action?pN=0&pS=10"
												class="parent"> <span> 保险中心 </span> </a>
								...
								<li onMouseOver="displaySubMenu(this)"
									...
									<ul>
										...
										<li onMouseOver="displaySubMenu(this)"
											...
											<a href="forum_courseclub.action"
												class="parent"> <span> 选课中心 </span> </a>
										<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">

											<a href="forum_classclub.action"
												class="parent"> <span> 选班中心 </span> </a>
										<!-- <li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">

											<a href="study.action?module=myelclass_list.action?pN=0&pS=10"
												class="parent"> <span> 在线书城 </span> </a>	 -->
												
										<li onMouseOver="displaySubMenu(this)"
											onMouseOut="hideSubMenu(this)">

											<a href="line_training_course_center.action?pN=0&pS=10"
												class="parent"> <span> 线下培训班导航 </span> </a>	
										...
										<li onMouseOver="displaySubMenu(this)"
											...
											<a href="exam_listbytitle_isPass.action?pN=0&pS=10&isCorrespond=1"
								...
								<li onMouseOver="displaySubMenu(this)"
									...
									<ul>
										...
										<li>
											<a href="knowledge_center_list.action"
