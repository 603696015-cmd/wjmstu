...
href="wsj_phone/images/shopping/index.css"><LINK rel=stylesheet type=text/css 
href="wsj_phone/images/shopping/menu.css">
<LINK rel=stylesheet type=text/css href="wsj_phone/images/shopping/book_index.css"><LINK 
rel=stylesheet type=text/css href="wsj_phone/images/shopping/nav_style_0903.css">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" height="51" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td  style="background-color:#00A2FC;" class="STYLE10"><span class="STYLE11" onclick="clickButton()">
  ...
  <tr>
    <td><table width="320" border="0" align="left" cellpadding="0" cellspacing="0" class="kc_content2">
      <tr>
        <td valign="top"><p>&nbsp;</p>
          <table width="320" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40" height="35" align="center"><img src="images/shopping/pic_35.gif" alt="" width="5" height="9" /></td>
              <td>主讲教师：
            ...
            <tr>
              <td height="35" colspan="2" align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0" >
                <tr>
                  <td align="left" class="STYLE10" style="padding:10px;">原价
                    <s:property value="course.price.courseoldPrice" />
                    元　课程时长
                    <s:property value="course.during" />
                    课时 <br />
                    现价
                    <s:property value="course.price.coursenowPrice" />
                    元　已节省
                    <s:property value="course.price.chajia" />
                    元 </td>
                </tr>
              </table></td>
            </tr>
            ...
            <tr>
              <td width="40" height="35" align="center"><img src="images/shopping/pic_35.gif" alt="" width="5" height="9" /></td>
              <td>课程格式：
                <s:property value="course.courseFormName" /></td>
            </tr>
            <tr>
              <td width="40" height="35" align="center"><img src="images/shopping/pic_35.gif" alt="" width="5" height="9" /></td>
              <td>已有评价
          ...
          <table width="320" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
            <tr>
              <td>&nbsp;</td>
              <s:if test="mycourse == 0">
                <td width="160"><img src="images/shopping/jr_buy.gif" alt="" width="99" height="32" id="send_ajax" /></td>
                <td width="140"><a href="shopping_addandto.action?commodity.commodityid=&lt;s:property value="course.id="course.id"/></a>&amp;commodity.commoditytype=1&quot; &gt;<img src="images/shopping/pic_29.gif" alt="" width="112" height="36" id="tocart" /></a></td>
              </s:if>
              <s:else>
                <td colspan="2">已购买</td>
              </s:else>
  ...
  <tr>
    <td><table width="100%" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="kc_content3">
      <tr>
        <td style="background-color:#00A2FC;" class="STYLE10"> 　　课程简介 </td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<!--<table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content2>
  <tr>
	...
	<s:if test="courseComment.count!=0"></s:if>
<a name="liuyan2"></a>
