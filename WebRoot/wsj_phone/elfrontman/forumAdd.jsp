...
function checkForm(form,valid){
		...
		<table width="320" bgcolor="#ffffff" border="0" align="left"
						...
						<table style="padding: 8px;" width="100%" height="30" border="0"
							...
							<tr>
								...
								<td height="25" bgcolor="#F7FBFE">
									<input style="WIDTH:150px;height: 25px;border: 1px solid #000000;padding:5px;" type="text" size="40" id="title" name="forum.title">
