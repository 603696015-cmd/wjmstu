...
<HTML>
	<HEAD>
		...
		<TITLE>中国食品安全培训网--<s:property value="fblock.title" />版块--文章列表
		</TITLE>
		<base href="<%=basePath%>">
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
					...
					<form action="forumListByBlockid.action?fblock.id=10" method="post" name="ddd">
