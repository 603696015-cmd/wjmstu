													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td height="85" valign="top" style="line-height:15px;">
																<div><b>简介：</b><s:property value="description" />&nbsp;<a href="class_view2.action?elclass.id=<s:property value="id"/>&cltype.id=<s:property value="cltype.id"/>" style="color:blue;">查看详情&gt;&gt;</a></div>
																<div style="color: blue"><b>创建时间:</b> <s:date name="createtime"
