...
function validateIdCard(obj)
{
 ...
 return 0;
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr>
       <td width="100" height="35" align="center" bgcolor="#CFDBE2" class="STYLE5">新闻公告</td>
       <td bgcolor="#CFDBE2">&nbsp;</td>
     </tr>
   </table>
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td><table width="100%"  height=170 border=0 align="left"
										cellpadding=0 cellspacing=0 class=bd4 style="padding:0 !important;">
										<tbody>
											<tr>
												<td align=left>
																...
																<td height=140>
																	<table border=0 cellspacing=0 cellpadding=0
																		...
																		<tbody>
																			...
																			<zdyLib:zdyloop lablename='2-复制Jl4pqQB1'  xunhuan='' setnull='暂无数据' switches='' include=''  constraint='true'    ></zdyLib:zdyloop>
																		</tbody>
																	</table>																</td>
															</tr>
														</tbody>
			  ...
			  <tr>
			    <td><img src="images/gaiban2/img_24.jpg" width=320 height=3></td>                
		      </tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="100" height="35" align="center" bgcolor="#CFDBE2" class="STYLE5">证书查询</td>
                        <td bgcolor="#CFDBE2">&nbsp;</td>
                      </tr>
                    </table>
					<TABLE width="100%" height="60" border=0 align="center"
                      ...
                      <TR>
                        <TD width="80" height="50" align=right bgcolor="#F8FCFE"><span class="STYLE5">身份证：</span> </TD>
                        <TD height="50" align=left vAlign=center bgcolor="#F8FCFE" style="padding:5px;"><INPUT id=shenfenzheng2 class=db2 size=15
																			name=shenfenzheng2 style="width:200px;height:30px;">
                        </TD>
                      </TR>
                      <TR>
                        <TD width="80" height="50" align=right bgcolor="#F8FCFE" class=bai><span class="STYLE5">证书号：</span> </TD>
                        <TD height=50 align=left vAlign=center
																		bgcolor="#F8FCFE" style="padding:5px;"><INPUT id=zhengshuhao2 class=db2 size=15
																			name=zhengshuhao2 style="width:200px;height:30px;">
                        </TD>
                      </TR>
                      <TR>
                        <TD height="50" colspan="2" align=center bgcolor="#F8FCFE" class=bai><input type="submit" name="Submit" style="font-size:24px;" value="点击查询"></TD>
                      </TR>
                    </TABLE>
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
