...
var ax={"statusId":'1'}
	...
	<BODY onLoad="setImgs();"><%@include file="frontheader.jsp"%>
		...
		<table width="100%" border="0" align="left" cellpadding="0"
            ...
            <tr>
                <td>
                <table width="100%" height="51" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td style="background-color:#00A2FC;" class="STYLE10"> 　　<span class="STYLE11">位置导航：培训班导航中心</span></td>
  </tr>
</table>
                </td>
            </tr>
        ...
        border="0">
                <tbody>
                  ...
                  <tr><td>
		<s:include value="frontbottom.jsp" /></td></tr>
                </tbody>
            </table>
        </table>
