...
<tr>
        ...
        border="0">
		      <tbody>
		        <tr>
		          <td width="5" height="5"><img src="images/knowledge/zhao_21.gif" alt="" 
            width="5" height="5" /></td>
		          <td width="662" background="images/knowledge/zhao_22.gif"></td>
		          <td width="5"><img src="images/knowledge/zhao_23.gif" alt="" 
        width="5" height="5" /></td>
	            </tr>
		        <tr>
          ...
          align="left" height="30"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
		        ...
		        <tr>
		          <td background="images/knowledge/zhao_24.gif"></td>
		          <td align="left" bgcolor="#a2ceea" height="3"><img 
            src="images/knowledge/zhao_29.gif" alt="" width="222" height="3" /></td>
		          <td background="images/knowledge/zhao_25.gif"></td>
	            </tr>
		        <tr>
		          <td background="images/knowledge/zhao_24.gif"></td>
		        ...
		        <tr>
		          <td height="6"><img src="images/knowledge/zhao_26.gif" alt="" width="5" height="5" /></td>
		          <td background="images/knowledge/zhao_27.gif"></td>
		          <td><img src="images/knowledge/zhao_28.gif" alt="" 
        width="5" height="5" /></td>
	            </tr>
	          </tbody>
	        </table></td>
		          ...
		          <td align="left" valign="top" style="PADDING: 8px; line-height:25px;"><form action="knowledge_center_list.action" method="post"
		            ...
		            <s:iterator value="knowledges">
		              <table width="100%" border="0" align="center" cellpadding="0"
		                ...
		                <tr>
		                  <td height="35" valign="bottom" class="heicu14"><table width="100%" height="30" border="0" cellpadding="0"
														cellspacing="0">
		                    <tr>
		                      <td class="STYLE5"><a 
		                ...
		                <tr>
		                  <td height="95" valign="bottom"><table width="98%" border="0" align="center"
														cellpadding="0" cellspacing="0">
		                    <tr>
