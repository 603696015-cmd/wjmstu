function QuizTimer(id,timerarea,during,during_js,passtime,bottom,left){
	 this.id = id;
	 ...
	 $(timer).append("<h2 style='margin:3px 0px 3px 0px;color:red;text-align:center;font-family:\"Times New Roman\",Georgia,Serif;' id='"+timerarea+"'>加载中</h2>");
	 this.timerd = timer;
	 $("body").append(timer);
