...
<link href="elfrontimages/nav_style_0903.css" type=text/css rel=stylesheet />
...
//	 }
  ...
  <tr>
    <td background="images/shopping/pic_17.gif" class="STYLE10"> 　　<span class="STYLE11">位置导航：课程导航中心</span></td>
  </tr>
</table>
		
		
	<s:iterator value="listList" >
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="33" class=picback><a href="newcourseIndex.action?course.ctype.id=<s:property value="name.id"/>"><s:property  value="name.name" /></a></td>
      </tr>
    </table>
    ...
    <table width="690" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>
        	 <s:if test="hotcours.size==0||hotcours==null">暂无热门图书信息</s:if>
		    <s:else>
              ...
              <TD height=95 vAlign=bottom><TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                  <TBODY>
                    <TR>
                      ...
                      <TD height=85 vAlign=top style="padding-right:20px;">简介： 
                        <s:property value="descString" /><br/>
                        <span class="h30">创建：<s:property value="creater.realname" /> <s:date name="createtime"
		...
		<table width="320" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    <td height="120" valign="top" bgcolor="#FF0000"><div class="menu_bg">
		      <div>
       	...
       	<table width="320" border="0" cellspacing="0" cellpadding="0">
       	  <tr>
       	    <td><table width="320" height="51" border="0" align="center" cellpadding="0" cellspacing="0">
       	      <tr>
       	        <td background="images/shopping/pic_17.gif" class="STYLE101"> 　　<span class="STYLE111">位置导航：课程导航中心</span></td>
   	          </tr>
   	        </table></td>
   	      </tr>
       	  <tr>
       	    <td>
            	<s:iterator value="listList" >
	<table width="320" border="0" align="center" cellpadding="0" cellspacing="0" class=kc_content>
  <tr>
    <td width="270" height="200" valign="top" bgcolor="#f8f9fa">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
