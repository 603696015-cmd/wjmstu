...
<html>
	<head>
		...
		<base href="http://localhost:80/gdgat/" />
		<TITLE>学习课程（SCORM）--ttttttttttt
		</TITLE>
		<LINK href="css/study_wbkc.css" type=text/css rel=stylesheet />
		<script type="text/javascript" src="js/cstudy.js"></script>
	...
	COLOR: #ffffff
		...
		<script type="text/javascript">
			 function div_ifr(){
				 ...
				 var gsd = "'> </iframe>";
				 document.getElementById("ifr").innerHTML = qas+asd+aqw+awq+" 'scourses/680/scoWrapper.htm"+gsd;
			}
			...
			var API = null;
			function myload(){
				API = window.document.APIAdapter;
			}
		</script>
	</HEAD>
	<body onload="div_ifr();myload()" style="overflow: visible;height:100%; padding: 0px; margin: 0px">
	<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"
            width="110" height="110" id="APIAdapter"
            codebase="http://java.sun.com/update/1.6.0/jinstall-6u16-windows-i586.cab#Version=1,6,0,16">
    <param name = "code" value = "com.sopia.common.scorm.SopiaAPIAdapterApplet.class" >
    <param name = "codebase" value = "/gdgat" >
    <param name = "type" value="application/x-java-applet;version=1.6">
    <param name = "mayscript" value="true" >
    <param name = "scriptable" value="true" >
    <param name = "archive" value = "elearning.jar" >
    <param name = "user_id" value = "1" >
    <param name = "course_id" value = "680" >
    <param name = "class_id" value = "950" >
    <param name = "context" value = "gdgat" >
    <comment>
    <applet code="com.sopia.common.scorm.SopiaAPIAdapterApplet.class" 
            archive="elearning.jar" 
            codebase="/gdgat"
            height="155" 
            id="APIAdapter" 
            name="APIAdapter" 
																...
																<tr>
																	...
																	<td valign="middle" align="center" width=480>
																		...
																		<a class=dh target="_blank"
																			href="course_tandsp.action?course.id=680&course_sourse=0">讲师简介</a><span
																			class="STYLE12"> &gt;&gt;</SPAN>
																		<a class=dh href="#" style="cursor: hand"
																			onclick="javascript:showCat(this);return false;">进度</a><span
																			class="STYLE12"> &gt;&gt;</SPAN>
																		<a class=dh target="_blank"
																			href="course_tandsp.action?course.id=680&course_sourse=1">教学计划</a><span
																			class="STYLE12"> &gt;&gt;</SPAN>
																		<a class=dh target="_blank"
																			href="practice_listInit.action?course.id=680">练习中心</a><span
																			class="STYLE12"> &gt;&gt;</SPAN>
																		<a class=dh style="cursor: hand"
																			onclick="window.open('course_study_noteAddInit.action?course.id=680','')">做笔记</a><span
																			class="STYLE12"> &gt;&gt; </span><a class="dh"
																			style="cursor: hand"
																			onclick="window.open('course_study_notelist.action?course.id=680','')">查看笔记</A>
