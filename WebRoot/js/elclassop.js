...
function addExamRoomUserinfo(id){
	if($("#_kc_u"+id).length==0){
		...
		$(_d).html(
			...
			'<input type="hidden" name="elRegistration.erParas['+eridx+'].examRoom.id" value="'+jsondata.id+'">'+
			'<label style="width:260px;float:left;text-align:left;">'+
			'名称：'+jsondata.title+'</label>'+
			'<label style="float:left;text-align:left;">'+
			'是否通过：<select name="elRegistration.erParas['+eridx+'].isPassed">'+
			'<option value="-1">全部</option>'+
			'<option value="1">是</option>'+
			'<option value="2">否</option>'+
			'</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
			'考场成绩：<select name="elRegistration.erParas['+eridx+'].examScoreTerm">'+
			'<option value=">=">>=</option>'+
			'<option value=">">></option>'+
			'<option value="=">=</option>'+
			'<option value="<"><</option>'+
			'<option value="<="><=</option>'+
			'</select><input type="text" maxlength="4" style="width:30px;" name="elRegistration.erParas['+eridx+'].examScore" value="0" />'+
			'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
			'<select name="elRegistration.erParas['+eridx+'].linkTerm">'+
...
function addExamRoomEpUserinfo(id){
	...
	{	async:false,  //   
		...
		for(var i=0;i<jsondata.eroomEps.length;i++){
			...
			//$(_d).css("float","left");
			$(_d).css("border","solid #fff 1px");
			epHtml='<input type="hidden" name="elRegistration.erepParas['+epindex_+'].examRoom.id" value="'+jsondata.eroomEps[i].erid+'">'+
					'<input type="hidden" name="elRegistration.erepParas['+epindex_+'].examPaper.id" value="'+jsondata.eroomEps[i].epid+'">'+
					...
					'是否通过：<select name="elRegistration.erepParas['+epindex_+'].isPassed">'+
					'<option value="-1">全部</option>'+
					'<option value="1">是</option>'+
					'<option value="2">否</option>'+
					'</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
					'考试次数：<select name="elRegistration.erepParas['+epindex_+'].examCountTerm">'+
					'<option value=">=">>=</option>'+
					'<option value=">">></option>'+
					'<option value="=">=</option>'+
					'<option value="<"><</option>'+
					'<option value="<="><=</option>'+
					'</select><input type="text" maxlength="4" style="width:30px;" name="elRegistration.erepParas['+epindex_+'].examCount" value="0" />'+
					'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
					'<br/>平均分：<select name="elRegistration.erepParas['+epindex_+'].avgScoreTerm">'+
					'<option value=">=">>=</option>'+
					'<option value=">">></option>'+
					'<option value="=">=</option>'+
					'<option value="<"><</option>'+
					'<option value="<="><=</option>'+
					'</select><input type="text" maxlength="4" style="width:30px;" name="elRegistration.erepParas['+epindex_+'].avgScore" value="0" />'+
					'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
					'最高分：<select name="elRegistration.erepParas['+epindex_+'].maxScoreTerm">'+
					'<option value=">=">>=</option>'+
					'<option value=">">></option>'+
					'<option value="=">=</option>'+
					'<option value="<"><</option>'+
					'<option value="<="><=</option>'+
					'</select><input type="text" maxlength="4" style="width:30px;" name="elRegistration.erepParas['+epindex_+'].maxScore" value="0" />'+
					'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
					'<select name="elRegistration.erepParas['+epindex_+'].linkTerm">'+
					'<option value="or">or</option>'+
					'<option value="and">and</option>'+
					'</select>'+
					'</label>'+
...
function addElclassUserinfo(id){
	...
	{	async:false,  //   
		...
		success:function(data){
				var jsondata = eval("("+data+")");
	$(_d).html(
		'<input type="hidden" name="elRegistration.classParas['+clindex_+'].elClass.id" value="'+jsondata.id+'">'+
		'<label style="width:260px;float:left;text-align:left;">'+
		'名称：'+jsondata.title+'</label>'+
		'<label style="float:left;text-align:left;">'+
		'是否通过：<select name="elRegistration.classParas['+clindex_+'].isPassed">'+
		'<option value="-1">全部</option>'+
		'<option value="1">是</option>'+
		'<option value="2">否</option>'+
		'</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
		'总学分：<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].sumScoreStart" value="0" />'+
		'&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].sumScoreEnd" value="100" />'+
		'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
		'<br/>必修总学分：<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].bsumScoreStart" value="0" />'+
		'&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].bsumScoreEnd" value="100" />'+
		'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
		'选修总学分：<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].xsumScoreStart" value="0" />'+
		'&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" maxlength="4" style="width:30px;" name="elRegistration.classParas['+clindex_+'].xsumScoreEnd" value="100" />'+
		'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
		'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
		'<select name="elRegistration.classParas['+clindex_+'].linkTerm">'+
		'<option value="or">or</option>'+
		'<option value="and">and</option>'+
		'</select>'+
		'</label>'+
