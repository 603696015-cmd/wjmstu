...
function initMenu(basepath,cid){
	...
	l102.addChild(new lmenu("l10205","处理删除学习课程","study_course_delete_list.action",2,"rightFrame"));
	...
	l106 = new lmenu("l106","学习统计分析","",1);
	l106.addChild(new lmenu("l10601","点数排行榜","score_dot_list.action",2,"rightFrame") );
	l106.addChild(new lmenu("l10602","积分排行榜","score_score_list.action",2,"rightFrame") );
	l106.addChild(new lmenu("l10603","学分排行榜","score_xfscore_list.action",2,"rightFrame") );
	l106.addChild(new lmenu("l10604","综合排行榜","score_zhscore_list.action",2,"rightFrame") );
	...
	l109=  new lmenu("l109","学习奖惩","",1);
	l109.addChild(new lmenu("l10901","点数设置","dot_setInit.action",2,"rightFrame"));
	l109.addChild(new lmenu("l10904","积分设置","score_setInit.action",2,"rightFrame"));
	l109.addChild(new lmenu("l10905","学分设置","xfscore_setInit.action",2,"rightFrame"));
	l109.addChild(new lmenu("l10906","惩罚机制","jian_setInit.action",2,"rightFrame"));			
	l109.addChild(new lmenu("l10907","兑换比例","scorechange_setInit.action",2,"rightFrame"));			
	...
	l403.addChild(new lmenu("l40304","我的点数","myscore_dot_view.action?elclass.name=&pN=0&pS=10",2,"rightFrame"));
	l403.addChild(new lmenu("l40305","我的积分","myscore_score_view.action?elclass.name=&pN=0&pS=10",2,"rightFrame"));
	...
	l4012.addChild(new lmenu("l401201","地图概貌","talent_expert_list.action",2,"rightFrame"));
	l4012.addChild(new lmenu("l401202","专家搜索","talent_expert_search.action?role.id=6",2,"rightFrame"));
	l4012.addChild(new lmenu("l401203","专家论坛","forumIndex.action",2,"_blank"));
	...
	l501.addChild(new lmenu("l50101","人才管理","account_searchInit.action?role.id=4",2,"rightFrame"));			
	...
	l504.addChild(new lmenu("l50402","帐号管理","account_searchInit.action?role.id=6",2,"rightFrame"));			
