...
$(function(){
	...
	ToolsBarObj.ToolsBar_Add("toolbar_application","申请","images/newversion/un_view.gif","applicationDetail()");
...
function clickcheckbox(){
	...
	if(pp.length>1){
		...
		if(can_application)
			ToolsBarObj.ToolsBar_Enabled("toolbar_application");
		else
		    ToolsBarObj.ToolsBar_Disabled("toolbar_application");
