...
WTree.prototype.fabricate=function(n){
	...
	var href_url= "<a  title='"+n.title+"' id='"+n.treeType+n.id+"_a"+"' href=\""+((this.url==null||this.url=="")?"javascript:"+this.id+".open( "+n.id+");":(this.url+n.id))+"\">"+ n.name+ "</a>";
	/*if(n.parent==null){
