...
// Tree object
function dTree(objName,inputname) {
...
dTree.prototype.node = function (node, nodeId) {
	...
	if(node.id!=0){
		//if(strcheck=='true')
		//str+="<input type='checkbox' checked='checked' name='"+inputname+"' id=\""+objName +node.id+ "\" value='"+node.id+"'>"
		//else
		str+="<input type='checkbox' checked='checked' disabled name='"+this.inputname+"' id=\""+this.obj +node.id+ "\" value='"+node.id+"'>"
	}
	if (node.url) {
