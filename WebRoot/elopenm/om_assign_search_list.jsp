	...
	<BODY>
		...
		<!--<table width="60%" cellpadding="1" cellspacing="1">
			...
			<script type="text/javascript">
			 	function page(i){
			 		acc_list.action=  "om_assign_search.action";
			 	...
			 	function assign2user(){
			 		acc_list.action=  "om_assign.action";
			 		acc_list.submit();
			 	}
			</script>
				<wysLib:page></wysLib:page>
				<br>
				<input value="添加到当前<s:if test="room.roomtype==1">会议</s:if><s:if test="room.roomtype==2">课堂</s:if>中" type="button" onclick="assign2user()">
