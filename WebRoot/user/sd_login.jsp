...
<html>
	<head>
		...
		<script type="text/javascript">
			function load(){
				...
				this.parent.location.href='admin/login.jsp';
	...
	<DIV id=wrap>
			...
			<DIV class=main>
				...
				<form name="myform" method="post" action="sd_user_center_login.action" style="padding: 0px;margin: 0px;">
				<input type="hidden" name="ipAddress" id="ipAddress"/>
				<input type="hidden" name="isFromAdmin" value="1"/>
				<input type="hidden" name="myLogin.ipAddr" id="ipAddr" value="${requestScope.myLogin.ipAddr }" />
					...
					<P class=title style="text-align: left;">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						没有账号,请先<a href="sd_navigation.action">注册</a></P>
					<UL class=maintable>
