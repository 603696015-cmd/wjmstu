...
<HTML>
	<HEAD>
		...
		<TITLE>XX市干部培训网络学校--素材中心首页</TITLE>
		<base href="<%=basePath%>">
	...
	<BODY>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td>　<span class="STYLE6">知识中心栏目导航</span></td>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>　<span class="STYLE6">当前位置：素材中心首页</span></td>
                                <td width="60" align="center"><a href="#"></a></td>
                              </tr>
                          </table></td>
                          <td background="images/knowledge/zhao_25.gif"></td>
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                        ...
                        <tr>
                          <td background="images/knowledge/zhao_24.gif"></td>
                          <td height="200" align="left" valign="top" style="PADDING: 8px; line-height:25px;"><form action="knowledge_center.action" method="post" name="ddd">
					...
					</script><!--<wysLib:page></wysLib:page>--><s:iterator value="qstuffs">
						...
						<tr>
							<td height="35" valign="bottom" class="heicu14">
								<table width="100%" height="30" border="0" cellpadding="0"
									...
									<tr>
										<td class="STYLE5">
										<a href=""><s:property value="title"/>(<s:property value="typeName"/>)</a>
										</td>
										<td width="50" align="right">
										<a target="_blank" href="assist_plan_stuff_download.action?fileName=<s:property value="id" />.<s:property value="fileext" />">下载</a>
										</td>
									</tr>
								</table>
							</td>
									...
									<tr>
										<td height="85" valign="top">
										 简介：<s:property value="description"/> 
											<br />  
											<span class="h30">上传：<s:property value="owner.realname"/> <s:date name="createtime" format="yyyy-MM-dd HH:mm:ss"/> |</span>
										</td>
									</tr>
								</table>
							</td>
