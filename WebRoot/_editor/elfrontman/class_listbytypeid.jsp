...
<HTML>
	<HEAD>
		...
		<TITLE>XX市干部培训网络学校--培训班搜索结果列表</TITLE>
		<base href="<%=basePath%>">
...
<SCRIPT type="text/javascript">
	...
	<BODY onLoad="setImgs();">
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>　<span class="STYLE6">当前位置：培训班 &gt;&gt; <s:property value="cltype.name" />栏目下的班级<br> </span></td>
                                <td width="60" align="center"><a href="#"></a></td>
                              </tr>
                          </table></td>
                          <td background="images/knowledge/zhao_25.gif"></td>
							...
							<tr>
								<td height="35" valign="bottom" class="heicu14">
									<table width="100%" height="30" border="0" cellpadding="0"
										...
										<tr>
											<td class="STYLE5">
												<a href="class_view.action?elclass.id=<s:property value="id"/>&coursePage.id=-1"><s:property value="name" /></a>
											</td>
											<td align="center">
