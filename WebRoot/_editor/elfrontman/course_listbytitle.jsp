...
<HTML>
	<HEAD>
		...
		<TITLE>XX市干部培训网络学校--课程搜索结果列表</TITLE>
		<base href="<%=basePath%>">
	...
	<BODY onLoad="setImgs();">
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>　<span class="STYLE6">课程超市导航</span></td>
            ...
            src="images/knowledge/zhao_29.gif" width="222" /></td>
                        ...
                        <tr>
                          <td background="images/knowledge/zhao_24.gif"></td>
                          <td height="200" align="left" valign="top" style="PADDING: 8px; line-height:25px;"><wysLib:ctypeTree rootAble="true" href="courseIndex.action?pN=0&pS=10&containsub=0&course.ctype.id="></wysLib:ctypeTree>
                          </td>
                          <td background="images/knowledge/zhao_25.gif"></td>
                        </tr>
                        <tr>
        ...
        width="5" /></td>
          ...
          align="left" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>　<span class="STYLE6">当前位置：课程搜索 &gt;&gt;符合条件：”<s:property value="course.name" />“的课程如下<br></span></td>
                                <td width="60" align="center"><a href="#"></a></td>
                              </tr>
                          </table></td>
                          <td background="images/knowledge/zhao_25.gif"></td>
							...
							<tr>
								<td height="35" valign="bottom" class="heicu14">
									<table width="100%" height="30" border="0" cellpadding="0"
										...
										<tr>
											<td class="STYLE5">
												<a href="course_study.action?course.id=<s:property value="id"/>&coursePage.id=-1"><s:property value="name" /></a>
											</td>
											<td align="center">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="110" align="left" valign="top">
												<img src="<s:property  escape="false" value="mainimg"/>" id="cimg_<s:property value="#zxcSt.index"/>" width="100" height="80"/>
												<SCRIPT type="text/javascript">
