...
<title>知识中心--<s:property value="course.ctype.name" />--列表</title>
...
oncopy="return false" 
oncut="return false" 
onpaste="return false"  onload="setImgs();">
...
<table width="970" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <TR>
    <TD height=25>
      ...
      align="middle" /> <A href="logout.action" 
            ...
            <s:iterator value="zxNotices">
              <tr>
                ...
                <td height="26" align="left" class="grey4b" ><a target="_blank" title="<s:property value="title"/>" 
                        href="newsIndexView.action?news.id=<s:property value="id"/>"><s:property value="title"/> </a></td>
              </tr></s:iterator>
            </table></td>
          </tr>
        </table>
        ...
        <td valign="top"><table width="700" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="elfrontimages/tlbg01.png">
                <tr>
                  <td height="35" align="left" style="padding-left:27px;" class="white14">当前位置：河北省公安厅工卫局 >> 课程列表 >> <s:property value="course.ctype.name" /></td>
                </tr>
              </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="bkgreen">
                  <tr>
                    <td height="662" align="center" valign="top" bgcolor="#FBFEF5" style="padding:10px;"><table width="98%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="42" align="center" class="blue14"><s:property value="news.title" /></td>
                        </tr>
                        <tr>
                          <td height="42" align="center"><s:if test="zxNews.size==0">
					...
					<s:if test="zxCourses.size==0">
									...
									<table width="650" height="100" border="0" align="center" cellpadding="0" cellspacing="0" class="listkk">
			                          <tr>
			                            <td width="155" height="113" rowspan="2" align="left" valign="middle" class="listit"><img src="<s:property  escape="false" value="mainimg"/>" id="cimg_<s:property value="#zxcSt.index"/>" width="141" height="93" /></td>
			                            <td height="30" class="listit"><a class="fl"
																	href="courseIndexView.action?course.id=<s:property value="id"/>&coursePage.id=-1"><s:property
																		value="name" /> </a> <span class="list3 fr"><s:date name="createtime"
																		format="yyyy年MM月dd日 HH:mm:ss" /></span></td>
			                          </tr>
			                          <tr>
			                            <td align="left" valign="top" class="list3" style="text-indent:2em;"><SCRIPT type="text/javascript">
													obj = document.getElementById("cimg_<s:property value="#zxcSt.index"/>");
													addImgs(obj);
												</SCRIPT><span class="list3" style="text-indent:2em;"><s:property value="descString" /></span></td>
			                          </tr>
			                        </table>
									</s:iterator>
									<wysLib:page></wysLib:page>
					<form action="courseIndex.action" method="post" name="ddd">
                        ...
                        <table width="98%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top" style="line-height:25px;font-size:12px;">${news.content }</td>
                          </tr>
                        </table>
                      </td>
                  </tr>
