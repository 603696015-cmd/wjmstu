		...
		function setCurTime(oid){
       	...
       	function searchUserInit(){
			 ...
			 if(rv!=undefined&&rv!=""){
				 //var bh=rv.split("_");
				 var bh=rv.split("-=wys=-");
				 document.getElementById("department_id").value=bh[2];
				 document.getElementById("department_name").value=bh[1];
			 }
		} 
...
<div id="pfmsBaseInfo" style="display:block;">
  <FORM id=myform name=myform onsubmit="return CheckForm();" action="alterUserInfo.action?number=1" method=post>
  	<input type="hidden" name="pfmsUser.userId" value="${pfmsUser.userId }"/>
  	<input type="hidden" name="pfmsUser.id" value="${pfmsUser.id }"/>
  	<input type="hidden" name="showType" value="<s:property value='showType'/>"/>
  	<input type="hidden" name="pfmsUser.user.department.id" id="department_id" value="<s:property value='pfmsUser.user.department.id'/>"/>
<TABLE cellSpacing=1 cellPadding=3 width="98%" align=center border=0>
   ...
   <tr>
		...
		<td width="72%" >&nbsp;
			 <s:textfield theme="simple" name="pfmsUser.user.department.name" 
				size="20" id="department_name" readonly="true" />
  ...
  <tr class=tdbg>
	...
	<td width="72%" >
		<select name="pfmsUser.user.role.id">
			<option value="<s:property value='pfmsUser.user.role.id'/>">
  ...
  <TR class=tdbg>
    ...
    <TD width="72%">&nbsp;&nbsp; <INPUT class=textbox id="realname" maxLength=50 
      size=30 name="pfmsUser.user.realname" value="${pfmsUser.user.realname }"> </TD></TR>
	  <TR class=tdbg>
	  <TR class=tdbg>
    <TD width="28%" height=22><SPAN 
    ...
    <TD width="72%">&nbsp;&nbsp; <INPUT class=textbox id="danwei" maxLength=50 
      size=30 name="pfmsUser.user.danwei" value=${pfmsUser.user.danwei }> </TD></TR>
  <TR class=tdbg>
  	<TD width="28%" height=22><SPAN 
    ...
    <TD width="72%">&nbsp;&nbsp; <INPUT class=textbox id="respName" maxLength=50 
      size=30 name="pfmsUser.respName" value=${pfmsUser.respName }></TD></TR>
  ...
  <TR class=tdbg>
    ...
    <TD width="72%">&nbsp;&nbsp; <INPUT class=textbox id="shenfenzheng" maxLength=50 
      size=30 name="pfmsUser.user.shenfenzheng" value=${pfmsUser.user.shenfenzheng }></TD></TR>
    ...
    <TD rowspan="2" align=center>
     <IMG id=imgIcon1  
      ...
      border=1 name=showimages> <BR>
        <A 
      href="<s:if test='pfmsUser.yingyezhizhao != null'><%=path %>/images/pfms/yingyezhizhao_${pfmsUser.userId }.${pfmsUser.yingyezhizhao }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon2  
      ...
      border=1 name=showimages> <BR>
         <A 
      href="<s:if test='pfmsUser.shuiwudengjizheng != null'><%=path %>/images/pfms/shuiwudengjizheng_${pfmsUser.userId }.${pfmsUser.shuiwudengjizheng }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon3   
      ...
      border=1 name=showimages> <BR>
        <A 
      href="<s:if test='pfmsUser.zuzhijigoudaimazheng != null'><%=path %>/images/pfms/zuzhijigoudaimazheng_${pfmsUser.userId }.${pfmsUser.zuzhijigoudaimazheng }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
      color=red>查看大图</FONT></A></TD>
    <TD>
只支持jpg、gif、png，小于500k，默认尺寸为600*800 
      <BR>
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon4   
      ...
      border=1 name=showimages> <BR>
        <A 
      href="<s:if test='pfmsUser.farenshenfenzheng != null'><%=path %>/images/pfms/farenshenfenzheng_${pfmsUser.userId }.${pfmsUser.farenshenfenzheng }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
      color=red>查看大图</FONT></A> </TD>
    <TD>
只支持jpg、gif、png，小于500k，默认尺寸为600*800 
      <BR>
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon5   
      ...
      border=1 name=showimages> <BR>
        <A 
      href="<s:if test='pfmsUser.zizhidengjizhengshu != null'><%=path %>/images/pfms/zizhidengjizhengshu_${pfmsUser.userId }.${pfmsUser.zizhidengjizhengshu }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
      color=red>查看大图</FONT></A> </TD>
    <TD>
只支持jpg、gif、png，小于500k，默认尺寸为600*800 
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon6   
      ...
      border=1 name=showimages> <BR>
         <A 
      href="<s:if test='pfmsUser.xinyongdengjipingguzhengshu != null'><%=path %>/images/pfms/xinyongdengjipingguzhengshu_${pfmsUser.userId }.${pfmsUser.xinyongdengjipingguzhengshu }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
      color=red>查看大图</FONT></A> </TD>
    <TD>
只支持jpg、gif、png，小于500k，默认尺寸为600*800 
  ...
  <TR>
    <TD rowspan="2" align=center>
     <IMG id=imgIcon7   
      ...
      border=1 name=showimages> <BR>
         <A 
      href="<s:if test='pfmsUser.qitazhengshu != null'><%=path %>/images/pfms/qitazhengshu_${pfmsUser.userId }.${pfmsUser.qitazhengshu }</s:if><s:else>javascript:show_message();</s:else>"><FONT 
      color=red>查看大图</FONT></A> </TD>
    <TD>
只支持jpg、gif、png，小于500k，默认尺寸为600*800 
