...
<html>
	...
	<body onload="myload();">
		<form action="updateColumnInit.action" method='post' name='uu'>
					...
					<tr style="display: none" id="addColumn"> 
						...
						<td width="80" height="30" align="center" > 
								...
								<div id="is_qiuji_qiuhe" style="display:none;">
									...
									是否从保险产品中获取单价<input type="checkbox" name="bsql.from_entity" id="from_entity" onclick="value_from_entity();"/>
								</div>
						</td>
						<td width="80" height="30" align="center" > 
