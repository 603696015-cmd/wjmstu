	...
	<body onload="load()"> 
		...
		<div style="margin-top: 20px; text-align: center;">
			<table width="100%">
				<tr>
					<td valign="top">
							<form action="IC_ListInit.action" method="post" >
								...
								<center>
									...
									创建人&nbsp;<input type="text" name="ID.founder.realname" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							...
							<caption > 
							    <a href="IC_addInit.action"　class="textbg4">添加险种</a> 
							</caption>
								<tr>
									...
									<th width="180" height="30" align="center" >
										模板路径		&nbsp;&nbsp; 
										 <a href="IC_U_Demo_downloadInit.action?fileName=IC_U_demo.jsp" target="_blank" style="color:red">模板下载</a> 
										 <a href="IC_U_Demo_downloadInit.action?fileName=IC_U_demo.css" target="_blank" style="color:red">样式下载</a> 					
									</th> 
								...
								<s:iterator value="ICList">
									<tr>
										...
										<td height="30" align="center" >  
											<form action="IC_U_UpdateDemo.action?IC.id=<s:property value="id" />" enctype="multipart/form-data"	method="post"> 
												模板：<input type="file" name="st" value="<s:property value=""/>"> 
												<s:if test="demourl.length() > 0">
													<input type="submit" value="替换">
										 			<a href="IC_U_Demo_downloadInit.action?fileName=<s:property value="tableName"/>.jsp" target="_blank" style="color:red">下载</a> 
												</s:if><s:else>
													<input type="submit" value="上传"> 
												</s:else>
											</form>
											<form action="IC_U_UpdateDemo_CSS.action?IC.id=<s:property value="id" />" enctype="multipart/form-data"	method="post"> 
												样式：<input type="file" name="st" value="<s:property value=""/>"> 
												<s:if test="democss.length() > 0">
													<input type="submit" value="替换">
										 			<a href="IC_U_Demo_downloadInit.action?fileName=<s:property value="tableName"/>.css" target="_blank" style="color:red">下载</a> 
												</s:if><s:else>
													<input type="submit" value="上传"> 
												</s:else>
											</form>
									  ...
									  <td align="center" valign="middle">
									    <a href="IC_U_columns_manageInit.action?IC.id=<s:property value="id"/>">管理表</a>  
