...
<HTML>
	...
	<body>
		...
		<div style="margin-top: 20px;margin-left: 100px;"> 
		 	<wysLib:productTypeTree href="baoxianProductType_view.action?ptype.id=" rootAble="true"></wysLib:productTypeTree>
		</div>
		
		<div style="margin-top: 15px; margin-left: 80px;">
			<a href="baoxianProductType_addInit.action" class=textbg>添加所属栏目</a>
		</div>
		<!-- 内容 -->
