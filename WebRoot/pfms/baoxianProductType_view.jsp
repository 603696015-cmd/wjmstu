...
-->
	...
	<body>
		<ul class="nav">
			<li>
				<div style="padding-top:3px;color:#077ac7;font-size:12px;"><wysLib:Navigation ivalue="产品所属栏目简介" /></div>
			</li>
		</ul>
		<table width="100%">
			<tr>
			<td valign="top" width="200px" id="tree_list_td"><wysLib:productTypeTree href="baoxianProductType_view.action?ptype.id=" rootAble="true"></wysLib:productTypeTree>
		</td>
			...
			<td valign="top"><table width="100%" cellpadding="2" cellspacing="1" >
				...
				<tr>
					...
					<td >
						<a href="baoxianProductType_alterInit.action?ptype.id=<s:property value="ptype.id"/>" class="textbg4">修 改</a>
						<br />
						<s:form method="post" name="delEp" action="baoxianProductType_delete.action">
						<s:hidden name="ptype.id" id="ptypeId" />
							<s:if test="#session.roleid==1">
								<strong> 下属产品栏目与子栏目操作</strong> 并入上级类别
