...
tr {
	...
	<body>
			...
			<div style="margin-top: 0px; text-align: center;">
				...
				<div>
					<table width="100%" align="center" cellpadding="1" cellspacing="1"
						...
						<tbody >
							<s:iterator value="elclasses" id="elcid" status="elcst">
								<tr>
								...
								<!-- 	<td height="30" align="center">
									...
									<td>
										&nbsp;&nbsp;
										<a href="elclass_alterInit.action?elclass.id=${id}"
											class=textbg4>修改</a>
									</td>
									<td>
										&nbsp;&nbsp;
										<a href="delete_elclass.action?peixunBatch.elclass.id=${id}&peixunBatch.id=${peixunBatch.id}"
											class=textbg4>删除</a>
									</td>
									<td width="40" align="center">
											<s:if test="sortid!=1">
												<a
													href="elclass_upsort.action?elclass.id=<s:property value="id"/>&elclass.sortid=<s:property value="sortid"/>&&peixunBatch.id=${peixunBatch.id}">上移
												</a>
											</s:if>
										</td>
										<td width="40" align="center">
											<s:if test="#elcid.sortid!=(elclasses.size)">
												<a
													href="elclass_downsort.action?elclass.id=<s:property value="id"/>&elclass.sortid=<s:property value="sortid"/>&&peixunBatch.id=${peixunBatch.id}">下移
												</a>
											</s:if>
										</td>
								</tr>
		...
		<div
			...
			<a style="cursor: hand" class="textbg6" href="#"
				onClick="addElclass();return false;" style="width: 100px">添加培训班</a>
	...
	<SCRIPT type="text/javascript">
			function addElclass(){
				...
				var x = window.showModalDialog ('batch_elclass_List.action?sublibs=1&peixunBatch.id=${peixunBatch.id}&elclass.status=-1&x='+Math.random(),null,sFeature);
