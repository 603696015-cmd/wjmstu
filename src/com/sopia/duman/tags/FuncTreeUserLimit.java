...
public class FuncTreeUserLimit extends ElTag{
	/**
	 * 
	 */
	private static final Log logger = LogFactory.getLog(FuncTreeUserLimit.class);
...
//			HttpServletRequest req = (HttpServletRequest) request;
			...
			ElFunc cts = (ElFunc) request.getAttribute("userFuncTree");
