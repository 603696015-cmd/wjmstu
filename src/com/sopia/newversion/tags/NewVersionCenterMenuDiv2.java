...
public class NewVersionCenterMenuDiv2 extends TagSupport {
...
//							"<A href=\""+actionName+"\" target=\""+target+"\"><img style=\"margin-top: 10px;\""+
							"<A href=\""+actionName+"\" target=\"_self\"><img style=\"margin-top: 10px;\""+
...
//							"<A href=\"javascript:open('"+actionName+"');\" ><img style=\"margin-top: 10px;\""+
	...
	public void outPut(JspWriter out, List<ElFunc> menus) throws IOException {
		...
		for(int i=1;i<=level_count;i++){
			if(i == 1){
				out.println("<li class=\"selected\"><a href=\"javascript:void(0);\" class1=\"item-1\">"+funcName+"</a></li>");
			}else{
				if(i>3){
