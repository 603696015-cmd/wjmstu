...
public class LableTreeListAj extends ElTag {
	private static final long serialVersionUID = 3119679319963664116L;
	private static final Log logger = LogFactory.getLog(LableTreeListAj.class);
	...
	public int doStartTag() {
		try {
			...
			cts = (LableTree) request.getAttribute("lableTree");
			...
			out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"js/tree/wtree.css\" />\n"
							+ "<script type=\"text/javascript\" src=\"js/tree/wtree_lableTree.js\"></script>\n"
			...
			logger.error("自定义类别树ajax显示错误",ex);
		}
		return TagSupport.SKIP_BODY;
	}

	public void writeChilds(JspWriter out, Object obj) throws Exception {
		LableTree qlb = (LableTree) obj;
		List<LableTree> qlbChild = qlb.getChild();
