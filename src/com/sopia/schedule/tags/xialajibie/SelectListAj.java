package com.sopia.schedule.tags.xialajibie;
...
public class SelectListAj extends ElTag {
	private static final long serialVersionUID = 3119679319963664116L;
	private static final Log logger = LogFactory.getLog(SelectListAj.class);
	...
	public int doStartTag() {
		try {
			...
			SelectLevel cts = null;
			
			cts = (SelectLevel) request.getAttribute("selectLevelTree");
			...
			out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"js/tree/wtree.css\" />\n"
							+ "<script type=\"text/javascript\" src=\"js/tree/wtree_selectLevel.js\"></script>\n"
	...
	public void writeChilds(JspWriter out, Object obj) throws Exception {
		SelectLevel qlb = (SelectLevel) obj;
		List<SelectLevel> qlbChild = qlb.getChild();
		...
		if (qlbChild != null)
			for (int i = 0; i < qlbChild.size(); i++) {
				SelectLevel qlbi = qlbChild.get(i);
