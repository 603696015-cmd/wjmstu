...
public class DataApplicationList extends TagSupport{
	...
	public int doStartTag() {
		try {
			...
			outPut(list_tags,list_designe,out);
	...
	public void outPut(List<Tags> list_tags,List<Map<String,String>> list_designe,JspWriter out) throws IOException, NumberFormatException, ElException{
		TagsResolveHTMLForList.resolveHTMLForDataApplication(getType(),list_tags, list_designe, out);
	}
