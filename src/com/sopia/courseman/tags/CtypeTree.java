...
public class CtypeTree extends ElTag {
	private static final long serialVersionUID = 3119679319963664116L;
	private static final Log logger = LogFactory.getLog(CtypeTree.class);
	...
	public int doStartTag() {
		try {
			...
			CourseType cts = (CourseType) request.getAttribute("ctypeTree");
			// 判断用户是否是超级管理员。
