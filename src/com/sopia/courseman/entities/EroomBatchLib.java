...
public class EroomBatchLib extends ElNode {
	private String name;
	private String description;
	private List<EroomBatchLib> child;
	...
	public List<EroomBatchLib> getChild() {
		return child;
	}
	public void setChild(List<EroomBatchLib> child) {
		this.child = child;
	}
	public EroomBatchLib( int id ,String name) {
		super(id);
		this.name = name;
	}
	public EroomBatchLib() {
	}
	public EroomBatchLib(int id) {
		super(id);
	}
