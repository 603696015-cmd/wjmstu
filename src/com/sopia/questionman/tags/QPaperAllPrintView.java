...
public class QPaperAllPrintView extends TagSupport {
	private static final Log logger = LogFactory.getLog(QPaperAllPrintView.class);
	...
	private void writeEPBs(JspWriter out, List<ExamPaperBlock> epbs)
		...
		if (null != epbs)
			for (int j = 0; j < epbs.size(); j++) {
				...
				out.println("<table id='block_" + j + "' width='970' border='0' align='center' cellpadding='0' cellspacing='0' class='topb4' style='margin-top:15px;'>" +
				"<tr><td height='60' align='left' bgcolor='#D6F1F1' class='STYLE6' style='padding-left:15px;padding-right:15px;padding-top:5px;padding-bottom:5px;'>");
				out.println("第"
...
//				out.println("<table width='900' border='0' align='center' cellpadding='0' cellspacing='0'><tr>");
...
//			out.println("<div class='sort'>hhhhh" + qj.getSortid()
//					+ ".</div><div class='content'>");//【" + epb.getEachscore()	+ "分】
			if (qj.getQtype() == 6) {
				out.print("<table width='900' border='0' align='center' cellpadding='0' cellspacing='0' class='tlr-b'><tr>" +
						"<td height='60' align='left' style='padding-left:20px;padding-right:20px'>第<span class='blineno'> "+qj.getSortid()+" </span>题:");
			}else{
				out.print("<table width='900' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td height='60' align='left'>第<span class='blineno'> "+qj.getSortid()+" </span>题:");
			}
			if (qj.getQtype() == 7) {// 材料题
				List<Question> qjc = qj.getChilds();
				out.print( qj.getContent_() + "</td></tr></table>");
				for (int i = 0; i < qjc.size(); i++) {
	
					Question qjci = qjc.get(i);
					out.println("<table width='900' border='0' align='center' cellpadding='0' cellspacing='0'><tr>" +
							"<td height='60' align='left'>第( " + qjci.getSortid() + " )" + qjci.getContent_() );
...
//					+ "分】
	...
	private void writeEPQsComm(JspWriter out, Question qj, int blockid)
		...
		if (qj.getQtype() == 6) {
			...
			out.println("</td></tr></table><table width='900' border='0' align='center' cellpadding='0' cellspacing='0' class='lrb-b'><tr><td height='300' align='left'>&nbsp;</td></tr></table>");
...
//		out.print("</div>");
		out.print("</td></tr></table>" +
				"<table width='960' border='0' align='center' cellpadding='0' cellspacing='0' bgcolor='#E8E8E8'>" +
				"<tr><td width='60' align='center'>&nbsp;</td>" +
				"<td height='35' align='left'>　　考生作答</td>" +
				"<td width='200' align='center' class='fz14'>[　　　　　　　]</td>" +
				"</tr></table>");
...
//		}
//		out.print("</div><div><b>考生答案：</b>" + myStuAnswer+"</div>");
