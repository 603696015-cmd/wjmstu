...
public class AnsweringTypeTreeListAj extends ElTag {
	private static final long serialVersionUID = 3119679319963664116L;
	private static final Log logger = LogFactory.getLog(AnsweringTypeTreeListAj.class);
	...
	public int doStartTag() {
		try {
			...
			AnsweringType cts = null;
			
			cts = (AnsweringType) request.getAttribute("answeringType");
			...
			out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"js/tree/wtree.css\" />\n"
							+ "<script type=\"text/javascript\" src=\"js/tree/wtree_answeringTypeTree.js\"></script>\n"
	...
	public void writeChilds(JspWriter out, Object obj) throws Exception {
		AnsweringType qlb = (AnsweringType) obj;
		List<AnsweringType> qlbChild = qlb.getChild();
		...
		if (qlbChild != null)
			for (int i = 0; i < qlbChild.size(); i++) {
				AnsweringType qlbi = qlbChild.get(i);
