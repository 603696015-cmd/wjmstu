...
public class HttpUtils {
	...
	static final String bounDary = "----WebKitFormBoundaryCXRtmcVNK0H70msG";
	 ...
	 * @throws Exception
	 */
	public static void doPostAsyn(final String urlStr, final byte[] params,
	...
	public static String postFile1(String actionUrl, Map<String, String> params,
...
//		params.put("uid", "316294");
//		
//		byte[] fileIos = UploadRecordFile.getBytesByFile("C:\\record\\20201_442811_16557.pcm");
//		
////		Map<String, byte[]> files = new HashMap<String, byte[]>();
////		files.put("test", fileIos);
//		try {
//			HttpUtils.postFile1("http://127.0.0.1:8877/record/RecordUploadServlet", params, null);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
		
		  IBaseCache baseCache = CacheFactory.getRedisCache();
		  String str = baseCache.get("20201_audio_speak").toString();
