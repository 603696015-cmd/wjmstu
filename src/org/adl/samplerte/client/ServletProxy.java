...
public class ServletProxy
{
   ...
   ****************************************************************************/
   ...
   public ServletProxy( URL url, String userid,String scoid ,String courseid,String classid,String cid,String sessionid) 
   {
      this.servletURL = url;
      this.userid = userid;
   ...
   ****************************************************************************/
   public SCODataManager GetSCOData()
   {
      ...
      try
      {
         String servletCommand = "cmigetcat"+"=-="+this.userid+"=-="+this.scoid+"=-="+this.courseid+"=-="+this.classid+"=-="+this.cid;
   ...
   ****************************************************************************/
   public String PutSCOData( SCODataManager scoData )
   {
      try
      {
         ...
         String servletCommand = "cmiputcat"+"=-="+this.userid+"=-="+this.scoid+"=-="+this.courseid+"=-="+this.classid+"=-="+this.cid;
