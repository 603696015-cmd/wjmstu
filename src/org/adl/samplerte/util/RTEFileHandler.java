...
public class RTEFileHandler
{
    ...
    **
    ***************************************************************************/
    public RTEFileHandler(String basepath)
    {
        userID = new String();
        courseID = new String();
        classID = new String();
        ...
        sequence = 0;
        sampleRTERoot =basepath+ "/SampleRTEFiles";
    }
    ...
    public void setClassID( String idIn )
    {
    	classID = idIn;
    }
    ...
    public void initializeCourseFiles()
    {
        try
        {
            ...
            String userDir = sampleRTERoot + "/" + userID + "/" + classID + "/" + courseID;
            ...
            = "SELECT * FROM SC_ItemInfo WHERE CourseID = ?";

            String sqlInsertUserSCO
             = "INSERT INTO SC_UserSCOInfo (UserID, CourseID,CLASSID, SCOID, Launch, ParameterString, " +
            ...
            while ( itemRS.next() )
            {
               ...
               if ( type.equals( "sco" ) || type.equals( "asset" ) )
               {
                  ...
                  synchronized( stmtInsertUserSCO )
                  {
                     ...
                     stmtInsertUserSCO.setString( 3, classID );
                     stmtInsertUserSCO.setString( 4, scoID );
                     stmtInsertUserSCO.setString( 5, location );
                     stmtInsertUserSCO.setString( 6, parameterString );
                     stmtInsertUserSCO.setString( 7, "not attempted" );
                     stmtInsertUserSCO.setString( 8, prerequisites );
                     stmtInsertUserSCO.setString( 9, "" );
                     stmtInsertUserSCO.setString( 10, "ab-initio" );
                     stmtInsertUserSCO.setString( 11, masteryScore );
                     stmtInsertUserSCO.setInt( 12, sequence );
                     stmtInsertUserSCO.setString( 13, type );
    ...
    ****************************************************************************/
    private SCODataManager initSCOData()
    {
        ...
        try
        {
            ...
            = "SELECT * FROM SC_UserInfo WHERE UserID = ?";
